# Reel 0001 research source validation

## Topic

Affect labeling: naming an emotion in words as a possible emotion-regulation strategy.

## Sources reviewed

1. Lieberman et al. (2007), “Putting Feelings Into Words: Affect Labeling Disrupts Amygdala Activity in Response to Affective Stimuli.” [PubMed record](https://pubmed.ncbi.nlm.nih.gov/17576282/)
   - Peer-reviewed fMRI study record.
   - The study compares affect labeling with control encoding conditions and reports reduced amygdala response during affect labeling, with a proposed pathway involving right ventrolateral prefrontal cortex, medial prefrontal cortex, and amygdala.
...
Audience: Hindi-speaking general social audience seeking evidence-grounded education. Format: approximately 60 seconds, 9:16 portrait, Hindi narration and captions. Style: clean cinematic neuroscience animation with restrained labels and no diagnostic imagery. Narration is off-screen; no on-camera presenter is required.

## Asset and quota note

The first AI-generated portrait video clip was created successfully, then the free-plan video quota returned `1/1` for the day. No quota, billing, or access control was bypassed. Reel 0001 therefore uses a high-quality animated portrait montage from generated 9:16 neuroscience reference images with controlled pan/zoom transitions, generated Hindi narration, and Devanagari captions. Native AI video clips can resume after the quota resets.

## Status

Research evidence captured and independently cross-checked; Reel 0001 rendered, QC-passed, uploaded to Drive, and Drive-verified. It is not published.

Generated/updated: 2026-08-22.
