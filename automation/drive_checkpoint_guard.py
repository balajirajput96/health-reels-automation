...
def main() -> None:
    ...
    assert pointer["next_reel_id"] == "0006"
    ...
    for reel_id in ("reel_0001", "reel_0002", "reel_0003", "reel_0004", "reel_0005"):
    ...
    print(json.dumps({"status": "PASS", "project": pointer["project"], "completed": ["0001", "0002", "0003", "0004", "0005"], "next_reel_id": pointer["next_reel_id"], "target_total_reels": pointer["target_total_reels"]}, ensure_ascii=False))
