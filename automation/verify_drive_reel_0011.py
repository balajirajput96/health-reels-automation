...
EXPECTED = {
    "reel_0011_prefrontal_control_what_studies_measure_hi.mp4",
    "reel_0011_prefrontal_control_what_studies_measure_narration_hi.wav",
    "reel_0011_prefrontal_control_what_studies_measure_captions_hi.srt",
    "reel_0011_metadata.json",
    "reel_0011_qc_report.json",
    "reel_0011_prefrontal_control_what_studies_measure_sources.md",
    "reel_0011_prefrontal_control_what_studies_measure_script.md",
    "reel_0011_scene_01.png",
    "reel_0011_scene_02.png",
    "reel_0011_scene_03.png",
    "reel_0011_scene_04.png",
}
...
def main() -> int:
    ...
    result["valid"] = not (
        missing or zero or wrong_parent or not manifest_found or not manifest_parent_ok or not manifest_nonzero
    )
