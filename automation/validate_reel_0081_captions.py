...
last_end = 0
required = [
    'stress', 'stressor', 'subjective appraisal', 'Attention Network Test',
    'Response time', 'accuracy', 'EEG', 'Cortisol', 'alpha-amylase',
    'causation', 'individual forecast', 'AI-सहायित', 'व्यक्तिगत सलाह नहीं',
]
full = ''
for index, block in enumerate(blocks, 1):
    ...
    last_end = end
    full += '\n'.join(lines[2:]) + '\n'
assert last_end == 64_440, last_end
for phrase in required:
    assert phrase in full, phrase
print('R0081_CAPTIONS_OK')
