...
EXPECTED = {
    'reel_0077_stress_appraisal_what_studies_measure_hi.mp4',
    'reel_0077_stress_appraisal_what_studies_measure_narration_hi.wav',
    'reel_0077_stress_appraisal_what_studies_measure_captions_hi.srt',
    'reel_0077_metadata.json',
    'reel_0077_qc_report.json',
    'reel_0077_stress_appraisal_what_studies_measure_sources.md',
    'reel_0077_stress_appraisal_what_studies_measure_script.md',
    'reel_0077_scene_01.png',
    'reel_0077_scene_02.png',
    'reel_0077_scene_03.png',
    'reel_0077_scene_04.png',
}
