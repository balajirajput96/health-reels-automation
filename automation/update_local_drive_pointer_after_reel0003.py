...
def main() -> None:
    ...
    pointer["completed"]["reel_0003"] = {
        "status": "qc_passed_drive_verified",
        "folder_id": files["REEL-0003_local_manifest.json"]["parents"][0],
    ...
    pointer["next_reel_id"] = "0004"
    POINTER_PATH.write_text(json.dumps(pointer, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    print(json.dumps({"status":"PASS","completed_reel":"0003","next_reel_id":pointer["next_reel_id"],"artifact_count":pointer["completed"]["reel_0003"]["artifact_count"]}, ensure_ascii=False))
