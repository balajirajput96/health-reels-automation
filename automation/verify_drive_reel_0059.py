...
EXPECTED={'reel_0059_semantic_memory_what_studies_measure_hi.mp4','reel_0059_semantic_memory_what_studies_measure_narration_hi.wav','reel_0059_semantic_memory_what_studies_measure_captions_hi.srt','reel_0059_metadata.json','reel_0059_qc_report.json','reel_0059_semantic_memory_what_studies_measure_sources.md','reel_0059_semantic_memory_what_studies_measure_script.md','reel_0059_scene_01.png','reel_0059_scene_02.png','reel_0059_scene_03.png','reel_0059_scene_04.png'}
def main():
 ...
 r['valid']=not(missing or zero or wrong or len(manifests)!=1 or not r['manifest_parent_ok'] or not r['manifest_nonzero']); text=json.dumps(r,ensure_ascii=False,indent=2)+'\n'
