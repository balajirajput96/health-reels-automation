...
p = Path('assets/reel_0037_implementation_intentions_what_studies_measure_captions_hi.srt')
...
for b in blocks:
    ...
    assert s >= prev and e > s and e <= 61.52, (s, e, prev)
    prev = e
assert 'guaranteed result' in blocks[-1][-1].lower()
