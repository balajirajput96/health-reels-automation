...
p = Path('assets/reel_0041_identity_and_habits_what_studies_measure_captions_hi.srt')
...
for block in blocks:
    ...
    assert start >= previous_end and end > start and end <= 74.28, (start, end, previous_end)
    previous_end = end
