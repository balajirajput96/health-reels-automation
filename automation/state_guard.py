...
def main() -> int:
    ...
    register_parser.add_argument("--stage", required=True, choices=["original", "edited", "final", "drive_verified", "drive_verified_fallback", "scheduled", "published", "failed", "rejected"])
