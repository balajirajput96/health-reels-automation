...
p = Path('assets/reel_0043_meditation_training_what_studies_measure_captions_hi.srt')
...
for block in blocks:
    ...
    assert start >= previous_end and end > start and end <= 74.16, (start, end, previous_end)
    previous_end = end
