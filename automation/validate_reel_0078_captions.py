...
SRT = ROOT / 'assets/reel_0078_acute_stress_what_studies_measure_captions_hi.srt'
...
assert abs(previous_end - 73.600) < 0.01, previous_end
joined = text.lower()
for term in ('exposure', 'appraisal', 'behavior', 'physiology', 'association', 'diagnosis'):
    assert term in joined, term
print('R0078_CAPTIONS_OK')
