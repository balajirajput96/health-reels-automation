...
import re
p=Path('assets/reel_0051_feedback_learning_what_studies_measure_captions_hi.srt')
...
for b in blocks:
    ...
    assert start>=prev and end>start and end<=73.76, (start,end,prev)
    prev=end
last=' '.join(blocks[-1][2:]).lower()
