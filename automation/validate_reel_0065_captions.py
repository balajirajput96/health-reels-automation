...
import re
p=Path('assets/reel_0065_task_switching_what_studies_measure_captions_hi.srt')
...
for term in ('diagnosis','advice','model-derived','real-life multitasking'): assert term in text,term
