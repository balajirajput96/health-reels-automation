...
meta_path = ROOT / 'assets/reel_0079_metadata.json'
qc_path = ROOT / 'assets/reel_0079_qc_report.json'
drive_path = ROOT / 'state/reel_0079_drive_final_verification.json'
...
meta['measured_narration_duration_seconds'] = 68.20
