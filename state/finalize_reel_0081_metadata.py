...
drive_path = ROOT / 'state/reel_0081_drive_initial_verification.json'
...
meta['measured_narration_duration_seconds'] = 64.44
meta['measured_video_duration_seconds'] = qc['checks']['duration_seconds']
...
meta['qc']['drive_verification_note'] = 'Exact-package verification passed: 11 expected objects, one nonzero correctly parented manifest, zero missing/zero-size/wrong-parent/duplicate/unrelated objects; local-to-Drive byte sizes and file IDs verified.'
meta_path.write_text(json.dumps(meta, ensure_ascii=False, indent=2) + '\n', encoding='utf-8')
print(json.dumps({'measured_narration_duration_seconds': meta['measured_narration_duration_seconds'], 'measured_video_duration_seconds': meta['measured_video_duration_seconds'], 'measured_mp4_sha256': meta['measured_mp4_sha256'], 'local_media_qc': meta['qc']['local_media_qc'], 'drive_verified': meta['qc']['drive_verified']}, ensure_ascii=False, indent=2))
