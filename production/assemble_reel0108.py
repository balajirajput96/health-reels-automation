...
SPANS = [
    ("Span 01 — Hook", "क्या आपने महसूस किया है कि कोई खास गाना सुनते ही आपके रोंगटे खड़े हो जाते हैं और दिल की धड़कन तेज हो जाती है?"),
    ("Span 02 — Musical Frisson", "Neuroscience में इस अनुभव को Musical Frisson कहते हैं, जो दिमाग में डोपामाइन के अचानक बाढ़ की तरह बहने से होता है।"),
    ("Span 03 — Nucleus Accumbens", "जब आप संगीत सुनते हैं, तो दिमाग अगली धुन का अनुमान लगाता है—सही ताल मिलते ही Nucleus Accumbens हिस्सा भरपूर Dopamine रिलीज़ करता है।"),
    ("Span 04 — Whole-Brain Activation", "गाना सुनते समय दिमाग का केवल सुनने वाला हिस्सा नहीं, बल्कि मोटर कॉर्टेक्स, याददाश्त और भावनाएं एक साथ एक्टिव हो जाते हैं।"),
    ("Span 05 — Brainwave Entrainment", "धीमी 60 BPM की धुनें दिमाग की तरंगों को Alpha Waves में बदलकर तनाव और कॉर्टिसोल को कम कर देती हैं।"),
    ("Span 06 — Practical Music Tool", "पढ़ाई के लिए बिना बोल वाला संगीत सुनें और वर्कआउट में 130 BPM के तेज़ गाने इस्तेमाल करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल auditory neurobiology awareness के लिए है और clinical sensory therapy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (147, 51, 234)  # Violet for music / auditory neuroscience
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0108 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Music Neurobiology Nucleus Accumbens Dopamine Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0108_music_neurobiology_frisson','display_id':'REEL-0108','topic_hi':'Music Neuroscience: पसंदीदा गाना सुनने से रोंगटे क्यों खड़े होते हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
