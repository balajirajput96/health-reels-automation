...
WORK = ROOT / 'work' / 'reel_0045'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0045_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0045_framing_effect_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "'90% सफलता की संभावना' और '10% विफलता का जोखिम'—दोनों एक ही बात हैं, फिर भी आपका दिमाग अलग प्रतिक्रिया क्यों देता है?"),
    ("Span 02 — Kahneman & Tversky's Framing", "Behavioral economics में इसे 'framing effect' कहते हैं—जानकारी को पेश करने का तरीका हमारे फैसले बदल देता है।"),
    ("Span 03 — Loss Aversion Bias", "Prospect Theory के अनुसार इंसान के दिमाग को नुकसान (loss) का डर फायदे (gain) की खुशी से लगभग दोगुना ज़्यादा महसूस होता है।"),
    ("Span 04 — Positive vs Negative Frame", "जब विकल्प 'फायदे' के रूप में पेश किया जाता है तो हम सुरक्षित रास्ता चुनते हैं, लेकिन 'नुकसान' के रूप में हम ज़्यादा जोखिम लेते हैं।"),
    ("Span 05 — Real-World Impact", "विज्ञापनों, वित्तीय योजनाओं और मेडिकल चर्चाओं में framing का उपयोग हमारी पसंद को प्रभावित करने के लिए होता है।"),
    ("Span 06 — Critical Decision Rule", "कोई भी बड़ा फैसला लेते समय जानकारी को दोनों तरह से (फायदे और नुकसान दोनों के नजरिए से) लिखकर फिर सोचें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive science and decision theory awareness के लिए है और financial या medical advice का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(217, 70, 239))  # Fuchsia Framing accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(217, 70, 239), font=font_header)
    draw.text((40, 90), f"REEL-0045 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Behavioral Economics & Prospect Theory Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0045_the_framing_effect_in_decisions',
        'display_id': 'REEL-0045',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0045',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Framing Effect: शब्दों के हेर-फेर से हमारे फैसले बदलने का विज्ञान',
        'topic_key': 'framing_effect_decision_architecture',
        'pillar': 'mental_health',
        'evidence_class': 'behavioral_economics_and_prospect_theory',
