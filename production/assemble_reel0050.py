...
WORK = ROOT / 'work' / 'reel_0050'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0050_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0050_selective_attention_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने गौर किया है कि एक शोर-शराबे वाली पार्टी में भी कोई आपका नाम पुकारे तो आपका ध्यान तुरंत कैसे चला जाता है?"),
    ("Span 02 — The Cocktail Party Effect", "Cognitive psychology में इसे 'Cocktail Party Effect' कहते हैं—यह हमारे दिमाग की selective attention क्षमता है।"),
    ("Span 03 — Attentional Filtering", "हमारा मस्तिष्क हज़ारों गैर-ज़रूरी आवाज़ों को एक फ़िल्टर की तरह दबा देता है और केवल मुख्य बातचीत पर फोकस बनाए रखता है।"),
    ("Span 04 — Subconscious Monitoring", "लेकिन background में दिमाग पूरी तरह बंद नहीं होता; वह महत्वपूर्ण शब्दों (जैसे आपका नाम या खतरे की आवाज़) के लिए स्कैन करता रहता है।"),
    ("Span 05 — Frontoparietal Networks", "Brain के frontoparietal networks तय करते हैं कि कौन सा सिग्नल चेतना (consciousness) तक पहुँचेगा और कौन सा ब्लॉक होगा।"),
    ("Span 06 — Practical Productivity", "गहन एकाग्रता वाले काम करते समय बैकग्राउंड की बातचीत से बचें, क्योंकि दिमाग अनजाने में उसे प्रोसेस करने में ऊर्जा खर्च करता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल attention science awareness के लिए है और ADHD या sensory disorder diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(245, 158, 11))  # Amber Attention accent bar
    ...
    draw.text((40, 90), f"REEL-0050 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Attention Science & Cocktail Party Effect Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0050_selective_attention_and_cocktail_party_effect',
        'display_id': 'REEL-0050',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0050',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Selective Attention: शोर भरे माहौल में भी फोकस करने का Neuroscience',
        'topic_key': 'selective_attention_cocktail_party_effect',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_attention_science_and_auditory_filtering',
