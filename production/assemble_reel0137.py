...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी नोटिस किया है कि किसी विषय पर सिर्फ एक वीडियो देखने वाले लोग खुद को 20 साल के अनुभवी डॉक्टर या साइंटिस्ट से ज्यादा होशियार समझने लगते हैं?"),
    ("Span 02 — Dunning-Kruger Effect", "साइकोलॉजी में इसे Dunning-Kruger Effect कहा जाता है।"),
    ("Span 03 — Mount Stupid Trap", "कॉर्नेल यूनिवर्सिटी की रिसर्च बताती है कि शुरुआती ज्ञान मिलने पर इंसान Mount Stupid पर होता है—उसे लगता है कि वह सब कुछ जान चुका है।"),
    ("Span 04 — Valley of Despair", "लेकिन जैसे-जैसे इंसान गहराई में जाता है, उसे समझ आता है कि विषय कितना कठिन है, और उसका झूठा घमंड टूट जाता है।"),
    ("Span 05 — True Mastery", "सच्चे विद्वान हमेशा विनम्र होते हैं क्योंकि वे जानते हैं कि ज्ञान का कोई अंत नहीं है।"),
    ("Span 06 — 3-Argument Rule", "जब भी आपको किसी बात का 100% घमंड हो, तो खुद के विचार के खिलाफ 3 मजबूत तर्क खोजें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive psychology awareness के लिए है और psychological assessment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (245, 158, 11)  # Amber / Gold for metacognition & intellectual humility
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0137 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Dunning-Kruger Effect Mount Stupid Humility",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0137_dunning_kruger_effect','display_id':'REEL-0137','topic_hi':'Dunning-Kruger Effect: कम जानकारी वाले खुद को ज्ञानी क्यों समझते हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
