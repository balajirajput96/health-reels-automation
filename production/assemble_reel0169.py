...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि रोज सिर्फ दो मिनट किसी एक अच्छी बात के लिए दिल से आभार जताने पर आपके दिमाग के न्यूरल सर्किट्स सचमुच बदल सकते हैं?"),
    ("Span 02 — Negativity Bias", "इंसानी दिमाग का विकास खतरों को ढूंढने के लिए हुआ है, इसलिए हम अनजाने में अच्छी बातों को नजरअंदाज करके कमियों पर अटक जाते हैं।"),
    ("Span 03 — Dopamine Surge", "Harvard Health की रिसर्च के अनुसार, Gratitude की आदत दिमाग में डोपामाइन और सेरोटोनिन जैसे फील-गुड न्यूरोट्रांसमीटर्स को रिलीज करती है।"),
    ("Span 04 — DMN Brain Quieting", "ब्रेन स्कैन दिखाते हैं कि आभार जताने से दिमाग का वह हिस्सा शांत हो जाता है जो बेवजह की चिंता और ओवरथिंकिंग पैदा करता है।"),
    ("Span 05 — Sleep & Resilience", "UC Berkeley की स्टडीज में पाया गया कि सोने से पहले आभार व्यक्त करने से नींद की क्वालिटी और हार्ट रेट वेरिएबिलिटी में सुधार होता है।"),
    ("Span 06 — Micro Detail Rule", "बड़ी बातों के बजाय दिन की किसी छोटी सी चीज को याद करें—जैसे सुबह की गर्म चाय या किसी दोस्त की मुस्कान।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल positive cognitive psychology awareness के लिए है और clinical depression या severe anxiety disorders की थेरेपी का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (245, 158, 11)  # Warm amber gold for gratitude, resilience, and positive psychology
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0169 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Gratitude Neuroscience Harvard UC Berkeley DMN",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0169_gratitude_neuroscience','display_id':'REEL-0169','topic_hi':'Gratitude Science: रोज 2 मिनट आभार जताने से दिमाग में क्या बदलता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
