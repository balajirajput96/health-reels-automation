...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि सुबह ठंडे पानी से नहाने पर तुरंत बिजली जैसी फुर्ती क्यों आती है, और रात को गर्म पानी से नहाने पर गहरी नींद क्यों आती है?"),
    ("Span 02 — Morning Cold Shock", "सुबह ठंडा पानी लगते ही त्वचा के सेंसर्स दिमाग के Locus Coeruleus हिस्से को तुरंत एक्टिव कर देते हैं।"),
    ("Span 03 — 250% Alertness Surge", "वैज्ञानिक रिसर्च के अनुसार, इससे दिमाग में Norepinephrine और Dopamine का लेवल 250% तक बढ़ जाता है, जो दिनभर फोकस रखता है।"),
    ("Span 04 — Evening Heat", "इसके उलट, रात को सोने से पहले गर्म पानी से नहाने पर हाथ-पैरों की रक्त नलिकाएं खुल जाती हैं और अंदर की गर्मी बाहर निकल जाती है।"),
    ("Span 05 — Core Temp Drop", "शरीर का आंतरिक तापमान गिरते ही दिमाग समझ जाता है कि रात हो चुकी है, जिससे मेलाटोनिन रिलीज होता है और 50% गहरी नींद आती है।"),
    ("Span 06 — Daily Thermal Routine", "सुबह 2 मिनट का ठंडा शॉवर लें, और रात को सोने से 90 मिनट पहले गर्म पानी से नहाएं या पैर धोएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल thermal neurobiology awareness के लिए है और cardiovascular disorders में डॉक्टर की सलाह लें।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (14, 165, 233)  # Sky blue for thermal contrast (cold to warm)
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0126 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Thermal Contrast Cold Norepinephrine Warm Sleep Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0126_thermal_contrast_therapy','display_id':'REEL-0126','topic_hi':'Thermal Contrast: सुबह ठंडा और रात को गर्म पानी से नहाने का विज्ञान','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
