...
WORK = ROOT / 'work' / 'reel_0034'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0034_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0034_mood_congruent_memory_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने गौर किया है कि जब आप low feel करते हैं, तो दिमाग को सिर्फ पुरानी गलतियां और नाकामियां ही क्यों याद आती हैं?"),
    ("Span 02 — Mood Congruent Memory", "Cognitive psychology में इसे 'mood-congruent memory' कहते हैं—हमारा वर्तमान mood memory retrieval को filter करता है।"),
    ("Span 03 — Associative Network", "Brain में भावनाएं और यादें interconnected networks में जुड़ी होती हैं, इसलिए वर्तमान भाव समान यादों को trigger करता है।"),
    ("Span 04 — Cyclical Rumination", "इसके कारण एक नकारात्मक चक्र शुरू हो जाता है, जहाँ बुरी यादें mood को और भारी बना देती हैं।"),
    ("Span 05 — Reality Check", "याद रखें कि उस समय आपका दिमाग reality का निष्पक्ष record नहीं दिखा रहा, बल्कि mood-tinted memory दिखा रहा है।"),
    ("Span 06 — Practical Wisdom", "Low mood में अपनी ज़िंदगी या क्षमताओं पर कोई बड़ा अंतिम फैसला लेने से बचें और mood स्थिर होने का इंतज़ार करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive psychology education के लिए है और depression के clinical treatment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(168, 85, 247))  # Purple Memory accent bar
    ...
    draw.text((40, 90), f"REEL-0034 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Psychology & Associative Network Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0034_mood_congruent_memory_and_retrieval_bias',
        'display_id': 'REEL-0034',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0034',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Mood-Congruent Memory: उदास होने पर पुरानी गलतियां ही क्यों याद आती हैं?',
        'topic_key': 'mood_congruent_memory_retrieval_bias',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_psychology_and_memory_retrieval',
