...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब बनी-बनाई योजना अचानक बिगड़ जाती है, तो कुछ लोग टूट जाते हैं जबकि कुछ लोग तुरंत नया रास्ता निकाल लेते हैं?"),
    ("Span 02 — Executive Function", "दिमाग की इस क्षमता को Cognitive Flexibility कहते हैं, जो हमारे Lateral Prefrontal Cortex द्वारा संचालित तीन मुख्य Executive Functions में से एक है।"),
    ("Span 03 — Task-Shifting Test", "Cognitive Psychology में Wisconsin Card Sorting Test के ज़रिए देखा जाता है कि नियम बदलने पर दिमाग कितनी जल्दी नई सोच अपनाता है।"),
    ("Span 04 — Rigid vs Adaptive", "मानसिक रूप से कठोर दिमाग असफल रणनीतियों को दोहराता रहता है, जबकि लचीला दिमाग झटके से सीखकर रणनीति अपडेट करता है।"),
    ("Span 05 — Prediction Error Signal", "सफल लोग गलती को असफलता नहीं, बल्कि दिमाग के लिए Prediction Error Signal मानते हैं, जो नया मॉडल बनाने में मदद करता है।"),
    ("Span 06 — Training Flexibility", "अपनी Cognitive Flexibility बढ़ाने के लिए नई सोच के लोगों से बात करें, और खुद से पूछें कि इसका दूसरा हल क्या हो सकता है?"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल executive function cognitive neuroscience awareness के लिए है और clinical assessment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (14, 165, 233)  # Sky blue for flexibility
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0095 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Cognitive Flexibility Executive Function Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0095_cognitive_flexibility_adaptation','display_id':'REEL-0095','topic_hi':'Cognitive Flexibility: प्लान अचानक बदलने पर कुछ लोग तुरंत कैसे ढल जाते हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
