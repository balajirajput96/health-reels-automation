...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि बिना सोए सिर्फ 20 मिनट आंख बंद करके लेटने से दिमाग का डोपामिन 65% तक वापस रीचार्ज हो जाता है?"),
    ("Span 02 — Science of NSDR", "स्टैनफोर्ड न्यूरोसाइंटिस्ट Andrew Huberman इसे Non-Sleep Deep Rest या प्राचीन योग निद्रा कहते हैं।"),
    ("Span 03 — Copenhagen Brain Scan", "डेनमार्क के शोधकर्ताओं ने ब्रेन स्कैन में पाया कि जब शरीर जागते हुए भी पूरी तरह शांत होता है, तो दिमाग में डोपामिन का भंडार 65% बढ़ जाता है।"),
    ("Span 04 — Theta Waves Cortisol", "यह दिमाग को थीटा तरंगों में ले जाकर तनाव हार्मोन कॉर्टिसोल को खत्म कर देता है और थकान मिटा देता है।"),
    ("Span 05 — Accelerated Learning", "पढ़ाई या काम के बाद 20 मिनट का NSDR करने से सीखी गई बातें याददाश्त में 2 गुना पक्की हो जाती हैं।"),
    ("Span 06 — 20-Min Protocol", "दोपहर में जब थकान लगे, 20 मिनट के लिए सीधे लेट जाएं और हेडफोन पर NSDR की आवाज सुनते हुए गहरी सांस लें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल autonomic relaxation neuroscience awareness के लिए है और sleep apnea or clinical depression medical treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (168, 85, 247)  # Purple / Lavender for NSDR restorative theta brainwaves
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0151 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Non-Sleep Deep Rest NSDR Yoga Nidra Dopamine",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0151_nsdr_yoga_nidra_dopamine','display_id':'REEL-0151','topic_hi':'NSDR (Yoga Nidra): 20 मिनट में दिमाग का डोपामिन 65% रीसेट कैसे करें?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
