...
WORK = ROOT / 'work' / 'reel_0042'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0042_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0042_contemplative_traditions_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप सभी ध्यान-पद्धतियों को एक जैसा समझते हैं? Cognitive science बताती है कि हर तकनीक दिमाग को अलग तरह से train करती है।"),
    ("Span 02 — Focused Attention", "पहला प्रकार है 'Focused Attention'—किसी एक बिंदु (जैसे सांस) पर लगातार ध्यान केंद्रित करना और भटकाव को वापस लाना।"),
    ("Span 03 — Open Monitoring", "दूसरा प्रकार है 'Open Monitoring'—बिना किसी प्रतिक्रिया या जजमेंट के अपने वर्तमान विचारों और शारीरिक संवेदनाओं का साक्षी बनना।"),
    ("Span 04 — Compassion Practice", "तीसरा प्रकार है 'Compassion Meditation'—दूसरों और स्वयं के प्रति दया, शांति और सदिच्छा की भावना को सक्रिय करना।"),
    ("Span 05 — Distinct Neural Profiles", "Brain research दर्शाती है कि Focused Attention attention networks को मजबूत करता है, जबकि Compassion empathy circuits को।"),
    ("Span 06 — Targeted Practice", "अपनी आवश्यकता (एकाग्रता, भावनात्मक शांति, या सहानुभूति) के अनुसार उपयुक्त ध्यान पद्धति का चयन करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल contemplative cognitive science education के लिए है और medical treatment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(99, 102, 241))  # Indigo Traditions accent bar
    ...
    draw.text((40, 90), f"REEL-0042 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Contemplative Cognitive Science & Neural Network Taxonomy", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0042_contemplative_traditions_and_cognitive_networks',
        'display_id': 'REEL-0042',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0042',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Meditation Traditions: ध्यान की अलग-अलग पद्धतियों का वैज्ञानिक वर्गीकरण',
        'topic_key': 'contemplative_traditions_cognitive_networks',
        'pillar': 'mental_health',
        'evidence_class': 'contemplative_cognitive_science_and_neuroimaging',
