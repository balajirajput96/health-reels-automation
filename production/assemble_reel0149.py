...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि अगर आप इतनी धीमी रफ्तार से दौड़ें कि आप बात कर सकें, तो शरीर में तेजी से हांफने की तुलना में ज्यादा फैट जलता है?"),
    ("Span 02 — Zone 2 Science", "स्पोर्ट्स फिजियोलॉजिस्ट Dr. Iñigo San Millán के अनुसार, इसे Zone 2 Cardio कहा जाता है।"),
    ("Span 03 — Mitochondrial Growth", "धीमी कसरत मांसपेशियों में लाखों नए माइटोकॉन्ड्रिया पैदा करती है, जो शरीर के इंजन को नया बना देते हैं।"),
    ("Span 04 — Pure Fat Fuel", "इस गति पर शरीर चीनी के बजाय सीधे जमा चर्बी को ईंधन बनाकर जलाता है और लैक्टिक एसिड बनने नहीं देता।"),
    ("Span 05 — Heart and Longevity", "यही कारण है कि ओलंपिक एथलीट अपनी 80% ट्रेनिंग बिल्कुल धीमी रफ्तार में करते हैं ताकि उनका दिल फौलादी बने।"),
    ("Span 06 — Conversational Rule", "हफ्ते में 3 दिन 45 मिनट ऐसी रफ्तार में वॉक, जॉगिंग या साइकिल चलाएं जिसमें आपकी सांस न फूले और आप बातचीत कर सकें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cardiovascular exercise physiology awareness के लिए है और customized athletic training or cardiac rehabilitation का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (14, 165, 233)  # Sky blue for aerobic Zone 2 cardio & cellular endurance
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0149 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Zone 2 Cardio Mitochondrial Density Fat Burn",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0149_zone2_mitochondria_fatburn','display_id':'REEL-0149','topic_hi':'Zone 2 Cardio: धीमी दौड़ से फैट और स्टेमिना 3 गुना तेजी से क्यों बढ़ता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
