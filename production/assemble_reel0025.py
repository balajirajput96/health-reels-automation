...
WORK = ROOT / 'work' / 'reel_0025'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0025_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0025_choice_overload_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने गौर किया है कि तीस options में से चुनना, तीन options के मुकाबले ज्यादा तनावपूर्ण क्यों होता है?"),
    ("Span 02 — Behavioral Economics", "Behavioral economics research दर्शाती है कि बहुत ज्यादा choices मिलने पर 'choice overload' और decision fatigue हो सकती है।"),
    ("Span 03 — Cognitive Load & Regret", "जब बहुत सारे विकल्प होते हैं, तो brain पर cognitive load बढ़ता है और 'गलत चुनाव' का regret anticipation शुरू हो जाता है।"),
    ("Span 04 — Decision Paralysis", "इसके कारण या तो हम decision लेने में delay करते हैं, या चुनने के बाद भी कम संतुष्ट महसूस करते हैं।"),
    ("Span 05 — Simplification Strategy", "अपने daily routine में options को simplify करना और default choices सेट करना decision fatigue को कम कर सकता है।"),
    ("Span 06 — Contextual Application", "याद रखें कि हर जगह options कम करना जरूरी नहीं, लेकिन repetitive daily tasks में simplicity मदद कर सकती है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral science education के लिए है और psychological consultation का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(244, 63, 94))  # Rose Decision Science accent bar
    ...
    draw.text((40, 90), f"REEL-0025 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Behavioral Economics & Decision Science Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0025_choice_overload_and_decision_fatigue',
        'display_id': 'REEL-0025',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0025',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Choice Overload: ज्यादा Options और Decision Fatigue का Scientific Reason',
        'topic_key': 'choice_overload_decision_fatigue',
        'pillar': 'mental_health',
        'evidence_class': 'behavioral_economics_and_decision_science',
