...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी अनुभव किया है कि जब आप किसी काम में पूरी तरह डूब जाते हैं, तो समय का पता नहीं चलता और मन का संकोच और डर गायब हो जाता है?"),
    ("Span 02 — Flow State Definition", "Psychologist Mihaly Csikszentmihalyi ने इसे Flow State कहा है—जहाँ इंसान अपनी पूरी क्षमता के साथ प्रदर्शन करता है।"),
    ("Span 03 — Transient Hypofrontality", "Neuroscientist Arne Dietrich ने पाया कि फ्लो में दिमाग का Dorsolateral Prefrontal Cortex हिस्सा कुछ समय के लिए धीमा हो जाता है।"),
    ("Span 04 — Silencing Inner Critic", "यही वह हिस्सा है जो खुद पर शक करता है और पुरानी गलतियों पर पछताता है—इसके शांत होते ही ओवरथिंकिंग और डर पूरी तरह बंद हो जाता है।"),
    ("Span 05 — Neurochemical Cocktail", "इस दौरान दिमाग में Dopamine, Norepinephrine और Anandamide जैसे फील-गुड न्यूरोट्रांसमीटर्स का जबरदस्त संगम होता है।"),
    ("Span 06 — 90-Minute Protocol", "फ्लो स्टेट में जाने के लिए फोन को दूर रखें और 90 मिनट तक केवल एक स्पष्ट लक्ष्य पर बिना रुके काम करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive neuroscience awareness के लिए है और clinical psychological assessment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (14, 165, 233)  # Sky blue for deep focus / flow
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0106 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Flow State Transient Hypofrontality dlPFC Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0106_flow_state_hypofrontality','display_id':'REEL-0106','topic_hi':'Flow State: दिमाग फोकस में होने पर अंदर की आवाज क्यों चुप होती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
