...
WORK = ROOT / 'work' / 'reel_0062'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0062_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0062_attentional_tunneling_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने देखा है कि किसी बड़े खतरे या घबराहट में इंसान को सिर्फ सामने की मुख्य चीज़ दिखती है और आसपास का सब कुछ गायब हो जाता है?"),
    ("Span 02 — The Easterbrook Hypothesis", "Cognitive Science में इसे 'Easterbrook Hypothesis' या 'Attentional Tunneling' कहते हैं—तनाव बढ़ने पर ध्यान का दायरा संकरा हो जाता है।"),
    ("Span 03 — Weapon Focus Effect", "क्रिमिनोलॉजी में पाया गया कि हमले के समय गवाह केवल हथियार को याद रख पाते हैं, लेकिन हमलावर का चेहरा पूरी तरह भूल जाते हैं।"),
    ("Span 04 — Evolutionary Survival Logic", "हमारा दिमाग खतरे के मुख्य स्रोत पर पूरा फोकस लगा देता है ताकि बाकी की गैर-ज़रूरी जानकारी को नजरअंदाज किया जा सके।"),
    ("Span 05 — High Pressure Blindspots", "लेकिन आधुनिक जीवन में यह टनल विजन परीक्षा या मीटिंग में ज़रूरी विकल्पों और तर्कों को दिमाग से ओझल कर देता है।"),
    ("Span 06 — Panoramic Vision Reset", "जब भी ऐसा महसूस हो, अपनी नज़र को चौड़ा करें और कमरे के दोनों कोनों को एक साथ देखने का प्रयास करें—इससे टनल विजन टूटता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive psychology awareness के लिए है और clinical attention deficit diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(234, 179, 8))  # Yellow Attentional Tunneling accent bar
    ...
    draw.text((40, 90), f"REEL-0062 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Psychology & Easterbrook Attentional Tunneling Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0062_stress_and_attentional_tunneling',
        'display_id': 'REEL-0062',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0062',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Stress and Attentional Tunneling: तनाव में दिमाग की नज़र संकरी (Tunnel Vision) क्यों हो जाती है?',
        'topic_key': 'stress_attentional_tunneling_weapon_focus',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_psychology_and_attentional_narrowing',
