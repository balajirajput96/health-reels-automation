...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि सबसे बड़े विचार काम करते समय नहीं, बल्कि टहलते समय, नहाते समय या सोने से ठीक पहले ही क्यों आते हैं?"),
    ("Span 02 — Discovery of DMN", "Neuroscientist Marcus Raichle ने खोजा कि जब हम खाली बैठते हैं, तब दिमाग का Default Mode Network सबसे ज्यादा सक्रिय होता है।"),
    ("Span 03 — DMN vs TPN", "काम करते समय हमारा Task-Positive Network चालू रहता है, लेकिन जब हम रुकते हैं, तो DMN चालू होकर अतीत और भविष्य की कड़ियों को जोड़ने लगता है।"),
    ("Span 04 — Subconscious Eureka", "DMN अचेतन रूप से पुरानी यादों और नई समस्याओं को आपस में मिलाकर अचानक Eureka Moments पैदा करता है।"),
    ("Span 05 — Narrative Self Identity", "यह नेटवर्क हमारी आत्म-पहचान, प्राथमिकताओं और भविष्य की योजनाओं को आकार देने का काम भी करता है।"),
    ("Span 06 — Constant Screen Trap", "लगातार मोबाइल देखते रहने से DMN को सक्रिय होने का मौका नहीं मिलता, जिससे रचनात्मकता घटने लगती है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive neuroscience education awareness के लिए है और clinical attention assessment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (168, 85, 247)  # Purple for DMN/creativity
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0091 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Default Mode Network Creativity Evidence",fill=(148,163,184),font=fb)
