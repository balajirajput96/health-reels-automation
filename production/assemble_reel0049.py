...
WORK = ROOT / 'work' / 'reel_0049'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0049_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0049_memory_reconsolidation_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने गौर किया है कि जितनी बार आप किसी पुरानी बात को याद करते हैं, उसका भावनात्मक असर उतना ही बदलने लगता है?"),
    ("Span 02 — Biological Breakthrough", "Neuroscience की एक क्रांतिकारी खोज है 'Memory Reconsolidation'—यादों को याद करते ही उनका न्यूरल कनेक्शन फिर से लचीला (malleable) हो जाता है।"),
    ("Span 03 — The Labile Window", "जब कोई पुरानी याद दिमाग में active होती है, तो कुछ घंटों के लिए उसकी synaptic stability खुल जाती है।"),
    ("Span 04 — Protein Synthesis Restabilization", "उस याद को दिमाग में दोबारा सुरक्षित (reconsolidate) करने के लिए नए प्रोटीन और न्यूरल सिग्नल्स की ज़रूरत पड़ती है।"),
    ("Span 05 — Opportunity For Update", "इस खुले हुए समय में, यदि आप उस याद को नई समझ या शांत नजरिए के साथ जोड़ते हैं, तो वह नए रूप में स्टोर होती है।"),
    ("Span 06 — Emotional Healing", "यह प्रक्रिया बताती है कि हम पुरानी कड़वी यादों के चुभते हुए भावनात्मक भार को सही सोच के साथ हल्का कर सकते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल neurobiology awareness के लिए है और clinical trauma therapy का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(236, 72, 153))  # Pink Reconsolidation accent bar
    ...
    draw.text((40, 90), f"REEL-0049 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cellular Neuroscience & Synaptic Reconsolidation Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0049_memory_reconsolidation_and_synaptic_plasticity',
        'display_id': 'REEL-0049',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0049',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Memory Reconsolidation: यादों को दोबारा लिखने और अपडेट करने का Neuroscience',
        'topic_key': 'memory_reconsolidation_synaptic_plasticity',
        'pillar': 'mental_health',
        'evidence_class': 'cellular_neuroscience_and_synaptic_plasticity',
