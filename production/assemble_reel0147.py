...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि हमारे शरीर में एक ऐसी चमत्कारी चर्बी होती है, जो वजन बढ़ाने के बजाय बाकी चर्बी और शुगर को भट्टी की तरह जलाकर खत्म करती है?"),
    ("Span 02 — White vs Brown Fat", "वैज्ञानिक इसे Brown Adipose Tissue कहते हैं। सफेद चर्बी कैलोरी जमा करती है, जबकि भूरी चर्बी में लाखों माइटोकॉन्ड्रिया होते हैं।"),
    ("Span 03 — The UCP1 Engine", "भूरी चर्बी में मौजूद UCP1 प्रोटीन खाने की ऊर्जा को सीधे गर्मी में बदल देता है, जिससे शरीर का मेटाबॉलिज्म तेज हो जाता है।"),
    ("Span 04 — The Cold Trigger", "जब शरीर पर हल्की ठंड पड़ती है, तो दिमाग तुरंत भूरी चर्बी को सक्रिय करके खून से ग्लूकोज और फैट जलाने का आदेश देता है।"),
    ("Span 05 — Fat Browning", "नियमित ठंड के संपर्क से आपकी पुरानी सफेद चर्बी भी ब्राउन फैट में बदलने लगती है।"),
    ("Span 06 — Daily Activation", "सुबह नहाते वक्त आखिरी 1 मिनट ठंडा पानी डालें और रात में कमरे का तापमान थोड़ा ठंडा रखें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल metabolic thermal biology awareness के लिए है और hypothermia or cardiovascular disease clinical treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (249, 115, 22)  # Orange / Bronze for brown adipose tissue & thermogenesis heat
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0147 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Brown Adipose Tissue UCP1 Thermogenesis Cold",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0147_brown_adipose_ucp1','display_id':'REEL-0147','topic_hi':'Brown Fat: शरीर की खास चर्बी बाकी चर्बी को भट्टी की तरह कैसे जलाती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
