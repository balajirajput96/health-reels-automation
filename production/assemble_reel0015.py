...
WORK = ROOT / 'work' / 'reel_0015'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0015_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0015_meal_breaks_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "व्यस्त दिनों में consistent meal breaks लेना क्यों ज़रूरी हो सकता है?"),
    ("Span 02 — Cognitive Function", "Research describe करती है कि hectic schedule के दौरान break लेने से focus और cognitive function improve हो सकते हैं।"),
    ("Span 03 — Impact of Fatigue", "जब हम बिना ब्रेक के लगातार काम करते हैं, तो stress levels बढ़ सकते हैं और fatigue हो सकती है।"),
    ("Span 04 — Public Health", "Public health sources के अनुसार, scheduled breaks mindful eating को बढ़ावा देते हैं और energy maintain करते हैं।"),
    ("Span 05 — Practice", "आप अपने daily routine में छोटे breaks plan करके work-life balance को support कर सकते हैं।"),
    ("Span 06 — Educational Context", "यह वीडियो केवल general-education awareness के लिए है; यह किसी professional medical diagnosis का विकल्प नहीं है।"),
    ("Span 07 — Safety Boundary", "किसी भी personal diet change या health decision से पहले qualified healthcare provider से consult करें।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(52, 211, 153))  # Emerald accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(52, 211, 153), font=font_header)
    draw.text((40, 90), f"REEL-0015 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Harvard T.H. Chan & PMC Nutrition Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0015_consistent_meal_breaks_during_busy_workdays',
        'display_id': 'REEL-0015',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0015',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Consistent Meal Breaks: Busy Workdays में Focus और Well-Being के लिए Scientific Insights',
        'topic_key': 'consistent_meal_breaks_busy_workdays',
        'pillar': 'nutrition',
        'evidence_class': 'harvard_hsph_and_peer_reviewed_pmc',
