...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब कोई आपसे कहता है कि यह काम बिल्कुल मत करना, तो हमारा दिमाग उसी काम को करने के लिए सबसे ज्यादा उतावला क्यों हो जाता है?"),
    ("Span 02 — Reactance Theory", "मनोवैज्ञानिक Jack Brehm ने इसे Psychological Reactance कहा है—यह आजादी छिनने पर दिमाग का रक्षात्मक रिएक्शन है।"),
    ("Span 03 — Threat to Autonomy", "जब भी कोई हम पर हुक्म चलाता है, हमारा दिमाग अपनी स्वायत्तता बचाने के लिए जानबूझकर उल्टा रास्ता चुनता है।"),
    ("Span 04 — Forbidden Fruit", "किसी चीज पर रोक लगते ही दिमाग में उसकी कीमत और आकर्षण अचानक कई गुना बढ़ जाता है।"),
    ("Span 05 — Magic Phrase", "रिसर्च में पाया गया कि अगर आप किसी से कहें लेकिन अंतिम फैसला पूरी तरह आपका है, तो लोग आपकी बात मानने के लिए दोगुना तैयार हो जाते हैं।"),
    ("Span 06 — Two-Option Rule", "दूसरों को या खुद को राजी करने के लिए हुक्म देने के बजाय हमेशा दो अच्छे विकल्प दें, ताकि दिमाग को खुद चुनने की आजादी महसूस हो।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social cognitive psychology awareness के लिए है और clinical behavioral assessment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (225, 29, 72)  # Rose / Crimson for psychological reactance / autonomy
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0122 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Psychological Reactance Autonomy Choice Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0122_psychological_reactance','display_id':'REEL-0122','topic_hi':'Psychological Reactance: मना करने पर उल्टा करने का मन क्यों करता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
