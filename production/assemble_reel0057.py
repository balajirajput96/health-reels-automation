...
WORK = ROOT / 'work' / 'reel_0057'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0057_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0057_procrastination_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब कोई ज़रूरी काम करना होता है, तभी हमारा हाथ अचानक सोशल मीडिया स्क्रॉल करने क्यों लग जाता है?"),
    ("Span 02 — Emotional Regulation Failure", "Psychology साबित करती है कि टालमटोल (Procrastination) आलस्य नहीं है, बल्कि तनाव और नकारात्मक भावनाओं से बचने की कोशिश है।"),
    ("Span 03 — Limbic vs Prefrontal Battle", "दिमाग का भावनात्मक हिस्सा (Limbic system) तुरंत राहत चाहता है, जबकि सोचने वाला हिस्सा (Prefrontal Cortex) दूर के फायदे देखता है।"),
    ("Span 04 — Temporal Discounting", "इसे 'Temporal Discounting' कहते हैं—मानव मस्तिष्क भविष्य के बड़े इनाम की तुलना में आज के तुरंत मिलने वाले आराम को ज़्यादा तरजीह देता है।"),
    ("Span 05 — Fear Of Failure", "काम में असफलता या परफेक्ट न होने का डर दिमाग में अलार्म बजाता है, जिससे हम काम शुरू करने से ही बचने लगते हैं।"),
    ("Span 06 — The 2-Minute Micro-Start", "समाधान यह है कि काम को इतना छोटा कर दें (जैसे सिर्फ 2 मिनट के लिए एक लाइन लिखना) कि दिमाग डरना बंद कर दे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral psychology awareness के लिए है और clinical mental health diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(139, 92, 246))  # Violet Procrastination accent bar
    ...
    draw.text((40, 90), f"REEL-0057 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Behavioral Psychology & Temporal Motivation Theory Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0057_procrastination_and_temporal_discounting',
        'display_id': 'REEL-0057',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0057',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Procrastination: टालमटोल (Delay) करने के पीछे का असली Neuroscience',
        'topic_key': 'procrastination_temporal_discounting',
        'pillar': 'mental_health',
        'evidence_class': 'behavioral_psychology_and_temporal_motivation_theory',
