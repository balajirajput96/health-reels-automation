...
WORK = ROOT / 'work' / 'reel_0023'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0023_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0023_breath_awareness_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी गौर किया है कि एक धीमी, गहरी सांस शरीर में तुरंत क्या बदलाव लाती है?"),
    ("Span 02 — Autonomic Physiology", "Autonomic physiology research दिखाती है कि controlled respiration parasympathetic nervous system को engage करती है।"),
    ("Span 03 — Vagus Nerve Mechanism", "जब हम सांस को धीरे-धीरे छोड़ते हैं (prolonged exhalation), तो vagus nerve stimulate होती है।"),
    ("Span 04 — Heart Rate Variability", "यह vagal brake heart rate को modulate करता है और heart rate variability को improve करने में मदद करता है।"),
    ("Span 05 — Rhythmic Regulatory Cue", "चार से छह सेकंड की slow rhythmic breathing acute stress में body को calm down करने का effective cue बन सकती है।"),
    ("Span 06 — Personal Capacity", "हर व्यक्ति की baseline breathing capacity अलग होती है, इसलिए अभ्यास हमेशा सहजता और बिना strain के करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल general education के लिए है और clinical anxiety या medical treatment का विकल्प नहीं है।"),
]

CAPTION_TEXT = [span[1] for span in SPANS]
WEIGHTS = [0.14, 0.16, 0.16, 0.16, 0.14, 0.12, 0.12]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(6, 182, 212))  # Cyan Physiology accent bar
    ...
    draw.text((40, 90), f"REEL-0023 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Autonomic Physiology & Vagal Tone Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0023_breath_awareness_and_parasympathetic_response',
        'display_id': 'REEL-0023',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0023',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Breath Awareness: Parasympathetic Nervous System और Vagal Tone का विज्ञान',
        'topic_key': 'breath_awareness_parasympathetic_response',
        'pillar': 'stress_management',
        'evidence_class': 'autonomic_physiology_and_neuroscience',
