...
WORK = ROOT / 'work' / 'reel_0026'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0026_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0026_observational_learning_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या किसी को देखकर सीखना सिर्फ नकल करना है? Cognitive science कहती है—यह उससे कहीं ज्यादा गहरा है।"),
    ("Span 02 — Action vs Outcome", "Observational learning में brain न सिर्फ दूसरे के action को देखता है, बल्कि उसके outcome से भी सीखता है।"),
    ("Span 03 — Behavioral Transfer", "Experiments मापते हैं कि नई situation में व्यक्ति कितनी सटीकता और speed से सही choice करता है।"),
    ("Span 04 — Prediction Error", "Researchers choice data से prediction error और learning rate जैसे model-based variables calculate करते हैं।"),
    ("Span 05 — Neural Correlates", "EEG और fMRI task के दौरान brain activity के electrical signals और cognitive correlates को ट्रैक करते हैं।"),
    ("Span 06 — Scientific Nuance", "याद रखिए, सिर्फ copy करना, सीखना और गहराई से समझना—तीन बिल्कुल अलग processes हो सकती हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive science education के लिए है और psychological diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(20, 184, 166))  # Teal Learning accent bar
    ...
    draw.text((40, 90), f"REEL-0026 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Science & Observational Modeling Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0026_observational_learning_and_modeling',
        'display_id': 'REEL-0026',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0026',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Observational Learning: दूसरों को देखकर सीखने का Cognitive Science',
        'topic_key': 'observational_learning_and_modeling',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_science_and_reinforcement_modeling',
