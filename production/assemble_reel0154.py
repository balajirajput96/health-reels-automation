...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी गौर किया है कि जिस प्रोजेक्ट के लिए आपको 1 महीने का वक्त मिलता है, वह पूरा भी 1 महीने में ही होता है—लेकिन आखिरी रात में आप 80% काम 3 घंटे में कैसे निपटा देते हैं?"),
    ("Span 02 — Parkinson Discovery", "बिहेवियरल साइंस में इसे Parkinson's Law कहते हैं: काम उतना ही फैल जाता है जितना उसे पूरा करने के लिए समय दिया जाए।"),
    ("Span 03 — Endless Time Trap", "जब किसी काम के लिए बहुत ज्यादा वक्त होता है, तो दिमाग फालतू परफेक्शन और आलस में समय बर्बाद करने लगता है।"),
    ("Span 04 — Deadline Hyperfocus", "लेकिन जैसे ही डेडलाइन सिर पर आती है, दिमाग की सारी फालतू सोच बंद हो जाती है और सिर्फ जरूरी काम पर लेजर जैसा फोकस बन जाता है।"),
    ("Span 05 — The 50% Time Cut", "रिसर्च में पाया गया कि सख्त समय सीमा तय करने से काम की गुणवत्ता कम नहीं होती, बल्कि रफ्तार दोगुनी हो जाती है।"),
    ("Span 06 — Aggressive Deadline", "अगली बार जब कोई काम करना हो, तो खुद को आधा समय दें—अगर 4 दिन का काम है, तो 2 दिन का लक्ष्य रखें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल productivity psychology awareness के लिए है और workplace burnout prevention management का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (234, 88, 12)  # High-energy orange for Parkinson's law time compression
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0154 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Parkinsons Law Time Scarcity Deadline Focus",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0154_parkinsons_law_deadlines','display_id':'REEL-0154','topic_hi':'Parkinsons Law: जिस काम को 2 हफ्ते दें वह 2 घंटे में कैसे होता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
