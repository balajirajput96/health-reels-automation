...
WORK = ROOT / 'work' / 'reel_0047'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0047_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0047_working_memory_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी अनुभव किया है कि एक साथ चार नई बातें सुनते ही दिमाग का संतुलन बिगड़ने लगता है?"),
    ("Span 02 — Cognitive Whiteboard", "Cognitive psychology में इसे 'Working Memory' कहते हैं—यह हमारे दिमाग का सक्रिय व्हाइटबोर्ड या कंप्यूटर की RAM जैसा है।"),
    ("Span 03 — 4-Chunk Capacity", "रिसर्च दर्शाती है कि हमारा चेतन मन एक समय में केवल लगभग 4 नई जानकारी या 'chunks' को ही सक्रिय रख सकता है।"),
    ("Span 04 — Multitasking Overload", "जब हम एक साथ कई कामों में ध्यान बांटते हैं, तो working memory तुरंत भर जाती है और गलतियां होने लगती हैं।"),
    ("Span 05 — Chunking Strategy", "बड़ी जानकारी को छोटे समूहों (chunks) में बांटकर याद रखना (जैसे 10 अंकों के नंबर को 3-3-4 में तोड़ना) क्षमता को बढ़ाता है।"),
    ("Span 06 — Cognitive Offloading", "दिमाग को बेवजह बोझिल करने के बजाय टू-डू लिस्ट और नोट्स का उपयोग करके अपनी मानसिक ऊर्जा जटिल सोच के लिए बचाएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive science awareness के लिए है और neurological assessment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(2, 132, 199))  # Sky Working Memory accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(2, 132, 199), font=font_header)
    draw.text((40, 90), f"REEL-0047 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Psychology & Working Memory Capacity Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0047_working_memory_capacity_and_cognitive_load',
        'display_id': 'REEL-0047',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0047',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Working Memory: दिमाग के सीमित कार्यक्षेत्र (RAM) को समझने का विज्ञान',
        'topic_key': 'working_memory_capacity_cognitive_load',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_psychology_and_executive_function',
