...
WORK = ROOT / 'work' / 'reel_0028'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0028_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0028_choice_architecture_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने ध्यान दिया है कि ज्यादातर लोग किसी form या app में default settings को कभी नहीं बदलते?"),
    ("Span 02 — Choice Architecture", "Behavioral economics में इसे 'choice architecture' कहते हैं—जिसमें विकल्पों की प्रस्तुति चुनाव को nudge करती है।"),
    ("Span 03 — Status Quo Bias", "Brain cognitive energy बचाने के लिए default option को चुनता है, क्योंकि opt-out करने में extra effort लगता है।"),
    ("Span 04 — Real-World Impact", "Studies दर्शाती हैं कि जब helpful options को default बनाया जाता है, तो participation rates dramatically बढ़ जाते हैं।"),
    ("Span 05 — Personal Defaults", "आप अपने phone और घर में healthy habits को 'default setting' बनाकर willpower पर निर्भरता घटा सकते हैं।"),
    ("Span 06 — Freedom of Choice", "याद रखें कि good choice architecture हमेशा व्यक्ति को दूसरा विकल्प चुनने की पूरी स्वतंत्रता देती है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral science awareness के लिए है और clinical consultation का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(245, 158, 11))  # Amber Choice accent bar
    ...
    draw.text((40, 90), f"REEL-0028 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Behavioral Economics & Choice Architecture Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0028_choice_architecture_and_defaults',
        'display_id': 'REEL-0028',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0028',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Choice Architecture: Default Options और Nudge Theory का विज्ञान',
        'topic_key': 'choice_architecture_and_defaults',
        'pillar': 'mental_health',
        'evidence_class': 'behavioral_economics_and_nudge_theory',
