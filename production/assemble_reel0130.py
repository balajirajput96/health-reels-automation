...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब कोई काम बहुत जरूरी होता है, तब भी हमारा दिमाग उसे टालकर बेकार के रील्स क्यों देखने लगता है?"),
    ("Span 02 — Limbic vs Prefrontal", "न्यूरोसाइंस के अनुसार, यह आलस नहीं है बल्कि दिमाग के दो हिस्सों—इमोशनल Limbic System और तार्किक Prefrontal Cortex की लड़ाई है।"),
    ("Span 03 — Emotional Coping", "रिसर्च बताती है कि प्रोक्रेस्टिनेशन समय की कमी नहीं, बल्कि काम से जुड़े डर, बोरियत या परफेक्शनिज्म के तनाव से बचने का तरीका है।"),
    ("Span 04 — Immediate Relief Trap", "काम टालते ही दिमाग को तुरंत तनाव से राहत मिलती है, और दिमाग इस टालमटोल को एक इनाम मान लेता है।"),
    ("Span 05 — The Future Stranger", "ब्रेन स्कैन में देखा गया कि दिमाग हमारे भविष्य के रूप को एक अजनबी समझता है और सारा बोझ उस पर छोड़ देता है।"),
    ("Span 06 — 2-Minute Solution", "काम को इतना छोटा कर दें कि दिमाग डरे नहीं—जैसे सिर्फ किताब खोलकर 1 लाइन पढ़ना। शुरू होते ही सारा डर गायब हो जाता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral neuroscience awareness के लिए है और clinical adult ADHD treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (244, 63, 94)  # Rose / Coral for limbic emotional friction
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0130 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Procrastination Limbic Hijack Emotional Regulation",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0130_procrastination_neuroscience','display_id':'REEL-0130','topic_hi':'Procrastination: काम टालना आलस नहीं, दिमाग का इमोशनल डिफेन्स है','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
