...
WORK = ROOT / 'work' / 'reel_0068'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0068_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0068_empathy_neuroscience_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी गौर किया है कि जब सामने किसी को चोट लगती है, तो अचानक आपके अपने पेट और दिल में भी दर्द क्यों महसूस होने लगता है?"),
    ("Span 02 — The Shared Pain Matrix", "Neuroscience में इसे 'Shared Pain Matrix' कहते हैं—दूसरों को दर्द में देखकर हमारे दिमाग के दर्द वाले हिस्से खुद सक्रिय हो जाते हैं।"),
    ("Span 03 — Insula And ACC Activation", "fMRI स्टडीज में देखा गया कि दूसरों की पीड़ा देखकर हमारे दिमाग का 'Anterior Insula' और 'ACC' हिस्सा बिल्कुल वैसे ही चमक उठता है।"),
    ("Span 04 — Two Empathy Systems", "सहानुभूति दो प्रकार की होती है: 'Affective Empathy' (दूसरे का दर्द महसूस करना) और 'Cognitive Empathy' (उनकी स्थिति को समझना)।"),
    ("Span 05 — The Empathy Burnout Trap", "यदि आप सिर्फ दूसरों का दर्द महसूस करते रहेंगे, तो दिमाग में भावनात्मक तनाव (Empathetic Distress) और थकान बढ़ जाएगी।"),
    ("Span 06 — Shifting To Compassion", "समाधान यह है कि केवल दर्द को महसूस करने के बजाय 'करुणा' (Compassion) अपनाएं—यानी शांत रहकर मदद करने की भावना रखें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social affective neuroscience awareness के लिए है और clinical psychiatric diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(244, 114, 182))  # Pink-Rose Empathy accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(244, 114, 182), font=font_header)
    draw.text((40, 90), f"REEL-0068 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Affective Neuroscience & Shared Pain Matrix Empathy Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0068_neural_basis_of_empathy_shared_pain',
        'display_id': 'REEL-0068',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0068',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Empathy: दूसरों का दर्द देखकर हमारे दिमाग में क्या होता है?',
        'topic_key': 'neural_basis_of_empathy_shared_pain_matrix',
        'pillar': 'mental_health',
        'evidence_class': 'social_affective_neuroscience_and_empathy',
