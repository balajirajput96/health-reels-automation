...
WORK = ROOT / 'work' / 'reel_0061'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0061_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0061_stress_recovery_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने सोचा है कि किसी तनावपूर्ण घटना के बाद कुछ लोग तुरंत सामान्य हो जाते हैं, जबकि कुछ को घंटों बेचैनी रहती है?"),
    ("Span 02 — Dynamic Recovery Trajectory", "Science में 'Stress Recovery' का मतलब सिर्फ तनाव खत्म होना नहीं, बल्कि शरीर का baseline पर लौटने की गति है।"),
    ("Span 03 — The Vagal Brake", "हमारा पैरासिम्पेथेटिक सिस्टम (Vagus Nerve) दिल की तेज़ धड़कन पर ब्रेक लगाकर रक्तचाप को सामान्य करता है।"),
    ("Span 04 — Heart Rate Variability (HRV)", "रिसर्च में 'HRV' (Heart Rate Variability) मापी जाती है—जितना लचीला दिल का रिदम होगा, उतनी ही तेज़ रिकवरी होगी।"),
    ("Span 05 — Acute vs Allostatic Wear", "अगर तनाव के बाद शरीर को आराम न मिले, तो कॉर्टिसोल का स्तर बना रहता है जो शारीरिक थकान बढ़ाता है।"),
    ("Span 06 — Activating Parasympathetic Reset", "लंबी गहरी सांस (जैसे 2 बार नाक से सांस लेकर मुंह से धीरे छोड़ना) तुरंत वेगस नर्व को सक्रिय करके दिल को शांत करती है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल autonomic psychophysiology education के लिए है और clinical autonomic diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(16, 185, 129))  # Emerald Green Stress Recovery accent bar
    ...
    draw.text((40, 90), f"REEL-0061 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Autonomic Psychophysiology & Vagal Restoration Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0061_autonomic_stress_recovery',
        'display_id': 'REEL-0061',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0061',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Stress Recovery: तनाव के बाद शरीर को शांत करने का असली Neuroscience',
        'topic_key': 'stress_recovery_vagal_restoration',
        'pillar': 'mental_health',
        'evidence_class': 'autonomic_psychophysiology_and_stress_recovery',
