...
WORK = ROOT / 'work' / 'reel_0013'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0013_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0013_evening_reflection_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या रात को सोने से पहले दिन भर के thoughts आपके mind में घूमते रहते हैं? Research describes करती है कि evening reflection एक natural mental transition हो सकती है।"),
    ("Span 02 — Cognitive Offloading", "Din के end में thoughts और tasks को paper पर लिखना cognitive offloading कहलाता है, जो mental load को reduce करने में help कर सकता है।"),
    ("Span 03 — PMC Research", "Studies suggest करती हैं कि bedtime writing से active thinking calm होती है और sleep onset fast हो सकता है।"),
    ("Span 04 — Psychological Closure", "Apni daily achievements या pending tasks को note down करके आप एक clear psychological closure create कर सकते हैं।"),
    ("Span 05 — Signal for Rest", "Yeh routine brain को signal देने में help करती है कि day over हो चुका है और body rest के लिए prepare हो सकती है।"),
    ("Span 06 — Educational Context", "यह content केवल general education और awareness के लिए है, किसी medical condition का diagnosis नहीं है।"),
    ("Span 07 — Safety Boundary", "Personal health guidance के लिए हमेशा qualified healthcare professional से consult करें।"),
]

CAPTION_TEXT = [span[1] for span in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.15, 0.12, 0.11]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(168, 85, 247))  # Purple accent bar
    ...
    draw.text((40, 90), f"REEL-0013 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "PMC & Harvard Health Public Health Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0013_evening_reflection_and_cognitive_offloading',
        'display_id': 'REEL-0013',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0013',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Evening Reflection और Cognitive Offloading: Sleep Quality के लिए Scientific Insights',
        'topic_key': 'evening_reflection_cognitive_offloading',
        'pillar': 'sleep',
        'evidence_class': 'peer_reviewed_pmc_and_harvard_health',
