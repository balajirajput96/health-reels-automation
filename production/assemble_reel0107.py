...
SPANS = [
    ("Span 01 — Hook", "अगर आपको अचानक बहुत तेज़ तनाव, घबराहट या गुस्सा आ जाए, तो सिर्फ 20 सेकंड में खुद को शांत करने का सबसे तेज़ वैज्ञानिक तरीका क्या है?"),
    ("Span 02 — Collapsed Alveoli", "तनाव में हमारी सांसें उथली हो जाती हैं, जिससे फेफड़ों की लाखों छोटी थैलियां सिकुड़ जाती हैं और शरीर में कार्बन डाइऑक्साइड फंस जाती है।"),
    ("Span 03 — Double Inhale Secret", "वैज्ञानिक इसे Physiological Sigh कहते हैं—नाक से एक गहरी सांस लें, और तुरंत उसके ऊपर एक और छोटा सा घूंट भरें।"),
    ("Span 04 — Re-Inflating Lungs", "यह दूसरी छोटी सांस सिकुड़ी हुई थैलियों को तुरंत खोल देती है, जिससे फेफड़ों की क्षमता पूरी तरह रीसेट हो जाती है।"),
    ("Span 05 — Long Slow Exhale", "इसके बाद मुंह से धीरे-धीरे पूरी हवा बाहर छोड़ें—लंबी सांस छोड़ने से दिमाग की Vagus Nerve दिल की धड़कन को तुरंत धीमा कर देती है।"),
    ("Span 06 — 3-Breath Reset", "जब भी तनाव महसूस हो, लगातार 2 से 3 बार यह डबल इनहेल और लंबा एक्सहेल करें—आप तुरंत शांत महसूस करेंगे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल autonomic respiratory science awareness के लिए है और acute medical emergency का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (20, 184, 166)  # Teal for respiratory health / calm breath
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0107 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Physiological Sigh Alveoli Vagus Nerve Reset Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0107_breathwork_physiological_sigh','display_id':'REEL-0107','topic_hi':'Physiological Sigh: 2 गहरी सांसों से तनाव और धड़कन कैसे धीमी होती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
