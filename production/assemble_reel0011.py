...
WORK = ROOT / 'work' / 'reel_0011'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0011_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0011_volunteering_connection_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "कभी-कभी हम अकेलापन महसूस करते हैं, और research describes करती है कि social connection हमारी well-being के लिए बेहद अहम है।"),
    ("Span 02 — Evidence", "Mayo Clinic और Harvard Health की studies के अनुसार, volunteering करना connection बढ़ाने का एक बेहतरीन तरीका हो सकता है।"),
    ("Span 03 — Mechanism", "जब हम community work में अपना time invest करते हैं, तो shared values के साथ नए relationships build होते हैं।"),
    ("Span 04 — Impact", "यह social interaction हमारे stress levels को buffer करने और loneliness को reduce करने में supportive साबित हो सकता है।"),
    ("Span 05 — Meaning", "इसके अलावा, group activities में contribute करने से purpose की sense मिलती है और mental health positive direction पाती है।"),
    ("Span 06 — Individual Variation", "ध्यान रखें कि हर व्यक्ति का experience अलग हो सकता है, और यह routine केवल general lifestyle exploration के लिए है।"),
    ("Span 07 — Safety Boundary", "Disclaimer: यह content केवल educational awareness के लिए है; यह किसी professional medical advice या diagnosis का substitute नहीं है।"),
]

CAPTION_TEXT = [span[1] for span in SPANS]
WEIGHTS = [0.13, 0.15, 0.16, 0.16, 0.15, 0.13, 0.12]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(56, 189, 248))  # Cyan accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(56, 189, 248), font=font_header)
    draw.text((40, 90), f"REEL-0011 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Mayo Clinic & Harvard Health Public Health Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0011_volunteering_and_social_connection',
        'display_id': 'REEL-0011',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0011',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Volunteering और Social Connection: Mental Well-Being के लिए Insights',
        'topic_key': 'volunteering_social_connection',
        'pillar': 'mental_health',
        'evidence_class': 'public_health_research_mayo_clinic_and_harvard_health',
        ...
        'files': ['final.mp4', 'narration.wav', 'captions.srt', 'visual_reference.png', 'metadata.json'],
