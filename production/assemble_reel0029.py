...
WORK = ROOT / 'work' / 'reel_0029'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0029_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0029_prosocial_behavior_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी अनुभव किया है कि किसी दूसरे की मदद करने के बाद मन में एक गहरी खुशी क्यों महसूस होती है?"),
    ("Span 02 — Social Psychology Evidence", "Social psychology research दर्शाती है कि prosocial behavior—जैसे मदद करना या दया दिखाना—well-being को बढ़ावा देता है।"),
    ("Span 03 — Reward Pathways", "Neuroimaging studies दिखाती हैं कि दयालु व्यवहार brain के reward pathways और positive affect को stimulate करता है।"),
    ("Span 04 — Warm Glow Effect", "Psychology में इसे 'warm glow' effect कहते हैं, जो social connection और mutual trust को मजबूत करता है।"),
    ("Span 05 — Small Daily Acts", "रोज़मर्रा की ज़िंदगी में छोटे-छोटे helpful acts करना positive mood और mental wellness को support कर सकता है।"),
    ("Span 06 — Healthy Limits", "ध्यान रखें कि दूसरों की मदद करते समय अपनी personal limits और self-care का ध्यान रखना भी उतना ही ज़रूरी है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल positive psychology education के लिए है और clinical therapy का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(236, 72, 153))  # Pink Prosocial accent bar
    ...
    draw.text((40, 90), f"REEL-0029 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Social Psychology & Well-Being Science Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0029_prosocial_behavior_and_well_being',
        'display_id': 'REEL-0029',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0029',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Prosocial Behavior: दूसरों की मदद करने से Well-Being बढ़ने का विज्ञान',
        'topic_key': 'prosocial_behavior_and_well_being',
        'pillar': 'mental_health',
        'evidence_class': 'social_psychology_and_neurobiology',
