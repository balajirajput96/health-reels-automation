...
WORK = ROOT / 'work' / 'reel_0069'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0069_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0069_psychology_of_belonging_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी महसूस किया है कि जब कोई ग्रुप आपको नज़रअंदाज़ करता है या बाहर निकालता है, तो सीने में असली शारीरिक दर्द क्यों होता है?"),
    ("Span 02 — The Need To Belong", "Psychology में इसे 'Need to Belong' कहते हैं—अपनों के साथ जुड़ाव महसूस करना हमारे लिए भोजन और पानी जितना ही बुनियादी है।"),
    ("Span 03 — Social Pain In fMRI", "fMRI रिसर्च में साबित हुआ कि सामाजिक बहिष्कार दिमाग के उसी हिस्से (dACC) को सक्रिय करता है जो शारीरिक चोट लगने पर दर्द महसूस कराता है।"),
    ("Span 04 — Evolutionary Survival Logic", "लाखों साल पहले कबीले से अलग होने का मतलब निश्चित मौत थी, इसलिए दिमाग ने अकेलेपन को खतरे का अलार्म बना दिया।"),
    ("Span 05 — The Health Cost Of Isolation", "लंबे समय तक अकेलापन और ठुकराया जाना शरीर में सूजन (Inflammation) और तनाव के हॉर्मोन को बढ़ा देता है।"),
    ("Span 06 — Quality Over Quantity", "दिमाग को शांत रखने के लिए सैकड़ों दोस्तों की ज़रूरत नहीं, बस 2 से 3 सच्चे और गहरे रिश्ते ही सुरक्षा का अहसास कराने के लिए काफी हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social psychology awareness के लिए है और clinical depression diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(251, 146, 60))  # Orange-Amber Belonging accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(251, 146, 60), font=font_header)
    draw.text((40, 90), f"REEL-0069 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Social Neuroscience & dACC Social Pain Matrix Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0069_psychology_of_belonging_social_pain',
        'display_id': 'REEL-0069',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0069',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Belonging: किसी समूह से बाहर निकाले जाने पर दिल में असली दर्द क्यों होता है?',
        'topic_key': 'psychology_of_belonging_dacc_social_pain',
        'pillar': 'mental_health',
        'evidence_class': 'social_neuroscience_and_health_psychology',
