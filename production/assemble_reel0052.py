...
WORK = ROOT / 'work' / 'reel_0052'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0052_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0052_mind_wandering_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी देखा है कि किताब पढ़ते-पढ़ते अचानक आपका दिमाग कहीं दूर ख्यालों में भटक जाता है?"),
    ("Span 02 — 47% Of Waking Time", "रिसर्च दर्शाती है कि इंसान अपने जागते हुए समय का लगभग 47% हिस्सा 'Mind Wandering' यानी ख्यालों में बिताता है।"),
    ("Span 03 — The Default Mode Network", "Neuroscience में इसे 'Default Mode Network' या DMN कहते हैं—जब हम कोई बाहरी काम नहीं करते, तो यह नेटवर्क सक्रिय हो जाता है।"),
    ("Span 04 — The Downside", "काम के दौरान ध्यान भटकने से एकाग्रता टूटती है, पढ़ाई की गति धीमी होती है और कई बार चिंता पैदा होती है।"),
    ("Span 05 — The Creative Upside", "लेकिन यही DMN नेटवर्क हमें भविष्य की योजना बनाने, नई रचनात्मक सोच (creativity) और समस्याओं के अनूठे हल खोजने में मदद करता है।"),
    ("Span 06 — Practical Regulation", "जब भी ध्यान भटके, खुद को डांटने के बजाय बस यह नोटिस करें कि मन भटका है और धीरे से वर्तमान काम पर लौट आएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive neuroscience education के लिए है और ADHD या mental health diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(59, 130, 246))  # Blue DMN accent bar
    ...
    draw.text((40, 90), f"REEL-0052 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Neuroscience & Default Mode Network (DMN) Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0052_mind_wandering_and_default_mode_network',
        'display_id': 'REEL-0052',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0052',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Mind Wandering: विचारों के भटकने और दिमाग के Default Network का विज्ञान',
        'topic_key': 'mind_wandering_default_mode_network',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_neuroscience_and_spontaneous_thought',
