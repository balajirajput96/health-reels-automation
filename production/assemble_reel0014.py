...
WORK = ROOT / 'work' / 'reel_0014'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0014_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0014_daylight_circadian_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि दिन के समय बाहर बिताना हमारी आंतरिक घड़ी यानी circadian clock के लिए एक ज़रूरी cue हो सकता है?"),
    ("Span 02 — NIH Findings", "National Institutes of Health और peer-reviewed research के अनुसार, natural daylight हमारी body clock को align करने में मदद करती है।"),
    ("Span 03 — Mechanism", "जब हम दिन में outdoor light लेते हैं, तो यह sleep-wake cycle को बेहतर बनाने और alertness बढ़ाने में सहायक हो सकती है।"),
    ("Span 04 — Sleep Impact", "Studies यह भी दिखाती हैं कि daytime outdoor exposure से mood और sleep quality पर positive असर पड़ सकता है।"),
    ("Span 05 — Daily Routine", "इसका मतलब है कि रोज़मर्रा की routine में थोड़ा समय बाहर बिताना healthy circadian rhythm को सपोर्ट कर सकता है।"),
    ("Span 06 — Educational Context", "यह वीडियो केवल general-education के उद्देश्य से है और यह professional medical advice का विकल्प नहीं है।"),
    ("Span 07 — Safety Boundary", "किसी भी personal health query के लिए हमेशा अपने doctor या qualified healthcare provider से संपर्क करें।"),
]

CAPTION_TEXT = [span[1] for span in SPANS]
WEIGHTS = [0.15, 0.16, 0.16, 0.15, 0.15, 0.12, 0.11]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(234, 179, 8))  # Yellow daylight accent bar
    ...
    draw.text((40, 90), f"REEL-0014 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "NIH / NIGMS & PMC Peer-Reviewed Circadian Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0014_daytime_outdoor_light_and_circadian_health',
        'display_id': 'REEL-0014',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0014',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Daytime Outdoor Light और Circadian Health: Scientific Insights',
        'topic_key': 'daytime_outdoor_light_circadian_health',
        'pillar': 'sleep',
        'evidence_class': 'nih_nigms_and_peer_reviewed_pmc',
