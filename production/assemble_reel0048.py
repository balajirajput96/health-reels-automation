...
WORK = ROOT / 'work' / 'reel_0048'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0048_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0048_episodic_memory_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने सोचा है कि किसी पुरानी यात्रा को याद करते समय दिमाग उस पल में सचमुच वापस पहुँचने जैसा क्यों महसूस करता है?"),
    ("Span 02 — Endel Tulving's Episodic Memory", "Neuroscience में इसे 'Episodic Memory' कहते हैं—यह हमारे व्यक्तिगत जीवन के अनुभवों और घटनाओं की याददाश्त है।"),
    ("Span 03 — Episodic vs Semantic", "तथ्यों को याद रखना (जैसे देश की राजधानी) 'semantic memory' है, जबकि खुद के अनुभव को याद करना 'episodic memory' कहलाता है।"),
    ("Span 04 — Mental Time Travel", "वैज्ञानिक Endel Tulving ने इसे 'mental time travel' कहा है—दिमाग की वह क्षमता जिससे हम भूतकाल और भविष्य दोनों की कल्पना कर सकते हैं।"),
    ("Span 05 — Hippocampal Binding", "Brain का hippocampus उस घटना की आवाज़ों, दृश्यों और भावनाओं को एक साथ जोड़कर पूरी कहानी बनाता है।"),
    ("Span 06 — Reconstructive Nature", "याददाश्त कोई फिक्स वीडियो रिकॉर्डिंग नहीं है, बल्कि हर बार याद करते समय दिमाग उस घटना को दोबारा construct करता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive neuroscience awareness के लिए है और memory clinic diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(168, 85, 247))  # Purple Episodic accent bar
    ...
    draw.text((40, 90), f"REEL-0048 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Neuroscience & Mental Time Travel Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0048_episodic_memory_and_mental_time_travel',
        'display_id': 'REEL-0048',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0048',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Episodic Memory: बीते पलों को दोबारा जीने और याद रखने का Neuroscience',
        'topic_key': 'episodic_memory_mental_time_travel',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_neuroscience_and_autobiographical_memory',
