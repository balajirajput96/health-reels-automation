...
WORK = ROOT / 'work' / 'reel_0030'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0030_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0030_emotion_granularity_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप सिर्फ 'बुरा लग रहा है' कहते हैं, या पहचानते हैं कि वह थकान है या निराशा?"),
    ("Span 02 — Emotion Granularity", "Affective neuroscience में इसे 'emotion granularity' कहते हैं—अपनी भावनाओं को precise नाम देने की क्षमता।"),
    ("Span 03 — Regulatory Mechanism", "जब brain को exact emotion का पता चलता है, तो वह situation से निपटने के लिए specific strategy चुन पाता है।"),
    ("Span 04 — Granularity vs Distress", "रिसर्च बताती है कि high emotional granularity वाले लोग stress और anxiety को ज्यादा effectively regulate करते हैं।"),
    ("Span 05 — Daily Self-Reflection", "सिर्फ 'stressed' कहने के बजाय, introspect करें कि क्या यह overwhelm है, uncertainty है या physical exhaustion।"),
    ("Span 06 — Adaptive Coping", "यह simple practice emotional clarity बढ़ाती है और impulsive reactions को कम करने में मदद कर सकती है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल psychological science awareness के लिए है और clinical mental health treatment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(168, 85, 247))  # Purple Granularity accent bar
    ...
    draw.text((40, 90), f"REEL-0030 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Affective Neuroscience & Emotion Regulation Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0030_emotion_granularity_and_affective_regulation',
        'display_id': 'REEL-0030',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0030',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Emotion Granularity: भावनाओं को सही नाम देने से Stress Regulation का विज्ञान',
        'topic_key': 'emotion_granularity_affective_regulation',
        'pillar': 'mental_health',
        'evidence_class': 'affective_neuroscience_and_cognitive_psychology',
