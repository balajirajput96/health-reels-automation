...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि मुंह से सांस लेने की आदत आपके दिमाग और दिल से लगभग 20% तक शुद्ध ऑक्सीजन छीन लेती है?"),
    ("Span 02 — Nitric Oxide Miracle", "हमारी नाक के साइनस में Nitric Oxide नाम की एक चमत्कारी गैस बनती है, जिसके लिए वैज्ञानिकों को नोबेल पुरस्कार मिला था।"),
    ("Span 03 — Vessel Dilation", "जब हम नाक से सांस लेते हैं, तो यह गैस फेफड़ों में पहुंचकर रक्त वाहिकाओं को तुरंत चौड़ा और लचीला बना देती है।"),
    ("Span 04 — 18% More Oxygen", "नाक से सांस लेने पर हवा धीरे-धीरे फेफड़ों के निचले हिस्से तक जाती है, जिससे शरीर को 18% अधिक ऑक्सीजन प्राप्त होती है।"),
    ("Span 05 — Natural Air Purifier", "नाक के बाल और म्यूकस 98% बैक्टीरिया, वायरस और प्रदूषण को फेफड़ों में जाने से पहले ही रोक देते हैं।"),
    ("Span 06 — Keep Mouth Closed", "दिनभर काम करते समय अपने होंठ बंद रखें और केवल नाक से ही शांत और गहरी सांस लेने की आदत बनाएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल respiratory physiology awareness के लिए है और ENT obstruction disorder का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (6, 182, 212)  # Cyan for respiratory nitric oxide / airflow
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0124 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Nasal Breathing Nitric Oxide 18% Oxygenation Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0124_nasal_breathing_nitric_oxide','display_id':'REEL-0124','topic_hi':'Nasal Breathing & Nitric Oxide: नाक से सांस लेने से 18% ज्यादा ऑक्सीजन कैसे मिलती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
