# Reel 0010 visual QC findings

**Inspected frames:** `qc_frame_02s.jpg` and `qc_frame_37s.jpg`  
...
Technical QC separately confirmed a 720×1280 portrait H.264/AAC render lasting 75.006 seconds, exactly six caption entries, and maximum wrapped caption line length of 30 characters. The closing image is a deterministic reuse of Reel 0010’s approved style reference because the free-plan image-generation quota was exhausted; this recovery is recorded in `work/visual_generation_diagnostic.md`.
