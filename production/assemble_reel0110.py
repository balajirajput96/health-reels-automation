...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि जब आप बेचैन या तनाव में हों, तो कमरे में बैठकर सोचने के बजाय 15 मिनट बाहर टहलना दिमाग को तुरंत कैसे शांत कर देता है?"),
    ("Span 02 — Optic Flow", "जब हम आगे की तरफ चलते हैं, तो आसपास की चीजें हमारी आंखों के रेटिना से पीछे की ओर फिसलती हैं, जिसे Optic Flow कहते हैं।"),
    ("Span 03 — Silencing Amygdala", "Neuroscience रिसर्च में देखा गया कि यह विजुअल मोशन दिमाग के डर वाले हिस्से Amygdala के खतरे के सिग्नल्स को सीधे तौर पर शांत कर देता है।"),
    ("Span 04 — Tunnel vs Panoramic", "तनाव में हमारी आंखें Tunnel Vision में आ जाती हैं, जबकि टहलते समय दृष्टि Panoramic Vision में फैल जाती है, जो नर्वस सिस्टम को रिलैक्स करती है।"),
    ("Span 05 — The EMDR Connection", "इसी विज्ञान का इस्तेमाल थेरेपी में भी आंखों की पुतलियों को दाएं-बाएं घुमाकर गहरे मानसिक आघात को शांत करने के लिए किया जाता है।"),
    ("Span 06 — 15-Minute Protocol", "जब भी दिमाग पर बोझ बढ़े, तो बिना फोन देखे 15 से 20 मिनट के लिए खुली हवा में आगे की तरफ कदम बढ़ाएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल visual neuroscience public awareness के लिए है और clinical psychotherapy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (16, 185, 129)  # Emerald green for outdoor walk / optic flow
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0110 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Visual Optic Flow Amygdala Panoramic Vision Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0110_optic_flow_anxiety_reduction','display_id':'REEL-0110','topic_hi':'Optic Flow & Anxiety: खुली हवा में टहलने से चिंता और डर क्यों शांत होता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
