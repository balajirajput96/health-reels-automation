...
SPANS = [
    ("Span 01 — Hook", "क्या आपके साथ कभी ऐसा हुआ है कि अपनी जिंदगी में सब अच्छा चलने के बावजूद, सोशल मीडिया पर दूसरों की पोस्ट देखकर अचानक हीनभावना महसूस होने लगती है?"),
    ("Span 02 — Festinger Theory", "Social Psychology में Leon Festinger की Social Comparison Theory बताती है कि इंसानी दिमाग अपनी काबिलियत और मूल्य को आंकने के लिए लगातार दूसरों से तुलना करता है।"),
    ("Span 03 — Upward Comparison Pain", "जब हम खुद से ज्यादा सफल या सुंदर लोगों से तुलना करते हैं, तो दिमाग का dACC और Insula एक्टिव होता है—जो शारीरिक दर्द जैसा महसूस कराता है।"),
    ("Span 04 — Downward Comparison", "इसके विपरीत, खुद से कमज़ोर स्थिति वाले लोगों को देखने पर दिमाग का Ventral Striatum डोपामाइन जारी करता है।"),
    ("Span 05 — Highlight Fallacy", "सोशल मीडिया पर लोग केवल अपनी जिंदगी के सबसे बेहतरीन पल दिखाते हैं, और हमारा दिमाग इस नकली तुलना को सच मानकर लगातार तनाव में रहता है।"),
    ("Span 06 — Shift to Self Progress", "समाधान है तुलना का रुख बदलना—दूसरों की हाइलाइट्स से नहीं, बल्कि अपनी पिछली स्थिति से अपनी आज की तरक्की की तुलना करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social psychology public awareness के लिए है और clinical depression या anxiety diagnosis का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (239, 68, 68)  # Red for social pain/comparison
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0093 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Social Comparison Theory Neural Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0093_social_comparison_upward_envy','display_id':'REEL-0093','topic_hi':'Social Comparison: सोशल मीडिया पर दूसरों को देखकर हम खुद को कमतर क्यों महसूस करते हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
