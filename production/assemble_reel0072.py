...
WORK = ROOT / 'work' / 'reel_0072'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0072_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0072_dehumanization_psychology_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि हम अपनों के लिए तो गहरा दर्द महसूस करते हैं, लेकिन अनजान लोगों की पीड़ा पर हमारा दिमाग सुन्न क्यों हो जाता है?"),
    ("Span 02 — The Stereotype Content Model", "Social Psychology में इसे 'Stereotype Content Model' कहते हैं—हमारा दिमाग हर व्यक्ति को दो पैमानों पर आंकता है: 'सहानुभूति' (Warmth) और 'क्षमता' (Competence)।"),
    ("Span 03 — Medial Prefrontal Cortex Shutdown", "fMRI अध्ययनों से पता चलता है कि जब हम किसी को अपने समूह से बाहर (Outgroup) मानते हैं, तो दिमाग का सामाजिक समझ वाला हिस्सा (mPFC) सक्रिय नहीं होता।"),
    ("Span 04 — Dehumanization Mechanism", "इसे 'Dehumanization' कहते हैं—जब दिमाग दूसरे इंसान को एक जीवित व्यक्ति के बजाय सिर्फ एक संख्या या वस्तु की तरह देखने लगता है।"),
    ("Span 05 — The Tribal Danger", "यह 'हम बनाम वे' (Us vs Them) वाली सोच समाज में नफरत, भेदभाव और असंवेदनशीलता को बढ़ावा देती है।"),
    ("Span 06 — The Humanizing Solution", "समाधान यह है कि हर व्यक्ति के व्यक्तिगत जीवन, संघर्ष और भावनाओं को समझने की कोशिश करें—इससे दिमाग तुरंत मानवीय जुड़ाव महसूस करता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social psychology awareness के लिए है और sociopolitical commentary का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(239, 68, 68))  # Red Dehumanization accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(239, 68, 68), font=font_header)
    draw.text((40, 90), f"REEL-0072 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Social Neuroscience & Stereotype Content Dehumanization Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0072_dehumanization_psychology_mpfc',
        'display_id': 'REEL-0072',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0072',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Dehumanization: हम दूसरों को इंसान समझना कब बंद कर देते हैं?',
        'topic_key': 'dehumanization_stereotype_content_mpfc',
        'pillar': 'mental_health',
        'evidence_class': 'social_psychology_and_cognitive_neuroscience',
