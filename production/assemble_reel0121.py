...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि रात को अच्छी नींद आने का सबसे बड़ा राज रात में नहीं, बल्कि सुबह उठते ही सूरज देखने में छुपा है?"),
    ("Span 02 — Retinal Sensors", "हमारी आंखों में खास न्यूरॉन्स होते हैं, जो सुबह की धूप में मौजूद खास स्पेक्ट्रम को पहचानते हैं।"),
    ("Span 03 — SCN Master Clock", "ये कोशिकाएं दिमाग की मुख्य घड़ी Suprachiasmatic Nucleus को संकेत भेजती हैं कि नया दिन शुरू हो चुका है।"),
    ("Span 04 — Cortisol Awakening", "धूप लगते ही दिमाग एक स्वस्थ Cortisol का झटका देता है, जिससे सुस्ती गायब होती है और मूड अच्छा हो जाता है।"),
    ("Span 05 — 14-Hour Melatonin Timer", "यही सुबह की धूप दिमाग में ठीक 14 घंटे बाद नींद का हार्मोन Melatonin रिलीज करने का बायोकेमिकल टाइमर चालू कर देती है।"),
    ("Span 06 — Outdoor Exposure Rule", "खिड़की के कांच के पीछे नहीं, बल्कि उठने के 1 घंटे के अंदर बाहर निकलकर 10 से 15 मिनट खुली धूप में खड़े हों।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल circadian chronobiology awareness के लिए है और clinical sleep disorder treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (245, 158, 11)  # Golden amber for morning sunlight / circadian anchoring
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0121 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Morning Sunlight SCN Clock Cortisol Melatonin Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0121_morning_sunlight_circadian','display_id':'REEL-0121','topic_hi':'Morning Sunlight: सुबह 10 मिनट धूप देखने से नींद और ऊर्जा कैसे तय होती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
