...
WORK = ROOT / 'work' / 'reel_0063'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0063_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0063_expectancy_value_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि कोई काम बहुत ज़रूरी होने के बावजूद हम उसे शुरू करने की हिम्मत क्यों नहीं जुटा पाते?"),
    ("Span 02 — The Mathematical Formula", "Educational Psychology में इसे 'Expectancy-Value Theory' कहते हैं—हमारी प्रेरणा दो चीज़ों का गुणनफल है: सफलता की उम्मीद और काम का महत्व।"),
    ("Span 03 — Expectancy Of Success", "पहला हिस्सा है 'Expectancy'—क्या मेरा दिमाग सच में यह मानता है कि मैं इस काम को सफलतापूर्वक पूरा कर सकता हूँ?"),
    ("Span 04 — Subjective Task Value", "दूसरा हिस्सा है 'Task Value'—यह काम मेरे भविष्य, मेरी पहचान और मेरे लक्ष्यों के लिए कितना कीमती और उपयोगी है?"),
    ("Span 05 — The Multiplication Trap", "यदि इनमें से एक भी शून्य हो गया तो कुल प्रेरणा शून्य हो जाती है—बिना आत्मविश्वास के महत्व सिर्फ तनाव पैदा करता है।"),
    ("Span 06 — Unlocking Full Motivation", "प्रेरणा जगाने के लिए काम को छोटे हिस्सों में बांटकर भरोसा बढ़ाएं और यह स्पष्ट करें कि यह काम आपकी ज़िंदगी के लिए क्यों मायने रखता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल educational motivation science awareness के लिए है और clinical psychological diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(59, 130, 246))  # Blue Expectancy-Value accent bar
    ...
    draw.text((40, 90), f"REEL-0063 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Educational Psychology & Expectancy-Value Theory Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0063_expectancy_value_theory_of_motivation',
        'display_id': 'REEL-0063',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0063',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Expectancy-Value Theory: प्रेरणा (Motivation) के गणित का असली विज्ञान',
        'topic_key': 'expectancy_value_theory_motivation',
        'pillar': 'mental_health',
        'evidence_class': 'educational_psychology_and_motivation_theory',
