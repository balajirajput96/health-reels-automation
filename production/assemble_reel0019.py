...
WORK = ROOT / 'work' / 'reel_0019'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0019_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0019_social_jetlag_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने गौर किया है कि weekend पर देर तक सोने से Monday सुबह उठना मुश्किल क्यों हो जाता है?"),
    ("Span 02 — AASM Findings", "Research बताती है कि weekday और weekend के sleep schedule में बड़ा अंतर होने को social jet-lag कहते हैं।"),
    ("Span 03 — Circadian Mismatch", "जब हमारी biological clock और social routine में अंतर आता है, तो circadian rhythm प्रभावित हो सकती है।"),
    ("Span 04 — Fatigue & Alertness", "इस routine shift के कारण daytime fatigue, mood changes और low alertness महसूस हो सकती है।"),
    ("Span 05 — Sleep Consistency", "Studies के अनुसार, sleep schedule में consistency बनाए रखने से body को natural rest cycle maintain करने में मदद मिलती है।"),
    ("Span 06 — Practical Steps", "Weekend पर अपने sleep patterns में छोटे और gradual बदलाव करके इस अंतर को कम किया जा सकता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल general education के लिए है और किसी medical sleep disorder का इलाज नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(99, 102, 241))  # Indigo Sleep accent bar
    ...
    draw.text((40, 90), f"REEL-0019 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "PMC & AASM Peer-Reviewed Sleep Medicine", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0019_social_jetlag_and_weekend_routine_shifts',
        'display_id': 'REEL-0019',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0019',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Social Jet-Lag: Weekend Sleep Shifts और Circadian Rhythm के Scientific Facts',
        'topic_key': 'social_jetlag_weekend_routine_shifts',
        'pillar': 'sleep',
        'evidence_class': 'pmc_and_aasm_peer_reviewed_sleep_medicine',
