...
SPANS = [
    ("Span 01 — Hook", "क्या आप भी सुबह उठने के बाद घंटों तक सुस्ती महसूस करते हैं? इसकी वजह अक्सर नींद की कमी नहीं, बल्कि आपकी बिगड़ी हुई Biological Clock होती है।"),
    ("Span 02 — Master Clock SCN", "दिमाग के Hypothalamus में स्थित Suprachiasmatic Nucleus शरीर की मास्टर क्लॉक है, जो तापमान, हार्मोन और ऊर्जा को नियंत्रित करती है।"),
    ("Span 03 — Morning Sensing", "हमारी आंखों की खास Melanopsin कोशिकाएं सुबह की सूरज की रोशनी को भांपकर SCN को संकेत भेजती हैं।"),
    ("Span 04 — Cortisol Pulse", "यह संकेत तुरंत Cortisol Pulse जारी करता है, जो हमें सतर्क बनाता है और हमारे इम्यून सिस्टम व मेटाबॉलिज्म को एक्टिव करता है।"),
    ("Span 05 — Melatonin Timer", "सुबह धूप लेने से ठीक 14 घंटे बाद रात में Melatonin हार्मोन का सही समय पर रिसाव तय होता है, जिससे गहरी नींद आती है।"),
    ("Span 06 — Blue Light Warning", "रात में मोबाइल और चमकदार रोशनी इस चक्र को बिगाड़ देती है, जिससे Melatonin का बनना रुक जाता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल circadian rhythm biology awareness के लिए है और clinical sleep disorder treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (234, 179, 8)  # Yellow for sunlight/circadian
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0087 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Circadian Rhythm SCN Sunlight Biology Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0087_circadian_rhythm_scn_sunlight','display_id':'REEL-0087','topic_hi':'Circadian Rhythm: सुबह की धूप दिमाग की जैविक घड़ी को कैसे रिसेट करती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
