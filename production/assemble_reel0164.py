...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि मुंह से सांस लेने पर आपके फेफड़ों को वह चमत्कारी गैस नहीं मिलती जो खून में ऑक्सीजन को 15% तक बढ़ा देती है?"),
    ("Span 02 — The Sinus Factory", "नोबेल पुरस्कार विजेता रिसर्च के अनुसार, हमारी नाक और साइनस की गुहाओं में लगातार Nitric Oxide नाम की एक खास गैस बनती है।"),
    ("Span 03 — Vasodilation Power", "जब आप नाक से सांस लेते हैं, तो यह गैस फेफड़ों में पहुंचकर रक्त नलिकाओं को खोल देती है।"),
    ("Span 04 — 15% Oxygen Surge", "इससे फेफड़ों के हर हिस्से में खून का बहाव बढ़ जाता है और शरीर 10 से 15% ज्यादा ऑक्सीजन सोख पाता है।"),
    ("Span 05 — The Humming Surge", "स्वीडन की रिसर्च में पाया गया कि हम्म की आवाज करने से नाक में नाइट्रिक ऑक्साइड का उत्पादन 15 गुना बढ़ जाता है!"),
    ("Span 06 — Nose Breathing Rule", "दिन भर मुंह बंद रखकर सिर्फ नाक से सांस लें और रोजाना 2 मिनट धीमी गुंजन करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल respiratory pulmonary physiology awareness के लिए है और chronic asthma, COPD or sleep apnea clinical therapy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (6, 182, 212)  # Bright oxygen cyan for nasal nitric oxide & lung oxygenation
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0164 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Nasal Nitric Oxide Oxygenation Louis Ignarro",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0164_nasal_nitric_oxide','display_id':'REEL-0164','topic_hi':'Nasal Nitric Oxide: नाक से सांस लेने पर 15% ज्यादा ऑक्सीजन क्यों मिलती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
