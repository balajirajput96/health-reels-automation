...
WORK = ROOT / 'work' / 'reel_0027'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0027_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0027_social_norms_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि दूसरों का व्यवहार हमारे daily decisions को अनजाने में कैसे shape करता है?"),
    ("Span 02 — Descriptive vs Injunctive", "Social psychology में दो तरह के norms होते हैं: descriptive (लोग क्या कर रहे हैं) और injunctive (लोगों को क्या करना चाहिए)।"),
    ("Span 03 — Cognitive Heuristic", "जब स्थिति नई या अनिश्चित होती है, तो 'दूसरे क्या कर रहे हैं' यह देखना brain के लिए एक quick heuristic बन जाता है।"),
    ("Span 04 — Research Evidence", "Studies दिखाती हैं कि जब लोगों को बताया जाता है कि 'अधिकांश लोग ऐसा करते हैं', तो prosocial behavior बढ़ जाता है।"),
    ("Span 05 — Environmental Cues", "Public spaces में सही descriptive cues स्थापित करने से positive habits को naturally nudge किया जा सकता है।"),
    ("Span 06 — Cultural Context", "याद रखें कि social norms का प्रभाव cultural background और individual values पर भी depend करता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral science awareness के लिए है और psychological advice का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(132, 204, 22))  # Lime Social accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(132, 204, 22), font=font_header)
    draw.text((40, 90), f"REEL-0027 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Social Psychology & Normative Influence Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0027_social_norms_and_descriptive_cues',
        'display_id': 'REEL-0027',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0027',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Social Norms: Descriptive Cues और Behavioral Science का प्रभाव',
        'topic_key': 'social_norms_descriptive_cues',
        'pillar': 'mental_health',
        'evidence_class': 'social_psychology_and_behavioral_science',
