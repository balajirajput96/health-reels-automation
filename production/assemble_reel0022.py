...
WORK = ROOT / 'work' / 'reel_0022'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0022_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0022_mindfulness_attention_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "जब कोई कहे कि meditation से attention बढ़ गई, तो पूछिए—किस measure में?"),
    ("Span 02 — Questionnaires", "Research में पहली layer questionnaires हैं, जो self-reported awareness और subjective rating मापते हैं।"),
    ("Span 03 — Behavioral Tasks", "दूसरी layer behavioral tasks हैं, जैसे Stroop task, जिसमें response time और accuracy देखी जाती है।"),
    ("Span 04 — EEG & ERP Signals", "तीसरी layer EEG और ERP signals हैं, जो task के दौरान electrical activity के correlates record करते हैं।"),
    ("Span 05 — Task Specificity", "Longitudinal studies में training के साथ task-specific electrophysiological differences देखे गए हैं।"),
    ("Span 06 — Scientific Nuance", "एक specific measure में बदलाव पूरी ज़िंदगी की attention बदलने का absolute proof नहीं होता।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल scientific education के लिए है और clinical psychological diagnosis नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(139, 92, 246))  # Violet Neuroscience accent bar
    ...
    draw.text((40, 90), f"REEL-0022 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Psychology & EEG Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0022_mindfulness_and_attention_what_studies_measure',
        'display_id': 'REEL-0022',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0022',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Mindfulness और Attention: Studies वास्तव में क्या Measure करती हैं?',
        'topic_key': 'mindfulness_attention_what_studies_measure',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_psychology_and_eeg_research',
