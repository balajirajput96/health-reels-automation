...
WORK = ROOT / 'work' / 'reel_0079'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0079_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0079_interoception_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि किसी खतरे या महत्वपूर्ण फैसले से पहले हमारे पेट और दिल में अजीब सी हलचल (Gut Feeling) क्यों होने लगती है?"),
    ("Span 02 — What Is Interoception", "Neuroscience में इसे 'Interoception' कहते हैं—यह हमारे शरीर का वह छठा सेंस है जो अंदरूनी अंगों के संकेतों को दिमाग तक पहुंचाता है।"),
    ("Span 03 — The Insular Cortex Hub", "दिमाग का 'Insular Cortex' हिस्सा हमारी धड़कन, सांस और पेट की हलचल को पढ़कर भावनाओं का रूप देता है।"),
    ("Span 04 — Somatic Marker Hypothesis", "वैज्ञानिक एंटोनियो दमासियो के अनुसार, यह 'गट फीलिंग' कोई अंधविश्वास नहीं, बल्कि शरीर द्वारा ली गई बहुत तेज और सटीक चेतावनी है।"),
    ("Span 05 — Heartbeat Detection And Emotion", "जिन लोगों की अपने दिल की धड़कन और सांस को महसूस करने की क्षमता बेहतर होती है, वे अपने तनाव को भी आसानी से नियंत्रित कर पाते हैं।"),
    ("Span 06 — Somatic Awareness Practice", "अपने शरीर के अंदरूनी संकेतों को नज़रअंदाज़ करने के बजाय गहरी सांस लें और महसूस करें कि आपका शरीर इस समय क्या कह रहा है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल interoceptive neuroscience awareness के लिए है और clinical somatic symptom diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(59, 130, 246))  # Blue Interoception accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(59, 130, 246), font=font_header)
    draw.text((40, 90), f"REEL-0079 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Somatic Neuroscience & Insular Cortex Interoception Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0079_interoception_insular_cortex',
        'display_id': 'REEL-0079',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0079',
        'status': 'rendered_local_complete_verified',
        'topic_hi': "Interoception: शरीर का 'छठा सेंस' जो हमारी भावनाओं और फैसलों को चलाता है",
        'topic_key': 'interoception_insular_cortex_somatic_markers',
        'pillar': 'mental_health',
        'evidence_class': 'somatic_neuroscience_and_emotional_processing',
