...
WORK = ROOT / 'work' / 'reel_0059'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0059_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0059_acute_stress_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने महसूस किया है कि अचानक किसी खतरे को देखते ही एक सेकंड के अंदर आँखें चौड़ी और सांसें तेज़ कैसे हो जाती हैं?"),
    ("Span 02 — Two-Stage Biological System", "Human biology में इसे 'Acute Stress Response' कहते हैं—यह हमारे अस्तित्व की रक्षा के लिए बना दो-चरणों का तंत्र है।"),
    ("Span 03 — Stage 1: Fast Adrenaline Rush", "पहला चरण है 'SAM Axis'—कुछ ही मिलीसेकंड में एड्रेनालाईन (Adrenaline) रिलीज होकर दिल की धड़कन और मांसपेशियों में खून का बहाव बढ़ा देता है।"),
    ("Span 04 — Stage 2: The HPA Axis", "दूसरा चरण है 'HPA Axis'—हाइपोथैलेमस से संदेश जाकर कॉर्टिसोल (Cortisol) रिलीज करवाता है, जो शरीर में ग्लूकोज और ऊर्जा की आपूर्ति करता है।"),
    ("Span 05 — Energy Prioritization", "इस दौरान पाचन और गैर-ज़रूरी क्रियाएं रुक जाती हैं और पूरी शारीरिक शक्ति उस पल की समस्या से निपटने में लग जाती है।"),
    ("Span 06 — Natural Recovery", "जैसे ही खतरा टलता है, पैरासिम्पेथेटिक सिस्टम (Vagus Nerve) सक्रिय होकर दिल और सांसों को वापस सामान्य स्थिति में ले आता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल human physiology awareness के लिए है और clinical endocrine diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(220, 38, 38))  # Red Acute Stress accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(220, 38, 38), font=font_header)
    draw.text((40, 90), f"REEL-0059 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Human Physiology & HPA Axis Acute Stress Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0059_acute_stress_response_and_hpa_axis',
        'display_id': 'REEL-0059',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0059',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Acute Stress: अचानक खतरे के समय शरीर के 2-चरणों वाले सुपरचार्ज का विज्ञान',
        'topic_key': 'acute_stress_response_hpa_axis',
        'pillar': 'mental_health',
        'evidence_class': 'human_physiology_and_neuroendocrinology',
