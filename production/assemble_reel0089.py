...
SPANS = [
    ("Span 01 — Hook", "क्या आपके साथ कभी ऐसा हुआ है कि एक साथ कई काम करने पर या शोर में पढ़ने पर दिमाग अचानक काम करना बंद कर देता है?"),
    ("Span 02 — Memory Limit", "Cognitive Psychology के अनुसार, हमारी Working Memory एक समय में केवल 3 से 5 टुकड़ों की जानकारी ही संभाल सकती है।"),
    ("Span 03 — Sweller Theory", "John Sweller की Cognitive Load Theory बताती है कि दिमाग में तीन प्रकार का बोझ होता है: Intrinsic, Extraneous, और Germane Load।"),
    ("Span 04 — Extraneous Trap", "मोबाइल के नोटिफिकेशन्स और Multitasking Extraneous Load बढ़ाते हैं, जिससे सोचने की क्षमता बिना किसी नतीजे के ख़त्म हो जाती है।"),
    ("Span 05 — Overload Symptoms", "जब दिमाग की सीमा पार होती है, तो निर्णय लेने में विफलता, मानसिक थकान, और तुरंत भूलने की समस्या होने लगती है।"),
    ("Span 06 — Offloading Strategy", "समाधान है Cognitive Offloading—ज़रूरी चीज़ों को कागज़ पर लिखें, एक समय में एक काम करें, और जानकारी को छोटे हिस्सों में बांटें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive load psychology awareness के लिए है और clinical learning disability assessment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (168, 85, 247)  # Purple for cognitive load
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0089 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Cognitive Load Theory Working Memory Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0089_cognitive_load_working_memory','display_id':'REEL-0089','topic_hi':'Cognitive Load Theory: बहुत सारी जानकारी एक साथ मिलने पर दिमाग जाम क्यों हो जाता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
