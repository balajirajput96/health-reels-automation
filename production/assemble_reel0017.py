...
WORK = ROOT / 'work' / 'reel_0017'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0017_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0017_kitchen_environment_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि आपका kitchen environment आपकी food choices को कैसे affect करता है?"),
    ("Span 02 — Cornell Findings", "Research describe करती है कि kitchen के visual cues और clutter snack intake को nudge कर सकते हैं।"),
    ("Span 03 — Clutter & Snacking", "जब kitchen में snacks सामने रखे होते हैं, तो mindless consumption बढ़ सकती है।"),
    ("Span 04 — Positive Environment", "इसके विपरीत, organized kitchen में fruits visible होने पर healthier choices आसान हो सकती हैं।"),
    ("Span 05 — Environmental Impact", "Environment का यह influence daily habits और mindful eating को support कर सकता है।"),
    ("Span 06 — Individual Variation", "याद रखिए, यह general behavioral insights हैं; हर व्यक्ति का response अलग हो सकता है।"),
    ("Span 07 — Safety Boundary", "यह content सिर्फ general education के लिए है, कोई medical advice या diagnosis नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(168, 85, 247))  # Purple Behavioral accent bar
    ...
    draw.text((40, 90), f"REEL-0017 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cornell University & Harvard HSPH Behavioral Science", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0017_kitchen_environment_cues_and_food_choices',
        'display_id': 'REEL-0017',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0017',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Kitchen Environment Cues और Daily Food Choices: Behavioral Insights',
        'topic_key': 'kitchen_environment_cues_food_choices',
        'pillar': 'nutrition',
        'evidence_class': 'cornell_and_harvard_hsph_behavioral_science',
