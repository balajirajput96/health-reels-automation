...
SPANS = [
    ("Span 01 — Hook", "क्या आपने ध्यान दिया है कि गाड़ी चलाना सीखते समय कितना ध्यान लगाना पड़ता था, लेकिन आज आप बिना सोचे आराम से गाड़ी चला लेते हैं?"),
    ("Span 02 — Brain Shift", "शुरुआत में कोई भी काम Prefrontal Cortex के ज़रिए बहुत ऊर्जा लेता है, लेकिन बार-बार करने पर दिमाग इसे Basal Ganglia में ट्रांसफर कर देता है।"),
    ("Span 03 — Action Chunking", "Neuroscientist Ann Graybiel के अनुसार, Basal Ganglia जटिल कामों को एक सिंगल कोड यानी Action Chunk में बदल देता है।"),
    ("Span 04 — Habit Loop", "हर आदत एक चक्र पर चलती है: Cue यानी ट्रिगर, Routine यानी व्यवहार, और Reward यानी दिमाग को मिलने वाली संतुष्टि।"),
    ("Span 05 — Cue Anchoring", "नई आदत बनाने का सबसे अच्छा तरीका है उसे पुरानी आदत से जोड़ना—जैसे ब्रश करने के तुरंत बाद मैं 2 मिनट ध्यान लगाऊंगा।"),
    ("Span 06 — Friction Control", "अच्छी आदतों के रास्ते से रुकावट कम करें और बुरी आदतों के रास्ते में रुकावट बढ़ाएं, जिससे दिमाग खुद-ब-खुद सही चुनाव करे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल habit formation neuroscience awareness के लिए है और clinical addiction या OCD treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (59, 130, 246)  # Blue for habits
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0086 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Habit Formation Basal Ganglia Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0086_habit_formation_basal_ganglia','display_id':'REEL-0086','topic_hi':'Habit Formation: आदतें कैसे बनती हैं और दिमाग उन्हें अपने आप कैसे चलाता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
