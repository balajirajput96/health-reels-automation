...
WORK = ROOT / 'work' / 'reel_0035'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0035_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0035_emotional_contagion_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने महसूस किया है कि किसी तनावपूर्ण कमरे में कदम रखते ही आपका अपना शरीर भी tense हो जाता है?"),
    ("Span 02 — Emotional Contagion", "Social neuroscience में इसे 'emotional contagion' कहते हैं—दूसरों की भावनाओं का आपस में प्राकृतिक रूप से फैलना।"),
    ("Span 03 — Motor Mimicry", "Brain अनजाने में दूसरों के facial expressions, posture और vocal tone की सूक्ष्म नकल (micro-mimicry) करता है।"),
    ("Span 04 — Neural Feedback Loop", "यह physical imitation हमारे अपने brain को feedback भेजती है, जिससे हम भी वैसा ही महसूस करने लगते हैं।"),
    ("Span 05 — Collective Mood", "यही कारण है कि सकारात्मक या नकारात्मक ऊर्जा पूरे परिवार, workplace या team में तेज़ी से resonate करती है।"),
    ("Span 06 — Mindful Boundaries", "इस प्रक्रिया को समझकर आप दूसरों की भावनाओं को बिना खुद overwhelm हुए conscious boundaries रख सकते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social psychology awareness के लिए है और clinical consultation का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(236, 72, 153))  # Pink Social Contagion accent bar
    ...
    draw.text((40, 90), f"REEL-0035 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Social Neuroscience & Emotional Contagion Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0035_emotional_contagion_and_social_resonance',
        'display_id': 'REEL-0035',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0035',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Emotional Contagion: दूसरों के Mood का हम पर असर पड़ने का Neuroscience',
        'topic_key': 'emotional_contagion_social_resonance',
        'pillar': 'mental_health',
        'evidence_class': 'social_neuroscience_and_mimicry_research',
