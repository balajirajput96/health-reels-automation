...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि सिर्फ 2 मिनट ठंडे पानी से नहाने पर दिमाग 4 घंटे तक सुपर-अलर्ट और खुश क्यों रहता है?"),
    ("Span 02 — 250% Dopamine Elevation", "वैज्ञानिक रिसर्च में पाया गया कि ठंडे पानी के संपर्क में आते ही दिमाग का डोपामाइन लेवल 250% और नोराड्रेनालाईन 530% तक बढ़ जाता है।"),
    ("Span 03 — No-Crash Energy", "कॉफी या मीठे से डोपामाइन अचानक बढ़कर तुरंत क्रैश हो जाता है, लेकिन ठंडे पानी से मिला डोपामाइन 4 घंटे तक स्थिर रहता है।"),
    ("Span 04 — Brown Fat Activation", "ठंड शरीर के Brown Adipose Tissue यानी अच्छे फैट को एक्टिव करती है, जो कैलोरी बर्न करके शरीर को अंदर से गर्म रखता है।"),
    ("Span 05 — The Søberg Rule", "डॉ. सुसाना सोबर्ग के अनुसार, पूरे हफ्ते में सिर्फ 11 मिनट का ठंडा एक्सपोजर भी मेटाबॉलिज्म और मूड बदलने के लिए काफी है।"),
    ("Span 06 — Daily Cold Shower", "रोज सुबह नहाने के आखिरी 60 से 90 सेकंड पानी को बिल्कुल ठंडा करके अपनी गर्दन और पीठ पर डालें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल thermal neurobiology awareness के लिए है और heart condition वाले व्यक्ति डॉक्टर से परामर्श लें।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (14, 165, 233)  # Sky blue for cold water immersion & dopamine
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0136 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Cold Immersion 250% Dopamine Søberg 11-Min Rule",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0136_cold_immersion_dopamine','display_id':'REEL-0136','topic_hi':'Cold Immersion: 2 मिनट ठंडे पानी से डोपामाइन 250% कैसे बढ़ता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
