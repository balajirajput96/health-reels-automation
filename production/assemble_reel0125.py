...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि न्यूरोसाइंस के केवल 5 सरल नियमों को अपने दिन में शामिल करके आप अपनी ऊर्जा और फोकस को दोगुना कर सकते हैं?"),
    ("Span 02 — Rule 1: Morning Light", "सुबह उठने के 1 घंटे के अंदर 10 मिनट सूरज की धूप लें, जिससे दिमाग का सर्केडियन क्लॉक और डोपामाइन तुरंत रीसेट हो जाए।"),
    ("Span 03 — Rule 2: Zone 2 Cardio", "दिनभर में 30 मिनट केवल नाक से सांस लेते हुए हल्की एक्सरसाइज करें, ताकि कोशिकाओं में नए माइटोकॉन्ड्रिया बन सकें।"),
    ("Span 04 — Rule 3: 90-Min Flow", "बिना फोन और नोटिफिकेशन के 90 मिनट का एक सिंगल-टास्क ब्लॉक बनाएं, जहाँ दिमाग फ्लो स्टेट में काम करे।"),
    ("Span 05 — Rule 4: Afternoon NSDR", "दोपहर में 20 मिनट का Non-Sleep Deep Rest करें, जो दिमाग के डोपामाइन को 65% तक तुरंत रीचार्ज कर देगा।"),
    ("Span 06 — Rule 5: Glymphatic Sleep", "रात को 7 से 8 घंटे की गहरी नींद लें, ताकि ग्लाइम्फैटिक सिस्टम दिमाग के सारे जहरीले टॉक्सिन्स धोकर बाहर कर दे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल integrative neuroscience public awareness के लिए है और medical prescription का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (147, 51, 234)  # Deep royal purple/gold for 200-Reel Milestone Masterclass
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,50),"200TH MILESTONE MASTERCLASS",fill=ACCENT,font=fh)
    draw.text((40,90),f"REEL-0125 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Bio-Neuroscience Daily OS 5 Pillars Master Blueprint",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0125_neuroscience_master_os','display_id':'REEL-0125','topic_hi':'Neuroscience Master Protocol: दिनभर ऊर्जा और फोकस के लिए 5 नियम','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
