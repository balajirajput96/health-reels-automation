...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब आप सिर्फ दीवार के कैलेंडर पर अपनी आदत पूरी होने पर लाल निशान लगाते हैं, तो अगले दिन वह काम करने की संभावना 2 गुना कैसे बढ़ जाती है?"),
    ("Span 02 — Hawthorne Discovery", "बिहेवियरल साइकोलॉजी में इसे The Hawthorne Effect कहते हैं।"),
    ("Span 03 — Observer Experiment", "वैज्ञानिक Elton Mayo ने पाया कि जब लोगों को लगता है कि उन पर नजर रखी जा रही है, तो उनका प्रदर्शन अपने आप 60% बेहतर हो जाता है।"),
    ("Span 04 — Self-Monitoring Power", "जब आप खुद अपनी आदतों—जैसे पढ़ाई, रनिंग या खर्च को ट्रैक करते हैं, तो दिमाग का प्रीफ्रॉन्टल कॉर्टेक्स खुद को जवाबदेह मानने लगता है।"),
    ("Span 05 — The Reality Check", "ट्रैकिंग करने से आलस और भ्रम खत्म हो जाता है और दिमाग को सच्चाई दिखती है।"),
    ("Span 06 — Red Cross Habit", "अपनी दीवार पर एक कैलेंडर लगाएं और जिस दिन भी आप 20 मिनट पढ़ाई या कसरत करें, उस तारीख पर बड़ा लाल निशान बनाएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल habit psychology awareness के लिए है और clinical behavioral coaching का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (220, 38, 38)  # Red for the Hawthorne red X calendar marker
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0143 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"The Hawthorne Effect Habit Tracking Accountability",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0143_hawthorne_effect_tracking','display_id':'REEL-0143','topic_hi':'The Hawthorne Effect: आदतें कैलेंडर पर टिक लगाने से 2 गुना मजबूत क्यों होती हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
