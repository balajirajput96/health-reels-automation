...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि 20 मिनट तक गर्म तापमान में पसीना बहाने से आपकी कोशिकाओं में ऐसे प्रोटीन्स एक्टिव होते हैं जो उम्र को धीमा कर देते हैं?"),
    ("Span 02 — Finnish Study", "Finland में 2,300 लोगों पर हुई 20 साल की रिसर्च में देखा गया कि नियमित सौना लेने वालों में हार्ट अटैक का खतरा 50% तक कम था।"),
    ("Span 03 — Heat Shock Proteins", "वैज्ञानिकों के अनुसार, शरीर गर्म होते ही Heat Shock Proteins नाम के विशेष सुरक्षा गार्ड एक्टिव हो जाते हैं।"),
    ("Span 04 — Protein Repair", "ये प्रोटीन्स कोशिकाओं में बिगड़े हुए प्रोटीन्स की मरम्मत करते हैं और अल्जाइमर जैसे रोगों का कारण बनने वाले कचरे को साफ करते हैं।"),
    ("Span 05 — Heart & Vascular Workout", "गर्मी से दिल की धड़कन 120 तक पहुंचती है और नसें चौड़ी हो जाती हैं—यह दिल के लिए हल्की दौड़ लगाने जितना फायदेमंद होता है।"),
    ("Span 06 — 2-3 Times Weekly", "हफ्ते में 2 से 3 बार 15 से 20 मिनट का गर्म स्टीम या सौना लें और खूब पानी और इलेक्ट्रोलाइट्स पिएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल thermal physiology awareness के लिए है और heart condition वाले डॉक्टर की सलाह के बाद ही करें।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (249, 115, 22)  # Bright orange/amber for heat shock
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0117 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Heat Shock Proteins Sauna Longevity FOXO3 Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0117_heat_shock_proteins_sauna','display_id':'REEL-0117','topic_hi':'Heat Shock Proteins: गर्म तापमान से सेल्स खुद की मरम्मत कैसे करते हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
