...
WORK = ROOT / 'work' / 'reel_0039'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0039_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0039_compassion_practice_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या दूसरों के लिए दिल से भलाई चाहना हमारे अपने शरीर और दिमाग को शांत कर सकता है?"),
    ("Span 02 — Contemplative Neuroscience", "Contemplative neuroscience research दर्शाती है कि compassion practice केवल भावना नहीं, बल्कि एक trainable mental skill है।"),
    ("Span 03 — Caregiving Circuits", "Brain scans दिखाते हैं कि करुणा का अभ्यास brain के caregiving circuits और insula को सक्रिय करता है।"),
    ("Span 04 — Autonomic Regulation", "यह अभ्यास parasympathetic nervous system को engage करता है और heart rate variability को बेहतर बनाता है।"),
    ("Span 05 — Simple Daily Practice", "दिन में कुछ मिनट खुद के लिए और दूसरों के लिए निस्वार्थ शांति व स्वास्थ्य की सदिच्छा करना एक सरल शुरुआत है।"),
    ("Span 06 — Trainable Skill", "जैसे मांसपेशियां कसरत से मजबूत होती हैं, वैसे ही सहानुभूति और भावनात्मक संतुलन नियमित अभ्यास से विकसित होते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल contemplative science awareness के लिए है और medical या clinical therapy का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(244, 63, 94))  # Rose Compassion accent bar
    ...
    draw.text((40, 90), f"REEL-0039 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Contemplative Neuroscience & Autonomic Physiology Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0039_compassion_practice_and_neural_caregiving',
        'display_id': 'REEL-0039',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0039',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Compassion Practice: दया और सदिच्छा के अभ्यास का Neuroscience',
        'topic_key': 'compassion_practice_neural_caregiving',
        'pillar': 'mental_health',
        'evidence_class': 'contemplative_neuroscience_and_autonomic_regulation',
