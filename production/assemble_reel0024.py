...
WORK = ROOT / 'work' / 'reel_0024'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0024_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0024_spacing_effect_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप भी exam या test से ठीक पहले रातभर cramming करने की आदत रखते हैं?"),
    ("Span 02 — Distributed Practice", "Cognitive psychology research दिखाती है कि massed study के मुकाबले distributed practice से retention काफी बेहतर होता है।"),
    ("Span 03 — Memory Consolidation", "जब हम study sessions के बीच time intervals देते हैं, तो memory consolidation को मजबूत होने का समय मिलता है।"),
    ("Span 04 — Desirable Difficulty", "थोड़े अंतराल के बाद information को recall करना एक desirable difficulty पैदा करता है जो memory trace को पक्का करता है।"),
    ("Span 05 — Spaced Sessions", "चार घंटे एक साथ पढ़ने के बजाय, एक-एक घंटे के चार spaced sessions plan करना ज्यादा effective हो सकता है।"),
    ("Span 06 — Nuance & Review", "हर subject और concept की complexity अलग होती है, इसलिए review intervals को आवश्यकतानुसार adjust करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल learning science education के लिए है और cognitive assessment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(234, 88, 12))  # Amber/Rust Learning accent bar
    ...
    draw.text((40, 90), f"REEL-0024 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Psychology & Memory Consolidation Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0024_spacing_effect_and_memory_consolidation',
        'display_id': 'REEL-0024',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0024',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Spacing Effect: Distributed Practice और Long-Term Memory का विज्ञान',
        'topic_key': 'spacing_effect_memory_consolidation',
