...
WORK = ROOT / 'work' / 'reel_0020'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0020_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0020_gentle_stretching_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि gentle stretching से body में movement variability कैसे बढ़ती है?"),
    ("Span 02 — Mayo Clinic Findings", "Research बताती है कि regular stretching routines joints के range of motion को maintain करने में मदद करती हैं।"),
    ("Span 03 — Muscle Stiffness", "जब हम different movements को daily routine में शामिल करते हैं, तो muscles की stiffness कम हो सकती है।"),
    ("Span 04 — Physical Ease", "Mayo Clinic के अनुसार, low-intensity stretching से flexibility और overall physical ease बेहतर हो सकती है।"),
    ("Span 05 — Routine Practice", "यह practice शरीर को daily tasks और healthy movement patterns के लिए तैयार करने का एक आसान तरीका है।"),
    ("Span 06 — Comfort Limits", "ध्यान रखें कि हर व्यक्ति का शरीर अलग होता है, इसलिए stretching हमेशा अपनी comfort range में ही करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल educational awareness के लिए है; किसी भी नए exercise plan से पहले doctor से consult करें।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(16, 185, 129))  # Emerald Mobility accent bar
    ...
    draw.text((40, 90), f"REEL-0020 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Harvard Health & Mayo Clinic Physical Therapy", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0020_gentle_stretching_and_movement_variety_for_mobility',
        'display_id': 'REEL-0020',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0020',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Gentle Stretching: Joint Mobility और Movement Variety के Scientific Tips',
        'topic_key': 'gentle_stretching_movement_variety_mobility',
        'pillar': 'fitness',
        'evidence_class': 'harvard_health_and_mayo_clinic_physical_therapy',
