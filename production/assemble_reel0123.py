...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी नोटिस किया है कि एग्जाम से एक रात पहले रटकर आप पास तो हो जाते हैं, लेकिन 3 दिन बाद दिमाग पूरी तरह साफ हो जाता है?"),
    ("Span 02 — Forgetting Curve", "Neuroscientist Hermann Ebbinghaus ने खोजा कि बिना रिवीजन के हमारा दिमाग 24 घंटे में 70% जानकारी को कचरा समझकर डिलीट कर देता है।"),
    ("Span 03 — Spacing Effect", "लेकिन अगर आप उसी पढ़ाई को टुकड़ों में बांटकर पढ़ें, तो इसे Spacing Effect कहते हैं।"),
    ("Span 04 — Synaptic Growth", "जब आप भूलने के ठीक पहले दोबारा याद करने की कोशिश करते हैं, तो न्यूरॉन्स पर नई प्रोटीन्स बनती हैं जो याददाश्त को लोहे की तरह मजबूत करती हैं।"),
    ("Span 05 — 1 Hr vs 4 Hrs", "एक दिन में 4 घंटे रटने के मुकाबले 4 अलग-अलग दिनों में 1-1 घंटा पढ़ना 300% ज्यादा पक्की याददाश्त बनाता है।"),
    ("Span 06 — 1-3-7-30 Rule", "किसी भी जरूरी बात को Day 1, Day 3, Day 7 और Day 30 पर सिर्फ 5 मिनट के लिए रीवाइज करें—वह जीवनभर के लिए याद हो जाएगी।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल memory neurobiology awareness के लिए है और clinical cognitive impairment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (16, 185, 129)  # Emerald green for memory retention / neural growth
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0123 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Spacing Effect Ebbinghaus Curve Synaptic LTP Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0123_spacing_effect_memory','display_id':'REEL-0123','topic_hi':'The Spacing Effect: रटकर पढ़ी गई चीजें क्यों भूलती हैं और फॉर्मूला क्या है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
