...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि परीक्षा से पहले रातभर जागकर पढ़ने की बजाय, सोने के बाद पढ़ी हुई चीजें दिमाग में कहीं बेहतर तरीके से याद रहती हैं?"),
    ("Span 02 — Two Sleep Phases", "Sleep Science में दो नींद के चरण सबसे महत्वपूर्ण हैं: 'Slow-Wave Sleep' जो तथ्यात्मक यादों को पक्का करती है, और 'REM Sleep' जो भावनात्मक और रचनात्मक एकीकरण करती है।"),
    ("Span 03 — Hippocampal Replay", "Slow-Wave Sleep के दौरान, दिमाग का Hippocampus दिनभर सीखी गई चीजों को तेज़ गति से दोहराता है और उन्हें Neocortex में स्थायी रूप से transfer करता है।"),
    ("Span 04 — Sleep Spindles", "NREM Sleep के दौरान 'Sleep Spindles' नामक brain waves, सीखने के दौरान बनाए गए synaptic connections को और मजबूत बनाते हैं।"),
    ("Span 05 — REM and Creativity", "REM Sleep में दिमाग अलग-अलग ज्ञान के बीच नई और रचनात्मक कड़ियां बनाता है—यही scientific insight और creative problem-solving का मूल आधार है।"),
    ("Span 06 — All-Nighter Truth", "Research बताती है कि रातभर जागकर पढ़ने से अगले दिन की याददाश्त 40% तक कम हो जाती है। पर्याप्त नींद लेकर पढ़ने वाले कहीं बेहतर प्रदर्शन करते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल sleep neuroscience and memory education awareness के लिए है और clinical insomnia या sleep disorder diagnosis का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (16, 185, 129)  # Emerald for sleep/memory
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0083 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Sleep & Memory Consolidation Scientific Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0083_sleep_memory_consolidation','display_id':'REEL-0083','topic_hi':'Sleep & Memory: नींद में सोते समय दिमाग कैसे पढ़ी हुई चीजें पक्की करता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
