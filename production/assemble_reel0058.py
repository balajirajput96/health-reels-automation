...
WORK = ROOT / 'work' / 'reel_0058'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0058_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0058_stress_appraisal_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि किसी स्टेज पर बोलने से पहले दिल की तेज़ धड़कन आपकी मदद के लिए है, न कि आपको डराने के लिए?"),
    ("Span 02 — Cognitive Appraisal Theory", "Psychophysiology में इसे 'Stress Appraisal' कहते हैं—हमारा दिमाग तनाव की स्थिति को कैसे देखता है, वही तय करता है कि शरीर कैसे रिएक्ट करेगा।"),
    ("Span 03 — The Threat Mindset", "अगर दिमाग स्थिति को 'खतरा' (Threat) समझता है, तो रक्त वाहिकाएं सिकुड़ जाती हैं और शरीर में डर का कॉर्टिसोल भर जाता है।"),
    ("Span 04 — The Challenge Mindset", "लेकिन अगर इसे 'चुनौती' (Challenge) माना जाए, तो रक्त वाहिकाएं खुल जाती हैं और दिमाग को ज़्यादा ऑक्सीजन और ऊर्जा मिलती है।"),
    ("Span 05 — Physiology Of Exercise", "चुनौती वाले नजरिए में दिल और नसों की स्थिति ठीक वैसी होती है जैसी कसरत (exercise) करते समय होती है—पूरी तरह सुरक्षित और ऊर्जावान।"),
    ("Span 06 — Arousal Reappraisal", "जब भी दिल तेज़ी से धड़के, खुद से कहें—'मेरा शरीर मुझे इस चुनौती को जीतने के लिए अतिरिक्त ऊर्जा दे रहा है।'"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल psychophysiology education के लिए है और clinical panic या cardiovascular diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(14, 165, 233))  # Light Blue Stress Appraisal accent bar
    ...
    draw.text((40, 90), f"REEL-0058 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Psychophysiology & Biopsychosocial Model of Stress Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0058_stress_appraisal_challenge_vs_threat',
        'display_id': 'REEL-0058',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0058',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Stress Appraisal: तनाव को खतरे (Threat) की जगह चुनौती (Challenge) बनाने का विज्ञान',
        'topic_key': 'stress_appraisal_challenge_vs_threat',
        'pillar': 'mental_health',
        'evidence_class': 'psychophysiology_and_biopsychosocial_stress_model',
