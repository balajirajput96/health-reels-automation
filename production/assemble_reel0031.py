...
WORK = ROOT / 'work' / 'reel_0031'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0031_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0031_behavior_change_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या सिर्फ 'मैं बदलूँगा' कहना behavior change का पक्का सबूत है? Scientific research कहती है—बिल्कुल नहीं।"),
    ("Span 02 — Intention vs Action", "Behavior-change science में stated intention और actual action दो बिल्कुल अलग measures माने जाते हैं।"),
    ("Span 03 — Objective Measurement", "Studies सिर्फ survey पर नहीं, बल्कि digital logs, sensor data और objective performance पर निर्भर करती हैं।"),
    ("Span 04 — Efficacy vs Effectiveness", "Lab में intervention का सफल होना (efficacy) और real life में काम करना (effectiveness) दो अलग बातें हैं।"),
    ("Span 05 — Maintenance Challenge", "शुरुआती उत्साह के बाद कई हफ़्तों के follow-up में adherence कैसे बदलती है, यह असली चुनौती है।"),
    ("Span 06 — Scientific Nuance", "Group average को व्यक्तिगत गारंटी मत समझिए—हर व्यक्ति के barriers और context अलग होते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral science awareness के लिए है और personal या clinical consultation का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(14, 165, 233))  # Sky Blue Behavior accent bar
    ...
    draw.text((40, 90), f"REEL-0031 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Behavior Change Intervention & Adherence Science Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0031_behavior_change_what_studies_measure',
        'display_id': 'REEL-0031',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0031',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Behavior Change: Intention, Real-World Action और Studies का विज्ञान',
        'topic_key': 'behavior_change_what_studies_measure',
        'pillar': 'mental_health',
        'evidence_class': 'behavioral_intervention_and_adherence_science',
