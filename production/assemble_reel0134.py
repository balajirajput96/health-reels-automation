...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि दुनिया भर के एथलीट्स और बायो-हैकर्स हर सुबह बर्फ जैसे ठंडे पानी में डुबकी क्यों लगाते हैं?"),
    ("Span 02 — White Fat vs Brown Fat", "हमारे शरीर में दो तरह का फैट होता है: सफेद चर्बी जो जमा होती है, और भूरी चर्बी यानी 'Brown Fat' जो कैलोरी को जलाकर गर्मी पैदा करती है।"),
    ("Span 03 — UCP1 Heat Engine", "ठंड लगते ही Brown Fat में मौजूद 'UCP1' प्रोटीन एक्टिव हो जाता है, जो जिद्दी चर्बी और शुगर को तुरंत भट्टी की तरह जला देता है।"),
    ("Span 04 — 250% Sustained Dopamine", "वैज्ञानिक रिसर्च में पाया गया कि ठंडे पानी के संपर्क में आने से डोपामाइन 250% तक बढ़ जाता है, जो घंटों तक स्थिर ऊर्जा और फोकस देता है।"),
    ("Span 05 — Better Insulin Sensitivity", "नियमित कोल्ड एक्सपोजर से शरीर की इंसुलिन संवेदनशीलता सुधरती है और मेटाबॉलिज्म तेज होता है।"),
    ("Span 06 — 11 Minutes Per Week", "Dr. Susanna Søberg के अनुसार, हफ्ते में कुल मिलाकर सिर्फ 11 मिनट ठंडा स्नान ब्राउन फैट को जगाने के लिए काफी है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल metabolic thermal awareness के लिए है और cardiovascular disease therapy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.16, 0.16, 0.15, 0.15, 0.14, 0.12, 0.12]
ACCENT = (6, 182, 212)  # Cyan / Ice blue for cold plunge & brown adipose tissue
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0134 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Cold Plunge • Brown Fat • UCP1 • 250% Dopamine",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0134_cold_plunge_bat','display_id':'REEL-0134','topic_hi':'Cold Plunge: ठंडे पानी से ब्राउन फैट और 250% डोपामाइन कैसे बढ़ता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
