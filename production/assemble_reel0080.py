...
WORK = ROOT / 'work' / 'reel_0080'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0080_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0080_peak_end_rule_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि एक 7 दिन की शानदार ट्रिप के आखिर में अगर 2 घंटे की फ्लाइट लेट हो जाए, तो पूरी ट्रिप बुरी क्यों लगने लगती है?"),
    ("Span 02 — Kahneman's Peak-End Rule", "Behavioral Science में इसे 'Peak-End Rule' कहते हैं—हमारा दिमाग किसी अनुभव को दो बिंदुओं से याद रखता है: सबसे तीव्र पल (Peak) और आखिरी पल (End)।"),
    ("Span 03 — Duration Neglect", "हमारा दिमाग यह नहीं गिनता कि अनुभव कितने घंटे या दिन चला (Duration Neglect)—वह सिर्फ यह देखता है कि अंत कैसा हुआ।"),
    ("Span 04 — The Medical Experiment", "नोबेल विजेता डेनियल काहनेमैन के प्रयोगों में देखा गया कि जिस प्रक्रिया का अंत शांत और कम दर्दनाक था, मरीजों ने उसे बाद में कम तकलीफदेह बताया।"),
    ("Span 05 — The Remembering Self", "हमारा 'याद रखने वाला मन' (Remembering Self) पूरी कहानी का औसत नहीं निकालता, बल्कि सिर्फ मुख्य हाइलाइट्स की एक छवि बना लेता है।"),
    ("Span 06 — Practical Application", "इसलिए जब भी आप पढ़ाई, कठिन वर्कआउट या कोई बातचीत खत्म करें, तो उसका अंत हमेशा किसी सकारात्मक और सुखद अहसास पर करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive heuristics and memory science awareness के लिए है और clinical memory disorder diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(14, 165, 233))  # Sky Blue Memory Heuristic accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(14, 165, 233), font=font_header)
    draw.text((40, 90), f"REEL-0080 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Heuristics & Peak-End Memory Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0080_peak_end_rule_memory_heuristics',
        'display_id': 'REEL-0080',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0080',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Peak-End Rule: हमारा दिमाग पुरानी यादों को कैसे याद रखता है?',
        'topic_key': 'peak_end_rule_duration_neglect_kahneman',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_heuristics_and_behavioral_decision_science',
