...
WORK = ROOT / 'work' / 'reel_0036'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0036_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0036_implementation_intentions_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या सिर्फ 'मैं healthy बनूँगा' सोचना habit बना देता है? Behavioral science कहती है—प्लानिंग में एक खास तत्व चाहिए।"),
    ("Span 02 — Goal vs Implementation", "'मैं walk करूँगा' एक goal intention है। लेकिन 'अगर शाम के सात बजेंगे, तो मैं जूते पहनूँगा'—यह implementation intention है।"),
    ("Span 03 — Cue Detection Speed", "If-then planning दिमाग में critical cue (समय या जगह) को पहचानने की cognitive speed को तेज़ कर देती है।"),
    ("Span 04 — Automatic Response", "जब वह निश्चित परिस्थिति आती है, तो बिना ज़्यादा सोचे-समझे targeted action शुरू करना आसान हो जाता है।"),
    ("Span 05 — Practical Formula", "अपने दैनिक लक्ष्यों को 'अगर [Situation], तो [Action]' के स्पष्ट फ़ॉर्मूले में ढालें।"),
    ("Span 06 — Real-World Context", "याद रखें कि यह कोई जादुई बटन नहीं है; बाधाओं और वास्तविक परिस्थितियों के अनुसार प्लान को adjust करना ज़रूरी है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral science awareness के लिए है और personal या clinical advice का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(16, 185, 129))  # Emerald Planning accent bar
    ...
    draw.text((40, 90), f"REEL-0036 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Implementation Intentions & Behavioral Science Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0036_implementation_intentions_if_then_planning',
        'display_id': 'REEL-0036',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0036',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Implementation Intentions: If-Then Planning से Habits बनाने का विज्ञान',
        'topic_key': 'implementation_intentions_if_then_planning',
        'pillar': 'mental_health',
        'evidence_class': 'behavioral_science_and_goal_attainment',
