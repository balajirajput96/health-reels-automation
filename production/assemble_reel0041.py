...
WORK = ROOT / 'work' / 'reel_0041'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0041_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0041_meditation_training_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "जब कोई रिसर्च कहती है कि 'meditation training का असर हुआ', तो क्या आपने सोचा है कि training को मापा कैसे गया?"),
    ("Span 02 — Assigned Dose", "पहला स्तर है assigned dose—participants को कितने मिनट और कितने दिन ध्यान करने को कहा गया, जो actual practice से अलग हो सकता है।"),
    ("Span 03 — Adherence Measurement", "दूसरा स्तर है adherence—कई studies में यह self-report पर आधारित होता है, न कि किसी सेंसर की minute-by-minute रिकॉर्डिंग पर।"),
    ("Span 04 — Questionnaire Outcomes", "तीसरा स्तर है outcome—well-being या mindfulness questionnaire का स्कोर, जो व्यक्ति का अपना अनुभव दर्शाता है।"),
    ("Span 05 — EEG Neurophysiology", "EEG studies मस्तिष्क तरंगों (brain oscillations) को मापती हैं, लेकिन EEG कोई विचार पढ़ने वाला यंत्र नहीं है।"),
    ("Span 06 — Critical Thinking", "इसलिए हमेशा देखें कि रिसर्च में क्या मापा गया—assigned time, self-report, या direct neurophysiology।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल contemplative science awareness के लिए है और medical या psychiatric consultation का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(59, 130, 246))  # Blue Meditation accent bar
    ...
    draw.text((40, 90), f"REEL-0041 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Contemplative Neuroscience & Dose Adherence Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0041_meditation_training_and_dose_adherence',
        'display_id': 'REEL-0041',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0041',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Meditation Training: वैज्ञानिक रिसर्च वास्तव में क्या मापती है?',
        'topic_key': 'meditation_training_dose_adherence',
        'pillar': 'mental_health',
        'evidence_class': 'contemplative_neuroscience_and_eeg_classification',
