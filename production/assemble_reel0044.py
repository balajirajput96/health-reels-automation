...
WORK = ROOT / 'work' / 'reel_0044'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0044_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0044_feedback_learning_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या सिर्फ 'बहुत अच्छा किया' या 'तुम होशियार हो' कहना किसी की performance सच में बेहतर बनाता है?"),
    ("Span 02 — Feedback Intervention Theory", "Research में पाया गया है कि गलत तरीके से दिया गया फीडबैक एक तिहाई मामलों में performance को सुधारने के बजाय बिगाड़ देता है।"),
    ("Span 03 — Task vs Ego Feedback", "व्यक्ति की योग्यता पर टिप्पणी (Ego-focused) ध्यान भटकाती है, जबकि काम के तरीके पर दिया गया फीडबैक (Task-focused) सुधार लाता है।"),
    ("Span 04 — Specific Actionable Steps", "असरदार फीडबैक वह है जो साफ बताए—क्या गलत हुआ, सही तरीका क्या है, और अगला कदम क्या होना चाहिए।"),
    ("Span 05 — Error Correction Loop", "गलती होने के तुरंत बाद सही प्रक्रिया समझने से दिमाग अपने internal model को update कर लेता है।"),
    ("Span 06 — Practical Communication", "दूसरों को या खुद को फीडबैक देते समय व्यक्ति के बजाय प्रक्रिया और विशिष्ट गलतियों पर ध्यान केंद्रित करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल learning science education के लिए है और formal clinical or educational appraisal का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(20, 184, 166))  # Teal Feedback accent bar
    ...
    draw.text((40, 90), f"REEL-0044 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Learning Science & Feedback Intervention Theory Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0044_feedback_in_learning_and_error_correction',
        'display_id': 'REEL-0044',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0044',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Feedback in Learning: सही फीडबैक से स्किल सुधारने का विज्ञान',
        'topic_key': 'feedback_in_learning_error_correction',
        'pillar': 'mental_health',
        'evidence_class': 'learning_science_and_feedback_intervention_theory',
