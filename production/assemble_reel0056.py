...
WORK = ROOT / 'work' / 'reel_0056'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0056_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0056_goal_gradients_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने देखा है कि दौड़ते समय फिनिश लाइन दिखते ही शरीर में अचानक नई ऊर्जा और रफ़्तार कहाँ से आ जाती है?"),
    ("Span 02 — Clark Hull's Hypothesis", "Behavioral science में इसे 'Goal Gradient Effect' कहते हैं—लक्ष्य जितना पास होता है, हमारा प्रयास उतना ही तेज़ हो जाता है।"),
    ("Span 03 — Coffee Card Research", "रिसर्च में पाया गया कि लॉयल्टी कार्ड पर 10 में से 8 स्टैम्प पूरे होते ही ग्राहक बाकी बचे 2 स्टैम्प बहुत जल्दी पूरे करते हैं।"),
    ("Span 04 — The Endowed Progress Effect", "यदि कार्ड पर 2 फ़्री स्टैम्प पहले से लगाकर 12 में से 2 भरे दिखाए जाएं, तो लोग खाली 10 वाले कार्ड से दोगुना तेज़ खरीदारी करते हैं।"),
    ("Span 05 — Subjective Distance", "दिमाग दूरी के वास्तविक फासले से ज़्यादा इस बात पर प्रतिक्रिया देता है कि वह खुद को फिनिश लाइन के कितने करीब महसूस कर रहा है।"),
    ("Span 06 — Practical Milestone Strategy", "बड़े और लंबे लक्ष्यों को छोटे-छोटे 3 से 5 दिन के माइलस्टोन्स में बांटें ताकि दिमाग हर थोड़े दिन में फिनिश लाइन की तेजी महसूस करे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral decision science awareness के लिए है और financial या psychological assessment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(249, 115, 22))  # Orange Goal Gradient accent bar
    ...
    draw.text((40, 90), f"REEL-0056 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Behavioral Economics & Goal Gradient Hypothesis Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0056_goal_gradient_effect_and_proximity_acceleration',
        'display_id': 'REEL-0056',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0056',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Goal Gradient Effect: लक्ष्य के करीब आते ही रफ़्तार बढ़ने का विज्ञान',
        'topic_key': 'goal_gradient_effect_proximity_acceleration',
        'pillar': 'mental_health',
        'evidence_class': 'behavioral_decision_science_and_goal_pursuit',
