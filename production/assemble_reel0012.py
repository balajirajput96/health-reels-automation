...
WORK = ROOT / 'work' / 'reel_0012'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0012_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0012_morning_planning_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "सुबह की शुरुआत planning के साथ करना क्या आपके लिए helpful हो सकता है?"),
    ("Span 02 — Evidence & Fatigue", "Research describes करती है कि daily routines और small, realistic priorities set करने से decision fatigue reduce हो सकती है।"),
    ("Span 03 — Harvard Health", "Harvard Health के अनुसार, अपने day को manage करने के लिए manageable steps चुनना stress को manage करने में a supportive cue बन सकता है।"),
    ("Span 04 — APA Insights", "APA भी highlight करता है कि habits को step-by-step build करना long-term well-being के लिए effective हो सकता है।"),
    ("Span 05 — Small Milestones", "इसलिए morning में unrealistic goals बनाने की बजाय, small और practical milestones पर focus करना beneficial हो सकता है।"),
    ("Span 06 — Individual Variation", "हर individual की needs अलग होती हैं, इसलिए अपने pace के अनुसार routines adjust करना sensible रहता है।"),
    ("Span 07 — Safety Boundary", "Disclaimer: यह content केवल general education और awareness के लिए है; यह professional medical advice या treatment का substitute नहीं है।"),
]

CAPTION_TEXT = [span[1] for span in SPANS]
WEIGHTS = [0.12, 0.16, 0.16, 0.15, 0.16, 0.13, 0.12]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(251, 146, 60))  # Warm Amber accent bar
    ...
    draw.text((40, 90), f"REEL-0012 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Harvard Health & APA Behavioral Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0012_morning_planning_and_realistic_priorities',
        'display_id': 'REEL-0012',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0012',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Morning Planning और Realistic Priorities: Mental Well-Being के लिए Simple Routine',
        'topic_key': 'morning_planning_realistic_priorities',
        'pillar': 'lifestyle',
        'evidence_class': 'public_health_research_harvard_health_and_apa',
