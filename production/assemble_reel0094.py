...
SPANS = [
    ("Span 01 — Hook", "क्या आपने सोचा है कि सबसे प्रतिभाशाली लोगों से बनी टीमें कई बार बुरी तरह असफल क्यों हो जाती हैं, जबकि साधारण टीमों में अद्भुत नवाचार होता है?"),
    ("Span 02 — Edmondson Discovery", "Harvard Business School की Amy Edmondson ने खोजा कि इसका राज़ Psychological Safety है—यानी बिना डर के सवाल पूछने और गलती स्वीकार करने का माहौल।"),
    ("Span 03 — Project Aristotle", "गूगल के प्रसिद्ध Project Aristotle ने 180 टीमों का अध्ययन करके पाया कि टीम की सफलता में सबसे महत्वपूर्ण तत्व यही Psychological Safety था।"),
    ("Span 04 — Brain Under Fear", "जब काम की जगह डांट या अपमान का डर होता है, तो दिमाग का Amygdala सक्रिय हो जाता है, जिससे सोचने और निर्णय लेने की क्षमता जाम हो जाती है।"),
    ("Span 05 — Executive Unlocking", "सुरक्षित माहौल मिलने पर Prefrontal Cortex स्वतंत्र होकर नए जोखिम लेने, सवाल पूछने और लीक से हटकर सोचने के लिए सक्रिय हो जाता है।"),
    ("Span 06 — Building Team Safety", "लीडर्स गलतियों पर गुस्सा होने की बजाय उत्सुकता दिखाएं, जिससे टीम बिना झिझक सच बोल सके और बेहतर सीख सके।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल organizational neuroscience and team psychology awareness के लिए है और business consulting का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (59, 130, 246)  # Blue for psychological safety
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0094 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Psychological Safety Project Aristotle Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0094_psychological_safety_teams','display_id':'REEL-0094','topic_hi':'Psychological Safety: डर का माहौल टीम के दिमाग को कैसे पंगु बना देता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
