...
WORK = ROOT / 'work' / 'reel_0076'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0076_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0076_emotion_regulation_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप भी गुस्सा आने पर जबरदस्ती मुस्कुराने की कोशिश करते हैं और अपनी भावनाओं को अंदर ही अंदर दबा लेते हैं?"),
    ("Span 02 — James Gross's Emotion Model", "Affective Science में भावनाओं को संभालने के 2 मुख्य तरीके बताए गए हैं: 'Cognitive Reappraisal' और 'Expressive Suppression'।"),
    ("Span 03 — The Biological Cost Of Suppression", "जब आप अपनी भावनाओं को दबाते हैं (Suppression), तो चेहरे पर शांति दिखती है, लेकिन अंदर दिल की धड़कन और कोर्टिसोल हॉर्मोन बढ़ जाता है।"),
    ("Span 04 — Cognitive Reappraisal Mechanism", "दूसरा तरीका है 'Reappraisal'—यानी स्थिति पर तुरंत गुस्सा करने के बजाय अपने नजरिए को बदलना और स्थिति को नए रूप में देखना।"),
    ("Span 05 — Brain Network Control", "रिसर्च बताती है कि Reappraisal से हमारे 'Prefrontal Cortex' का नियंत्रण बढ़ता है, जिससे दिमाग का डर वाला हिस्सा (Amygdala) शांत हो जाता है।"),
    ("Span 06 — Practical Reframing Habit", "इसलिए भावनाओं को दबाने के बजाय खुद से पूछें: 'क्या इस स्थिति का कोई दूसरा मतलब हो सकता है?' इससे तनाव तुरंत कम हो जाता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल affective neuroscience awareness के लिए है और clinical psychotherapy diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(236, 72, 153))  # Pink-Rose Emotion Regulation accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(236, 72, 153), font=font_header)
    draw.text((40, 90), f"REEL-0076 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Affective Neuroscience & Emotion Regulation Reappraisal Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0076_emotion_regulation_cognitive_reappraisal',
        'display_id': 'REEL-0076',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0076',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Emotion Regulation: गुस्सा या दुख दबाने से दिमाग और शरीर पर क्या असर होता है?',
        'topic_key': 'emotion_regulation_reappraisal_vs_suppression',
        'pillar': 'mental_health',
        'evidence_class': 'affective_neuroscience_and_emotion_regulation',
