...
WORK = ROOT / 'work' / 'reel_0064'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0064_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0064_semantic_memory_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि आपको यह तो याद है कि सूरज पूरब से उगता है, लेकिन यह याद नहीं कि आपने यह पहली बार कहाँ सीखा था?"),
    ("Span 02 — Semantic vs Episodic Memory", "Cognitive Neuroscience में इसे 'Semantic Memory' कहते हैं—यह हमारे दिमाग की वह एनसाइक्लोपीडिया है जहाँ दुनिया भर के तथ्य और भाषा के अर्थ जमा होते हैं।"),
    ("Span 03 — Spreading Activation Network", "दिमाग में यह ज्ञान एक जाल (Network) की तरह जुड़ा है—जैसे ही आप 'सेब' सोचते हैं, 'लाल', 'फल' और 'मीठा' अपने आप दिमाग में एक्टिवेट हो जाते हैं।"),
    ("Span 04 — The Anterior Temporal Lobe", "दिमाग का 'Anterior Temporal Lobe' हिस्सा एक हब की तरह काम करता है, जो देखने, सुनने और छूने के अनुभवों को जोड़कर एक अमूर्त विचार बनाता है।"),
    ("Span 05 — Abstract Categorization", "इसी क्षमता के कारण हम किसी भी नए डिज़ाइन की कुर्सी को देखकर तुरंत पहचान लेते हैं कि यह बैठने की चीज़ है।"),
    ("Span 06 — Smarter Learning Approach", "किसी भी नई जानकारी को लंबे समय तक याद रखने के लिए उसे पुराने जाने-पहचाने विचारों से जोड़कर पढ़ें, न कि रट्टा मारें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive neuroscience awareness के लिए है और neurological memory impairment diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(168, 85, 247))  # Purple Semantic Memory accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(168, 85, 247), font=font_header)
    draw.text((40, 90), f"REEL-0064 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Neuroscience & Semantic Network Knowledge Organization Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0064_semantic_memory_conceptual_networks',
        'display_id': 'REEL-0064',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0064',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Semantic Memory: दिमाग में ज्ञान और तथ्यों का विशाल नेटवर्क कैसे काम करता है?',
        'topic_key': 'semantic_memory_conceptual_networks',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_neuroscience_and_semantic_memory',
