...
WORK = ROOT / 'work' / 'reel_0071'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0071_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0071_theory_of_mind_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि हम कैसे समझ पाते हैं कि सामने वाला व्यक्ति क्या सोच रहा है और उसके मन में क्या चल रहा है?"),
    ("Span 02 — The Concept Of Mentalizing", "Cognitive Science में इसे 'Theory of Mind' कहते हैं—यह क्षमता जिससे हम दूसरों के विश्वास, इरादे और भावनाओं को समझ पाते हैं।"),
    ("Span 03 — The False-Belief Experiment", "वैज्ञानिक इसे 'फॉल्स-बिलीफ टेस्ट' (False-Belief Task) से मापते हैं—यह देखना कि क्या हम समझ सकते हैं कि दूसरे का विश्वास हकीकत से अलग हो सकता है।"),
    ("Span 04 — The Mentalizing Brain Network", "दिमाग का 'Temporoparietal Junction' (TPJ) और 'Prefrontal Cortex' दूसरों के नजरिए को समझने में सबसे अहम भूमिका निभाते हैं।"),
    ("Span 05 — The Power Of Perspective Taking", "यह कौशल हमें बातचीत में गलतफहमियां सुलझाने, दूसरों की भावनाएं समझने और बेहतर रिश्ते बनाने में मदद करता है।"),
    ("Span 06 — The Egocentric Trap", "अक्सर हमारा अपना ज्ञान हमें यह मानने पर मजबूर करता है कि जो हमें पता है, वही सबको पता होगा (Egocentric Bias)।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive developmental science awareness के लिए है और clinical diagnostic assessment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(168, 85, 247))  # Purple Mentalizing accent bar
    ...
    draw.text((40, 90), f"REEL-0071 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Developmental Science & Theory of Mind Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0071_theory_of_mind_mentalizing',
        'display_id': 'REEL-0071',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0071',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Theory of Mind: दूसरों के दिमाग की सोच समझने का अनोखा विज्ञान',
        'topic_key': 'theory_of_mind_mental_state_attribution',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_developmental_psychology_and_social_cognition',
