...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि जब आप रात को गहरी नींद में सोते हैं, तो आपका दिमाग सचमुच एक वाशिंग मशीन की तरह खुद को अंदर से धो रहा होता है?"),
    ("Span 02 — Glymphatic Discovery", "Neuroscientist Dr. Maiken Nedergaard ने खोजा कि दिमाग में Glymphatic System नाम का एक खास वेस्ट-क्लीनिंग नेटवर्क होता है।"),
    ("Span 03 — Glial Cells Shrink", "गहरी नींद में दिमाग की ग्लियल कोशिकाएं 60% तक सिकुड़ जाती हैं, जिससे तरल पदार्थ के बहने की जगह चौड़ी हो जाती है।"),
    ("Span 04 — CSF Toxin Flush", "रीढ़ की हड्डी का पानी तेजी से दिमाग में बहकर Amyloid-Beta और Tau जैसे खतरनाक टॉक्सिन्स को बाहर बहा ले जाता है।"),
    ("Span 05 — Side Sleeping Benefit", "रिसर्च में पाया गया कि करवट लेकर सोने से गुरुत्वाकर्षण के कारण टॉक्सिन्स की सफाई सबसे तेजी से होती है।"),
    ("Span 06 — 7-8 Hour Deep Sleep", "अधूरी नींद दिमाग में कचरा जमा करती है—इसलिए रात को 7 से 8 घंटे की गहरी नींद दिमाग की लंबी उम्र के लिए अनिवार्य है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल sleep neurobiology awareness के लिए है और neurological disorder treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (99, 102, 241)  # Indigo for deep sleep / glymphatic washing
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0112 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Glymphatic System CSF Deep Sleep Toxin Flush Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0112_glymphatic_system_sleep','display_id':'REEL-0112','topic_hi':'Glymphatic System: सोते समय दिमाग अपने टॉक्सिन्स कैसे धोता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
