...
WORK = ROOT / 'work' / 'reel_0065'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0065_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0065_false_memory_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपके साथ कभी ऐसा हुआ है कि आपको बचपन की कोई घटना पूरी तरह सच लगती है, लेकिन आपके घरवाले कहते हैं कि ऐसा कभी हुआ ही नहीं था?"),
    ("Span 02 — Memory Is Constructive", "Cognitive Psychology में इसे 'False Memory' कहते हैं—हमारा दिमाग यादों को वीडियो कैमरे की तरह रिकॉर्ड नहीं करता, बल्कि हर बार नए सिरे से जोड़ता है।"),
    ("Span 03 — The Misinformation Effect", "रिसर्च में पाया गया कि किसी घटना के बाद पूछे गए एक गलत सवाल से लोगों के दिमाग में झूठी यादें पैदा हो जाती हैं।"),
    ("Span 04 — Source Monitoring Failure", "दिमाग अक्सर यह भूल जाता है कि उसने कोई बात सच में देखी थी, किसी सपने में देखी थी या किसी की सुनाई कहानी में सुनी थी।"),
    ("Span 05 — The Confidence Trap", "सबसे हैरान करने वाली बात यह है कि जितनी पक्की और साफ आपको कोई याद लगती है, जरूरी नहीं कि वह उतनी ही सच हो।"),
    ("Span 06 — Healthy Cognitive Humility", "इसलिए अपनी और दूसरों की यादों पर बहस करने के बजाय यह स्वीकार करें कि इंसानी याददाश्त स्वाभाविक रूप से लचीली और बदलती रहती है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive memory science awareness के लिए है और forensic legal advice का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(236, 72, 153))  # Pink False Memory accent bar
    ...
    draw.text((40, 90), f"REEL-0065 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Memory Psychology & Constructive Retrieval Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0065_false_memory_and_misinformation_effect',
        'display_id': 'REEL-0065',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0065',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'False Memory: हमारा दिमाग पुरानी यादों को अपने आप क्यों बदल देता है?',
        'topic_key': 'false_memory_misinformation_effect',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_memory_psychology_and_constructive_retrieval',
