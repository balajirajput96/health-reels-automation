...
SPANS = [
    ("Span 01 — Hook", "क्या आपके साथ कभी ऐसा हुआ है कि किसी फैसला लेते समय पेट में एक अजीब सा अहसास होता है जो आगे चलकर बिल्कुल सही साबित होता है?"),
    ("Span 02 — Damasio Discovery", "Neuroscientist Antonio Damasio ने Somatic Marker Hypothesis में साबित किया कि यह कोई अंधविश्वास नहीं, बल्कि दिमाग की तीव्र वैज्ञानिक प्रक्रिया है।"),
    ("Span 03 — Somatic Marker", "हमारे Ventromedial Prefrontal Cortex में पुराने अनुभवों के आधार पर शरीर की शारीरिक प्रतिक्रियाएं स्टोर होती हैं।"),
    ("Span 04 — Pre-Conscious Filter", "जब हम कोई नया फैसला लेते हैं, तो दिमाग सेकंड के सौवें हिस्से में नुकसानदेह विकल्पों को इन शारीरिक संकेतों के ज़रिए हटा देता है।"),
    ("Span 05 — Iowa Gambling Task", "लैब प्रयोगों में देखा गया कि लोग सचेत रूप से समझने से पहले ही गलत कार्ड चुनने पर शारीरिक रूप से पसीना और तनाव महसूस करने लगते हैं।"),
    ("Span 06 — Intuition + Logic", "इसलिए अपनी Gut Feeling को पूरी तरह खारिज न करें—यह आपके अतीत के अनुभवों का तेज़ और शक्तिशाली अचेतन निचोड़ है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल decision-making neuroscience awareness के लिए है और clinical psychiatric evaluation का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (16, 185, 129)  # Emerald for gut feeling/somatic
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0092 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Somatic Marker Hypothesis Gut Feeling Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0092_somatic_marker_gut_feeling','display_id':'REEL-0092','topic_hi':'Somatic Marker Hypothesis: क्या Gut Feeling की आवाज वैज्ञानिक रूप से सही होती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
