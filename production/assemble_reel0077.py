...
WORK = ROOT / 'work' / 'reel_0077'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0077_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0077_flow_state_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी अनुभव किया है कि जब आप अपने किसी पसंदीदा खेल, संगीत या कोडिंग में डूबते हैं, तो समय का अहसास बिल्कुल खत्म क्यों हो जाता है?"),
    ("Span 02 — What Is Flow", "Psychology में इस मानसिक स्थिति को 'Flow State' कहते हैं—यह पूर्ण एकाग्रता और सहज प्रदर्शन की स्थिति होती है।"),
    ("Span 03 — Transient Hypofrontality", "Neuroscience के अनुसार, फ्लो में हमारे दिमाग का 'Prefrontal Cortex' अपनी आत्म-आलोचना (Inner Critic) और चिंता को थोड़ी देर के लिए शांत कर देता है।"),
    ("Span 04 — The Neurochemical Cocktail", "इस समय दिमाग में डोपामिन और नॉरएड्रेनालिन जैसे न्यूरोट्रांसमीटर सही मात्रा में रिलीज होते हैं, जो सीखने और प्रतिक्रिया की गति को बढ़ा देते हैं।"),
    ("Span 05 — Challenge-Skill Balance", "फ्लो तभी आता है जब काम न तो बहुत आसान हो (जिससे बोरियत हो) और न ही बहुत कठिन हो (जिससे घबराहट हो)।"),
    ("Span 06 — How To Enter Flow", "फ्लो में जाने के लिए बिना किसी रुकावट के लगातार 45 से 60 मिनट एक ही काम पर बिना फोन देखे फोकस करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल peak performance cognitive awareness के लिए है और clinical psychological therapy का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(16, 185, 129))  # Emerald Flow State accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(16, 185, 129), font=font_header)
    draw.text((40, 90), f"REEL-0077 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Neuroscience & Transient Hypofrontality Flow Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0077_neurobiology_of_flow_state',
        'display_id': 'REEL-0077',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0077',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Flow State: जब दिमाग का सारा शोर शांत होकर 100% फोकस बन जाता है',
        'topic_key': 'flow_state_transient_hypofrontality_dopamine',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_neuroscience_and_peak_performance',
