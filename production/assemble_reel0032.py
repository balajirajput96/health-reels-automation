...
WORK = ROOT / 'work' / 'reel_0032'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0032_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0032_affect_labeling_context_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "जब गुस्सा या घबराहट हो, तो अपनी फीलिंग को बोल देने से मन हल्का क्यों लगता है?"),
    ("Span 02 — fMRI Neuroimaging", "fMRI brain scans दिखाते हैं कि जब हम अपनी भावना को नाम देते हैं (affect labeling), तो amygdala शांत होने लगता है।"),
    ("Span 03 — Prefrontal Activation", "भावनाओं को शब्दों में ढालते समय prefrontal cortex सक्रिय होता है और emotional brain पर नियंत्रण बनाता है।"),
    ("Span 04 — Autonomic Dampening", "यह neural process दिल की धड़कन और autonomic arousal को stabilize करने में मदद करती है।"),
    ("Span 05 — Simple Phrasing", "कठिन परिस्थिति में खुद से कहना—'मुझे इस समय घबराहट महसूस हो रही है'—एक शक्तिशाली regulatory cue बन सकता है।"),
    ("Span 06 — Realistic Regulation", "यह समस्या को तुरंत ख़त्म नहीं करता, लेकिन brain को calm down करके बेहतर फैसले लेने में मदद करता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल neuroscience awareness के लिए है और clinical psychotherapy का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(59, 130, 246))  # Blue Prefrontal accent bar
    ...
    draw.text((40, 90), f"REEL-0032 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "fMRI Neuroimaging & Affect Labeling Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0032_affect_labeling_in_context',
        'display_id': 'REEL-0032',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0032',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Affect Labeling: तनाव में भावनाओं को शब्दों में ढालने का Neuroscience',
        'topic_key': 'affect_labeling_in_context',
        'pillar': 'mental_health',
        'evidence_class': 'fmri_neuroimaging_and_affective_regulation',
