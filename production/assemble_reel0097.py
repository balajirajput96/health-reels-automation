...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि अकेलापन केवल एक उदास अहसास नहीं है, बल्कि दिमाग इसे भूख या प्यास की तरह एक शारीरिक अलार्म मानता है?"),
    ("Span 02 — Cacioppo Model", "Neuroscientist John Cacioppo के अनुसार, प्राचीन काल में समूह से अलग होना जानलेवा था, इसलिए अकेला महसूस होते ही दिमाग Threat Mode में चला जाता है।"),
    ("Span 03 — Social Hyper-Vigilance", "अकेलेपन में दिमाग Social Hyper-Vigilance की स्थिति में आ जाता है, जहाँ हर साधारण बात या इंसान में भी खतरा महसूस होने लगता है।"),
    ("Span 04 — Sympathetic Overdrive", "यह स्थिति नर्वस सिस्टम को लगातार अलर्ट पर रखती है, जिससे रात में गहरी नींद नहीं आती और स्ट्रेस हार्मोन बढ़ा रहता है।"),
    ("Span 05 — Cytokine Surge", "Genetics रिसर्च में देखा गया कि अकेलापन शरीर में Pro-Inflammatory Genes को एक्टिव कर देता है, जिससे अंदरूनी सूजन और बीमारियाँ बढ़ती हैं।"),
    ("Span 06 — Re-Connecting Call", "इसे समझें: अकेलापन इस बात का जैविक संकेत है कि आपको सच्चे और सुरक्षित सामाजिक संबंधों की ज़रूरत है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social neurobiology public awareness के लिए है और clinical mental health evaluation का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (239, 68, 68)  # Red for loneliness threat
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0097 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Loneliness Neuroscience Inflammation Threat Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0097_neurobiology_of_loneliness','display_id':'REEL-0097','topic_hi':'Loneliness Neuroscience: अकेलापन शरीर में सूजन क्यों बढ़ाता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
