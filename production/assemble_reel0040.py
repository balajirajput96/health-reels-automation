...
WORK = ROOT / 'work' / 'reel_0040'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0040_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0040_interleaving_effect_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप भी एक ही तरह के सवाल बार-बार हल करके पढ़ाई करते हैं? Cognitive science कहती है—पद्धति बदलिए।"),
    ("Span 02 — Blocked vs Interleaved", "एक ही topic लगातार पढ़ना 'blocked practice' है, जबकि अलग-अलग topics को मिलाकर पढ़ना 'interleaving' कहलाता है।"),
    ("Span 03 — Strategy Discrimination", "Interleaved practice दिमाग को यह पहचानने पर मजबूर करती है कि किस सवाल पर कौन सा formula या strategy लगेगी।"),
    ("Span 04 — Research Evidence", "Studies दर्शाती हैं कि blocked study तुरंत आसान लगती है, लेकिन long-term retention में interleaved study कहीं आगे होती है।"),
    ("Span 05 — Desirable Difficulty", "यह अभ्यास थोड़ी मेहनत (desirable difficulty) मांगता है, जिससे memory traces और problem-solving skills मजबूत होती हैं।"),
    ("Span 06 — Practical Application", "Study session में flashcards को shuffle करें और अलग-अलग chapters के सवाल मिलाकर अभ्यास करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल learning science education के लिए है और formal cognitive assessment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(147, 51, 234))  # Purple Interleaving accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(147, 51, 234), font=font_header)
    draw.text((40, 90), f"REEL-0040 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Psychology & Interleaved Practice Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0040_interleaving_effect_in_learning',
        'display_id': 'REEL-0040',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0040',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Interleaving Effect: पढ़ाई में Topics को Mix करने से Retention बढ़ने का विज्ञान',
        'topic_key': 'interleaving_effect_in_learning',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_psychology_and_learning_science',
