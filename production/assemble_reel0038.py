...
WORK = ROOT / 'work' / 'reel_0038'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0038_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0038_environmental_friction_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने गौर किया है कि phone को दूसरे कमरे में रखने मात्र से screen time आधा क्यों हो जाता है?"),
    ("Span 02 — Behavioral Ergonomics", "Behavioral psychology में इसे 'environmental friction' कहते हैं—किसी काम को करने में लगने वाला शारीरिक प्रयास।"),
    ("Span 03 — Energy Conservation", "दिमाग प्राकृतिक रूप से ऊर्जा बचाने के लिए हमेशा सबसे कम प्रयास (least resistance) वाले विकल्प को चुनता है।"),
    ("Span 04 — Adding Friction", "बुरी आदतों के रास्ते में दो-तीन अतिरिक्त कदम जोड़ना (जैसे password लगाना) impulsive behavior को तोड़ देता है।"),
    ("Span 05 — Removing Friction", "अच्छी आदतों के रास्ते से रुकावटें हटाना (जैसे रात को ही workout gear निकालना) अगली सुबह शुरुआत को आसान बनाता है।"),
    ("Span 06 — Sustainable Design", "विलपॉवर पर निर्भर रहने के बजाय अपने आस-पास के माहौल को इस तरह डिज़ाइन करें कि सही काम करना सबसे आसान विकल्प बन जाए।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral science awareness के लिए है और clinical psychological advice का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(14, 165, 233))  # Cyan Friction accent bar
    ...
    draw.text((40, 90), f"REEL-0038 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Environmental Friction & Behavioral Design Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0038_environmental_friction_and_habit_ergonomics',
        'display_id': 'REEL-0038',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0038',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Environmental Friction: छोटी रुकावटों से बुरी आदतें रोकने का विज्ञान',
        'topic_key': 'environmental_friction_and_habit_ergonomics',
        'pillar': 'mental_health',
        'evidence_class': 'environmental_psychology_and_habit_design',
