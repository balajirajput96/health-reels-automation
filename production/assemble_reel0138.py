...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि पहाड़ पर चढ़ने वाले पर्वतारोहियों और गोताखोरों का शरीर बिना किसी दवा के खून में लाल कोशिकाएं कैसे बढ़ा लेता है?"),
    ("Span 02 — Nobel Prize Science", "2019 के नोबेल प्राइज विजेता वैज्ञानिकों ने खोजा कि जब शरीर में ऑक्सीजन की थोड़ी कमी होती है, तो HIF-1 Alpha प्रोटीन एक्टिव हो जाता है।"),
    ("Span 03 — Kidney EPO Release", "यह प्रोटीन किडनी को संकेत भेजता है, जिससे किडनी EPO नाम का कुदरती हार्मोन खून में रिलीज करती है।"),
    ("Span 04 — Bone Marrow RBC Surge", "यह हार्मोन हमारी हड्डियों के मज्जा को नई लाल रक्त कोशिकाएं बनाने के लिए मजबूर करता है।"),
    ("Span 05 — Oxygen Efficiency", "जिससे फेफड़ों की ताकत, स्टैमिना और कोशिकाओं में ऊर्जा बनाने की क्षमता कई गुना बढ़ जाती है।"),
    ("Span 06 — Breath Hold Protocol", "रोज सुबह जमीन पर आराम से बैठकर सामान्य सांस छोड़ें और 20 से 30 सेकंड सांस रोकें। कभी भी पानी में या गाड़ी चलाते समय यह न करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल respiratory physiology awareness के लिए है और pulmonary treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (239, 68, 68)  # Crimson / Red for EPO and red blood cells
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0138 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Intermittent Hypoxia EPO RBC Oxygen Capacity",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0138_intermittent_hypoxia_epo','display_id':'REEL-0138','topic_hi':'Intermittent Hypoxia: सांस रोकने से RBC और EPO कैसे बढ़ते हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
