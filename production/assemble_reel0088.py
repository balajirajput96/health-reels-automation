...
SPANS = [
    ("Span 01 — Hook", "क्या आपने ध्यान दिया है कि किसी मुश्किल समय में अपनों का हाथ थामते ही डर और दर्द तुरंत कम क्यों लगने लगता है?"),
    ("Span 02 — Social Baseline", "Social Neuroscience में James Coan की Social Baseline Theory कहती है कि हमारा दिमाग अपनों के साथ रहने को ही अपनी स्वाभाविक अवस्था मानता है।"),
    ("Span 03 — Hand-Holding Study", "fMRI स्टडीज में पाया गया कि खतरे के समय साथी का हाथ पकड़ने से दिमाग के Hypothalamus में स्ट्रेस रिस्पॉन्स आधा हो जाता है।"),
    ("Span 04 — Metabolic Load Sharing", "दिमाग हिसाब लगाता है कि अकेले में किसी समस्या का सामना करना बहुत थकाऊ है, जबकि अपनों के साथ वही चुनौती छोटी और आसान हो जाती है।"),
    ("Span 05 — Neural Co-Regulation", "इसे Co-Regulation कहते हैं—जहाँ दो लोगों का नर्वस सिस्टम एक-दूसरे के संपर्क और नज़रें मिलाने से शांत होता है।"),
    ("Span 06 — Connection Power", "इसलिए अकेलापन दिमाग पर भारी पड़ता है, जबकि सच्चे रिश्ते शरीर के ऊर्जा खर्च और तनाव को कम करते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social neuroscience awareness के लिए है और clinical psychological therapy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (236, 72, 153)  # Pink for connection/social baseline
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0088 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Social Baseline Theory Neural Co-Regulation Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0088_social_baseline_co_regulation','display_id':'REEL-0088','topic_hi':'Social Baseline Theory: अपनों के पास होने से दिमाग का तनाव तुरंत कम क्यों हो जाता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
