...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि जब टीचर को झूठ बोला गया कि कुछ साधारण बच्चे जन्मजात जीनियस हैं, तो 1 साल में उन बच्चों का असली आईक्यू 15 अंक कैसे बढ़ गया?"),
    ("Span 02 — Harvard Discovery", "हार्वर्ड यूनिवर्सिटी के वैज्ञानिक Robert Rosenthal ने इसे The Pygmalion Effect कहा।"),
    ("Span 03 — The Secret Signals", "जब कोई शिक्षक या बॉस आप पर भरोसा करता है, तो वह अनजाने में आपको ज्यादा वक्त, गहरी सीख और गर्मजोशी भरा प्रोत्साहन देने लगता है।"),
    ("Span 04 — Neural Confidence Bloom", "इस भरोसे से बच्चे के दिमाग में डोपामिन बढ़ता है और असफलता का डर खत्म होकर सीखने की रफ्तार दोगुनी हो जाती है।"),
    ("Span 05 — The Golem Warning", "इसके विपरीत, जब किसी को लगातार नाकारा या कमजोर कहा जाता है, तो उसका दिमाग सचमुच सिकुड़कर उम्मीद छोड़ देता है।"),
    ("Span 06 — Pygmalion Habit", "अपने बच्चों, दोस्तों और टीम को उनकी कमियों से नहीं, उनकी सबसे बड़ी संभावनाओं के नजरिए से देखें और उन पर भरोसा जताएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल educational social psychology awareness के लिए है और clinical child behavioral diagnosis का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (59, 130, 246)  # Bright blue for Pygmalion expectation & intellectual bloom
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0146 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"The Pygmalion Effect Expectancy Bloom Rosenthal",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0146_pygmalion_effect_expectancy','display_id':'REEL-0146','topic_hi':'The Pygmalion Effect: अटूट भरोसे से दिमाग सचमुच जीनियस कैसे बनता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
