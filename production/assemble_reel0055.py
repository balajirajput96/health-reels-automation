...
WORK = ROOT / 'work' / 'reel_0055'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0055_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0055_intrinsic_motivation_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब किसी शौक के लिए पैसे मिलने लगते हैं, तो कई बार उसमें पहले जैसा मज़ा और लगन क्यों खत्म हो जाती है?"),
    ("Span 02 — The Overjustification Effect", "Psychology में इसे 'Overjustification Effect' कहते हैं—बाहरी इनाम कई बार अंदरूनी लगन को दबा देते हैं।"),
    ("Span 03 — Self-Determination Theory", "वैज्ञानिक Edward Deci और Richard Ryan ने 'Self-Determination Theory' में बताया कि सच्ची प्रेरणा तीन बुनियादी जरूरतों से आती है।"),
    ("Span 04 — Pillar 1: Autonomy", "पहला है 'Autonomy' (स्वायत्तता)—यह महसूस होना कि आप अपनी मर्जी और पसंद से काम कर रहे हैं, किसी दबाव में नहीं।"),
    ("Span 05 — Pillar 2: Competence", "दूसरा है 'Competence' (सक्षमता)—रोज़ नए कौशल सीखना, प्रगति देखना और काम में महारत हासिल करना।"),
    ("Span 06 — Pillar 3: Relatedness", "तीसरा है 'Relatedness' (जुड़ाव)—दूसरों के साथ गहरा जुड़ाव महसूस करना और अपने काम को एक बड़े उद्देश्य से जोड़ना।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल motivational psychology awareness के लिए है और career counseling या medical therapy का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(16, 185, 129))  # Emerald Motivation accent bar
    ...
    draw.text((40, 90), f"REEL-0055 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Motivational Psychology & Self-Determination Theory Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0055_intrinsic_motivation_and_self_determination',
        'display_id': 'REEL-0055',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0055',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Intrinsic Motivation: असली प्रेरणा और खुशी के 3 मनोवैज्ञानिक स्तंभ',
        'topic_key': 'intrinsic_motivation_self_determination_theory',
        'pillar': 'mental_health',
        'evidence_class': 'motivational_psychology_and_self_determination_theory',
