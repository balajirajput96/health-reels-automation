...
WORK = ROOT / 'work' / 'reel_0078'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0078_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0078_decision_fatigue_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी गौर किया है कि पूरे दिन काम करने के बाद शाम को आप अक्सर अनहेल्दी जंक फूड या फालतू खरीदारी के शिकार क्यों हो जाते हैं?"),
    ("Span 02 — What Is Decision Fatigue", "Behavioral Science में इसे 'Decision Fatigue' कहते हैं—हमारा दिमाग हर छोटे-बड़े फैसले के साथ अपनी निर्णय लेने की ऊर्जा खोता जाता है।"),
    ("Span 03 — The Famous Judicial Study", "एक मशहूर रिसर्च में देखा गया कि जज भी दोपहर के खाने से पहले के समय में सबसे ज़्यादा सख्त फैसले लेते थे, क्योंकि उनका दिमाग थक चुका था।"),
    ("Span 04 — Two Brain Reactions To Exhaustion", "जब दिमाग थक जाता है, तो वह दो रास्ते चुनता है: या तो बिना सोचे तुरंत फैसला (Impulsive Choice) लेता है, या फैसले को टाल देता है।"),
    ("Span 05 — The Prefrontal Energy Budget", "हमारे 'Prefrontal Cortex' की क्षमता सीमित होती है—सुबह से शाम तक सैकड़ों विकल्प देखने से यह मानसिक रूप से खाली हो जाता है।"),
    ("Span 06 — How To Protect Your Willpower", "समाधान यह है कि सुबह के कपड़े और खाने जैसे छोटे फैसलों को पहले से तय कर लें ताकि बड़े और महत्वपूर्ण फैसलों के लिए दिमाग तरोताजा रहे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल decision ergonomics awareness के लिए है और clinical executive dysfunction diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(245, 158, 11))  # Amber Decision Fatigue accent bar
    ...
    draw.text((40, 90), f"REEL-0078 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Behavioral Decision Science & Executive Depletion Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0078_decision_fatigue_executive_depletion',
        'display_id': 'REEL-0078',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0078',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Decision Fatigue: शाम होते-होते हम गलत और जल्दबाजी वाले फैसले क्यों लेने लगते हैं?',
        'topic_key': 'decision_fatigue_executive_depletion_willpower',
        'pillar': 'mental_health',
        'evidence_class': 'behavioral_decision_science_and_cognitive_ergonomics',
