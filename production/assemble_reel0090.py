...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि दो समझदार लोग एक ही खबर या बहस को देखकर भी बिल्कुल अलग-अलग नतीजों पर 100% सही होने का दावा क्यों करते हैं?"),
    ("Span 02 — Confirmation Bias", "इसकी वजह है Confirmation Bias—दिमाग केवल उन्हीं तथ्यों को चुनता और याद रखता है जो उसकी पुरानी मान्यताओं से मेल खाते हैं।"),
    ("Span 03 — Motivated Reasoning", "Dan Kahan की रिसर्च के अनुसार, Motivated Reasoning की वजह से हमारी बुद्धि सच खोजने की बजाय अपनी पहचान और समूह को सही साबित करने में लग जाती है।"),
    ("Span 04 — Dopamine Reward", "जब हमें अपनी राय का समर्थन करने वाली कोई बात मिलती है, तो दिमाग Dopamine रिलीज करता है, जिससे सही होने का अहसास अच्छा लगता है।"),
    ("Span 05 — Backfire Effect", "जब सामने उल्टे तथ्य रखे जाते हैं, तो दिमाग का रक्षात्मक तंत्र एक्टिव हो जाता है और हम अपनी पुरानी बात पर और अड़ जाते हैं।"),
    ("Span 06 — Intellectual Humility", "सच्ची समझदारी का नियम है Intellectual Humility—खुद से सवाल पूछें कि ऐसा कौन सा तथ्य होगा जो मुझे गलत साबित कर सकता है?"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive bias psychology public awareness के लिए है और clinical cognitive assessment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (14, 165, 233)  # Sky blue for reasoning/biases
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0090 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Confirmation Bias Motivated Reasoning Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0090_confirmation_bias_motivated_reasoning','display_id':'REEL-0090','topic_hi':'Confirmation Bias: दिमाग सिर्फ वही क्यों देखना चाहता है जो वह पहले से मानता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
