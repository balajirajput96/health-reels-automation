...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि फाइबर सिर्फ पेट साफ करने के लिए नहीं है, बल्कि यह आपकी आंतों में मौजूद खरबों गुड बैक्टीरिया का सबसे पसंदीदा भोजन है?"),
    ("Span 02 — Prebiotic Journey", "Harvard Health के अनुसार, इंसान के एंजाइम्स फाइबर को पचा नहीं सकते, इसलिए यह सीधे बड़ी आंत तक बिना टूटे पहुंचता है।"),
    ("Span 03 — SCFA Factory", "वहां मौजूद गट बैक्टीरिया इस फाइबर को फरमेंट करके Short-Chain Fatty Acids, विशेषकर Butyrate में बदल देते हैं।"),
    ("Span 04 — Gut Barrier Shield", "यह Butyrate आंतों की अंदरूनी दीवार को मजबूत करता है और पूरे शरीर में सूजन और इन्फ्लेमेशन को कम करने में मदद करता है।"),
    ("Span 05 — Blood Sugar Gel", "साथ ही, घुलनशील फाइबर पेट में एक जैल बनाता है, जो ग्लूकोज के अवशोषण को धीमा कर इंसुलिन स्पाइक्स को रोकता है।"),
    ("Span 06 — Diversity Rule", "अपनी थाली में साबुत अनाज, दालें, फल और हरी सब्जियों की विविधता बढ़ाएं ताकि माइक्रोबायोम को भरपूर पोषण मिले।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल nutritional digestive health education के लिए है और irritable bowel syndrome या gastrointestinal disorders के क्लीनिकल इलाज का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (34, 197, 94)  # Vibrant leaf green for dietary fiber & gut health
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0166 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Dietary Fiber Microbiome Butyrate WHO Harvard",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0166_dietary_fiber_microbiome','display_id':'REEL-0166','topic_hi':'Dietary Fiber: आपकी आंतों के बैक्टीरिया के लिए जादुई भोजन क्यों है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
