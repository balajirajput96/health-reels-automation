...
WORK = ROOT / 'work' / 'reel_0074'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0074_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0074_prospection_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि दुनिया में सिर्फ इंसान ही ऐसे जीव हैं जो उन घटनाओं की पहले से कल्पना कर सकते हैं जो अभी घटी ही नहीं हैं?"),
    ("Span 02 — Episodic Future Thinking", "Neuroscience में इसे 'Episodic Future Thinking' या 'Prospection' कहते हैं—हमारा दिमाग एक मानसिक टाइम मशीन की तरह काम करता है।"),
    ("Span 03 — Memory Meets Imagination", "हमारा हिप्पोकैम्पस पुरानी यादों के टुकड़ों को जोड़कर भविष्य के नए-नए दृश्यों और स्थितियों का एक वास्तविक सिमुलेशन तैयार करता है।"),
    ("Span 04 — Reducing Impulsive Decisions", "जब आप अपने भविष्य के खुद के रूप को साफ-साफ देखते हैं, तो दिमाग का तुरंत लालच में आने वाला आवेग (Impulsive Discounting) घट जाता है।"),
    ("Span 05 — Empathy For Your Future Self", "ज्यादातर लोग अपने 'भविष्य के रूप' को एक अजनबी समझते हैं, जिससे वे आज गलत आदतें और आलस चुन लेते हैं।"),
    ("Span 06 — Mental Contrasting", "समाधान यह है कि केवल सपने न देखें—भविष्य के लक्ष्य के साथ-साथ आज आने वाली बाधाओं की भी कल्पना करें ताकि दिमाग तैयार रहे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive decision neuroscience awareness के लिए है और financial planning advice का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(14, 165, 233))  # Sky Blue Prospection accent bar
    ...
    draw.text((40, 90), f"REEL-0074 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Prospection & Episodic Simulation Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0074_episodic_future_thinking_prospection',
        'display_id': 'REEL-0074',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0074',
        'status': 'rendered_local_complete_verified',
        'topic_hi': "Prospection: भविष्य की कल्पना करने वाला हमारे दिमाग का 'टाइम मशीन'",
        'topic_key': 'episodic_future_thinking_prospection_simulation',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_decision_neuroscience_and_prospection',
