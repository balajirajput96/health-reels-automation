...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी ऐसे लोगों को देखा है जो किसी विषय पर सिर्फ एक वीडियो देखकर खुद को 20 साल के अनुभवी डॉक्टर या साइंटिस्ट से भी ज्यादा समझदार मानने लगते हैं?"),
    ("Span 02 — Cornell University Study", "मनोवैज्ञानिक David Dunning और Justin Kruger ने इसे 'Dunning-Kruger Effect' का नाम दिया है।"),
    ("Span 03 — The 'Mount Stupid' Peak", "जब किसी विषय की थोड़ी सी जानकारी मिलती है, तो दिमाग में अति-आत्मविश्वास (False Confidence) का गुब्बारा फूल जाता है।"),
    ("Span 04 — Metacognitive Blindspot", "कम ज्ञान होने के कारण इंसान को यह भी समझ नहीं आता कि उसे क्या नहीं आता और वह कितनी गलतियां कर रहा है।"),
    ("Span 05 — The Valley of Humility", "लेकिन जब कोई सच में गहराई से सीखता है, तो उसे समझ आता है कि विषय कितना अथाह है, और उसका अहंकार शांत हो जाता है।"),
    ("Span 06 — Intellectual Humility", "सच्चा ज्ञानी वही है जो यह स्वीकार करने की हिम्मत रखे कि 'मैं अभी बहुत कुछ नहीं जानता'।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive psychology awareness के लिए है और clinical intelligence testing का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.17, 0.14, 0.15, 0.15, 0.15, 0.12, 0.12]
ACCENT = (168, 85, 247)  # Violet / Purple for deep psychology & cognitive humility
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0133 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Dunning-Kruger Effect • Metacognition • Humility",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0133_dunning_kruger','display_id':'REEL-0133','topic_hi':'Dunning-Kruger Effect: कम जानकारी वाले खुद को ज्ञानी क्यों समझते हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
