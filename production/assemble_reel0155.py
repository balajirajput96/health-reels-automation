...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि नहाने के अंत में सिर्फ 60 सेकंड ठंडा पानी डालने से बीमार पड़ने का खतरा लगभग 30% तक कम हो जाता है?"),
    ("Span 02 — Amsterdam Trial", "एम्सटर्डम मेडिकल सेंटर के वैज्ञानिकों ने 3,000 से ज्यादा लोगों पर रिसर्च करके यह साबित किया है।"),
    ("Span 03 — 29% Sickness Drop", "स्टडी में पाया गया कि जिन लोगों ने रोज सिर्फ 30 से 60 सेकंड ठंडा पानी डाला, उनकी बीमारी की छुट्टियां 29% घट गईं।"),
    ("Span 04 — White Blood Cell Surge", "ठंडे पानी का झटका लगते ही शरीर की रोग प्रतिरोधक क्षमता तुरंत सक्रिय होकर वायरस से लड़ने के लिए तैयार हो जाती है।"),
    ("Span 05 — Norepinephrine Boost", "साथ ही, दिमाग में नॉरपेनेफ्रिन हार्मोन बढ़ता है, जिससे दिनभर जबरदस्त चुस्ती और ऊर्जा बनी रहती है।"),
    ("Span 06 — 30-Sec Habit", "गर्म पानी से नहाने के बाद, आखिरी 30 सेकंड के लिए नल को ठंडा करें और गर्दन और पीठ पर पानी गिरने दें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल thermal immune physiology awareness के लिए है और acute infection or cardiovascular condition medical treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (2, 132, 199)  # Deep ice blue for cold shower immune priming
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0155 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Cold Showers Immune Priming Leukocytes Amsterdam",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0155_cold_showers_immune_buijze','display_id':'REEL-0155','topic_hi':'Cold Showers: आखिरी 60 सेकंड ठंडा पानी डालने से बीमारियां 30% कम कैसे होती हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
