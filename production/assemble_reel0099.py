...
SPANS = [
    ("Span 01 — Hook", "क्या आपने ध्यान दिया है कि 2+2 का जवाब आप तुरंत बिना सोचे दे देते हैं, लेकिन 17x24 का जवाब निकालने के लिए रुककर सोचना पड़ता है?"),
    ("Span 02 — Kahneman Discovery", "Nobel Prize विजेता Daniel Kahneman ने Thinking, Fast and Slow में बताया कि दिमाग दो प्रणालियों System 1 और System 2 पर काम करता है।"),
    ("Span 03 — System 1 Fast", "System 1 तेज़, ऑटोमैटिक और भावनात्मक है, जो दिनभर के 95% छोटे-मोटे फैसले बिना ऊर्जा खर्च किए लेता है।"),
    ("Span 04 — System 1 Trap", "लेकिन System 1 शॉर्टकट्स पर चलता है, जिससे जल्दबाज़ी में गलतफहमियां, गुस्सा और गलत खरीदारी होती है।"),
    ("Span 05 — System 2 Slow", "System 2 धीमा, तार्किक और ऊर्जावान है, जो जटिल गणित, योजना और गंभीर फैसलों का विश्लेषण करता है।"),
    ("Span 06 — 10 Second Pause", "बड़े फैसले लेते समय 10 सेकंड का ब्रेक लें ताकि System 1 की जल्दबाज़ी रुके और System 2 सही चुनाव कर सके।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल decision-making cognitive psychology awareness के लिए है और clinical cognitive assessment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (245, 158, 11)  # Amber for dual process thinking
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0099 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Dual Process Theory System 1 System 2 Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0099_dual_process_theory_kahneman','display_id':'REEL-0099','topic_hi':'Dual-Process Theory: System 1 और System 2—दिमाग गलत फैसले क्यों लेता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
