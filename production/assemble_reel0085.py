...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि कुछ तनाव आपको तेज़ और focused बनाता है, जबकि लगातार stress आपको भुलक्कड़, थका हुआ और बीमार क्यों बना देता है?"),
    ("Span 02 — HPA Cascade", "किसी भी तनाव के जवाब में हमारा 'HPA Axis' सक्रिय होता है—Hypothalamus से CRH, Pituitary से ACTH, और Adrenal Glands से Cortisol और Adrenaline निकलता है।"),
    ("Span 03 — Acute Stress Benefits", "थोड़े समय के लिए निकलने वाला Cortisol हमारी ध्यान देने की क्षमता, immune response, और महत्वपूर्ण घटनाओं की याददाश्त को बेहतर बनाता है।"),
    ("Span 04 — Chronic Stress Damage", "लेकिन जब Cortisol लगातार बना रहता है, तो यह Hippocampus में BDNF protein को दबाता है और इसके आकार को 8% तक कम कर देता है, जिससे याददाश्त और सीखने की क्षमता घटती है।"),
    ("Span 05 — Amygdala Hyperactivation", "Chronic Stress से Amygdala अति-सक्रिय हो जाता है, जिससे हर छोटी-छोटी बात में खतरा दिखने लगता है और निर्णय लेने की क्षमता प्रभावित होती है।"),
    ("Span 06 — Recovery as Protection", "इससे बचाव के लिए नियमित exercise, 7 से 9 घंटे की गहरी नींद, और मज़बूत सामाजिक संबंध Cortisol स्तर को घटाते हैं और दिमाग की रक्षा करते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल stress neuroscience public awareness के लिए है और clinical anxiety disorder या PTSD diagnosis का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (239, 68, 68)  # Red for stress/danger
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0085 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"HPA Axis Cortisol Stress Neuroscience Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0085_stress_cortisol_hpa_axis','display_id':'REEL-0085','topic_hi':'Chronic Stress: लगातार तनाव दिमाग के Hippocampus को कैसे सिकोड़ता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
