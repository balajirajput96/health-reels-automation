...
WORK = ROOT / 'work' / 'reel_0046'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0046_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0046_base_rate_reasoning_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "अगर किसी बहुत दुर्लभ बीमारी का टेस्ट 99% सही है और रिपोर्ट positive आ जाए, तो क्या बीमार होने का खतरा सच में 99% है?"),
    ("Span 02 — Prior Base Rate", "Statistical science कहती है—पूरी तस्वीर समझने के लिए 'base rate' यानी समाज में उस बीमारी की बुनियादी दर जानना जरूरी है।"),
    ("Span 03 — False Alarm Balance", "जब कोई घटना 10,000 में से सिर्फ 1 व्यक्ति को होती है, तो टेस्ट का 1% false alarm भी असली पीड़ितों से ज़्यादा हो सकता है।"),
    ("Span 04 — Natural Frequencies", "जटिल प्रतिशत (percentages) के बजाय '10,000 में से 1' जैसे प्राकृतिक आंकड़ों (natural frequencies) में सोचने से भ्रम दूर होता है।"),
    ("Span 05 — Bayesian Reasoning", "दिमाग को किसी भी नए टेस्ट या संकेत को पुरानी बुनियादी संभावना (prior probability) के साथ मिलाकर देखना चाहिए।"),
    ("Span 06 — Practical Application", "किसी भी सनसनीखेज आंकड़े को देखकर घबराने के बजाय पूछें—'सामान्य रूप से यह घटना कितनी बार घटती है?'"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल statistical reasoning education के लिए है और medical diagnostic assessment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(13, 148, 136))  # Teal Base Rate accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(13, 148, 136), font=font_header)
    draw.text((40, 90), f"REEL-0046 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Decision Science & Bayesian Probability Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0046_base_rate_neglect_and_bayesian_reasoning',
        'display_id': 'REEL-0046',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0046',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Base Rate Neglect: आंकड़ों और संभावनाओं को सही समझने का विज्ञान',
        'topic_key': 'base_rate_neglect_bayesian_reasoning',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_decision_science_and_bayesian_reasoning',
