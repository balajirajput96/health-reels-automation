...
SPANS = [
    ("Span 01 — Hook", "अगर दोपहर में आपका दिमाग पूरी तरह थक जाए, तो बिना कॉफी पिए और बिना सोए केवल 20 मिनट में खुद को 100% रीचार्ज कैसे करें?"),
    ("Span 02 — What is NSDR?", "Stanford के Neuroscientist Andrew Huberman ने इसे Non-Sleep Deep Rest यानी NSDR कहा है, जो प्राचीन योग निद्रा का वैज्ञानिक रूप है।"),
    ("Span 03 — Theta Wave State", "इसमें आंखें बंद करके शरीर को शांत रखा जाता है, जिससे दिमाग की तरंगें Theta Waves में चली जाती हैं—यानी नींद और जागने के बीच की अवस्था।"),
    ("Span 04 — 65% Dopamine Reset", "ब्रेन स्कैन रिसर्च में देखा गया कि 20 मिनट का NSDR दिमाग के Striatum हिस्से में डोपामाइन के भंडार को 65% तक वापस भर देता है।"),
    ("Span 05 — Accelerated Learning", "पढ़ाई या नए काम के तुरंत बाद 15 मिनट का NSDR करने से दिमाग उस नई जानकारी को दुगुनी तेजी से याददाश्त में पक्का कर लेता है।"),
    ("Span 06 — 20-Min Daily Protocol", "दोपहर 1 से 4 बजे के बीच हेडफोन लगाकर 20 मिनट का गाइडेड NSDR ऑडियो सुनें—आप पूरी तरह तरोताजा महसूस करेंगे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल relaxation neurobiology awareness के लिए है और clinical sleep apnea disorder का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (56, 189, 248)  # Light sky blue for NSDR restorative state
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0119 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"NSDR Yoga Nidra 65% Dopamine Reset Theta Waves",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0119_nsdr_yoga_nidra','display_id':'REEL-0119','topic_hi':'NSDR: 20 मिनट में डोपामाइन और ऊर्जा 65% रीचार्ज कैसे करें?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
