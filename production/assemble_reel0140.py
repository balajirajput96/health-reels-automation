...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि पीठ या पेट के बल सोने के मुकाबले करवट लेकर सोने से दिमाग की रात में 25% ज्यादा गहरी सफाई होती है?"),
    ("Span 02 — Glymphatic System", "गहरी नींद में दिमाग का Glymphatic System एक्टिव हो जाता है, जो दिमाग की नसों को धोकर दिनभर का जहरीला प्रोटीन साफ करता है।"),
    ("Span 03 — MRI Brain Scan Proof", "यूनिवर्सिटी ऑफ रोचेस्टर के एमआरआई स्कैन में देखा गया कि करवट लेकर सोने पर सेरेब्रोस्पाइनल फ्लुइड दिमाग में सबसे आसानी से बहता है।"),
    ("Span 04 — 25% Waste Flush", "करवट की पोजीशन में खून की नलियां खुल जाती हैं और अल्जाइमर पैदा करने वाला Beta-Amyloid कचरा 25% तेजी से बाहर निकल जाता है।"),
    ("Span 05 — Restored Clarity", "यही कारण है कि करवट लेकर सोने वाले लोगों को सुबह उठने पर सिर में ताजगी और हल्कापन महसूस होता है।"),
    ("Span 06 — Side Sleeping Habit", "सोते समय दोनों घुटनों के बीच एक पतला तकिया रखें और हमेशा बाईं या दाईं करवट लेकर सोएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल sleep neurobiology awareness के लिए है और sleep apnea disorder treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (147, 51, 234)  # Deep Violet for glymphatic brain wash & deep sleep
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0140 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Lateral Sleep Glymphatic Wash 25% Waste Clearance",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0140_lateral_sleep_glymphatic','display_id':'REEL-0140','topic_hi':'Lateral Sleep: करवट लेकर सोने से दिमाग का कचरा 25% ज्यादा साफ कैसे होता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
