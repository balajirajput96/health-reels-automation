...
WORK = ROOT / 'work' / 'reel_0018'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0018_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0018_movement_snacks_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी 'movement snacks' यानी दिनभर में छोटे एक्टिविटी ब्रेक्स के बारे में सुना है?"),
    ("Span 02 — McMaster Findings", "Exercise physiology research दिखाती है कि दिन में कई बार brief movement bouts करने से fitness support हो सकती है।"),
    ("Span 03 — Practical Examples", "जैसे एक-दो मिनट के लिए सीढ़ियाँ चढ़ना, brisk walking या light stretching करना।"),
    ("Span 04 — Sedentary Interruption", "यह छोटे प्रयास prolonged sitting को break करने और circulation बेहतर करने में सहायक हो सकते हैं।"),
    ("Span 05 — Time Efficiency", "व्यस्त दिनचर्या में यह time-efficient तरीका movement consistency बनाए रखने में मदद कर सकता है।"),
    ("Span 06 — Personal Comfort", "हमेशा अपने fitness level और comfort range के अनुसार ही activity करें, कोई strain न लें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल general education के लिए है; नई workout शुरू करने से पहले doctor से consult करें।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(14, 165, 233))  # Sky Blue Activity accent bar
    ...
    draw.text((40, 90), f"REEL-0018 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "McMaster University & NIH Exercise Physiology", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0018_movement_snacks_throughout_the_day',
        'display_id': 'REEL-0018',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0018',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Movement Snacks: दिनभर में Short Physical Activity Bouts के फायदे',
        'topic_key': 'movement_snacks_throughout_the_day',
        'pillar': 'fitness',
        'evidence_class': 'mcmaster_university_and_nih_exercise_physiology',
