...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब कोई बहुत बड़ा टॉपर या कंपनी का बॉस मंच पर बोलते हुए अपनी कॉफी गिरा देता है, तो लोग उसे और ज्यादा पसंद क्यों करने लगते हैं?"),
    ("Span 02 — Pratfall Discovery", "सोशल साइकोलॉजी में इस जादू को The Pratfall Effect कहा जाता है।"),
    ("Span 03 — The Coffee Experiment", "वैज्ञानिक Elliot Aronson की रिसर्च में देखा गया कि जब किसी बहुत होशियार इंसान से कोई छोटी-मोटी बचकानी गलती होती है, तो लोगों के दिल में उसके लिए प्यार बढ़ जाता है।"),
    ("Span 04 — The Perfection Barrier", "बहुत ज्यादा परफेक्ट दिखने वाले लोगों से लोग डरते हैं या दूर भागते हैं क्योंकि वे अवास्तविक लगते हैं।"),
    ("Span 05 — Human Vulnerability", "लेकिन एक छोटी सी गलती साबित करती है कि वह भी एक आम इंसान है, जिससे उसके प्रति जलन खत्म होकर अपनापन आ जाता है।"),
    ("Span 06 — Authenticity Rule", "अपने काम में माहिर बनें, लेकिन कभी भी अपनी गलतियों को छुपाने या परफेक्ट बनने का नाटक न करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral psychology awareness के लिए है और social anxiety disorder treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (236, 72, 153)  # Rose for charisma & human relatability
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0139 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"The Pratfall Effect Likability Human Competence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0139_pratfall_effect','display_id':'REEL-0139','topic_hi':'The Pratfall Effect: काबिल लोगों की छोटी गलती उन्हें लोकप्रिय क्यों बनाती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
