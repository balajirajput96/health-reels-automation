...
SPANS = [
    ("Span 01 — Hook", "क्या आपको भी लगता है कि बचपन के बाद दिमाग की नई कोशिकाएं कभी नहीं बन सकतीं? साइंस ने इस पुरानी सोच को गलत साबित कर दिया है।"),
    ("Span 02 — Salk Institute Discovery", "Salk Institute के वैज्ञानिकों ने साबित किया है कि एक वयस्क दिमाग में भी हर दिन लगभग 700 नए न्यूरॉन्स पैदा होते हैं।"),
    ("Span 03 — BDNF: Brain Fertilizer", "इन नई कोशिकाओं को जिंदा रखने और बड़ा करने के लिए दिमाग में 'BDNF' नाम का प्रोटीन फर्टिलाइजर की तरह काम करता है।"),
    ("Span 04 — Aerobic Cardio Surge", "दौड़ने या कार्डियो करने से मांसपेशियों से खास सिग्नल्स निकलते हैं जो दिमाग के याददाश्त वाले हिस्से में BDNF की बाढ़ ला देते हैं।"),
    ("Span 05 — Intermittent Fasting", "14 से 16 घंटे का उपवास दिमाग की स्टेम सेल्स को सक्रिय करके नए न्यूरॉन्स बनाने में मदद करता है।"),
    ("Span 06 — Learn Something Difficult", "नए न्यूरॉन्स तभी दिमाग से जुड़ते हैं जब आप कोई नया हुनर, भाषा या कठिन स्किल सीखते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल neuroplasticity science awareness के लिए है और neurological disorder treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.17, 0.14, 0.15, 0.15, 0.15, 0.12, 0.12]
ACCENT = (16, 185, 129)  # Emerald green for neurogenesis & cognitive vitality
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0135 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Adult Neurogenesis • BDNF • Brain Cells • Fasting",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0135_adult_neurogenesis','display_id':'REEL-0135','topic_hi':'Adult Neurogenesis: क्या दिमाग में नई कोशिकाएं बनाई जा सकती हैं?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
