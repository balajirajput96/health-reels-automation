...
SPANS = [
    ("Span 01 — Hook", "क्या आप भी सिनेमा हॉल में कोई बेकार फिल्म सिर्फ इसलिए झेलते रहते हैं क्योंकि आपने 300 रुपये का टिकट खरीदा था? तो आप अपना पैसा और वक्त दोनों गवां रहे हैं!"),
    ("Span 02 — Sunk Cost Discovery", "बिहेवियरल इकोनॉमिक्स में इसे The Sunk Cost Fallacy कहते हैं।"),
    ("Span 03 — Loss Aversion Trap", "नोबेल पुरस्कार विजेता Richard Thaler के अनुसार, हमारा दिमाग बीती हुई लागत को खोने के डर से गलत फैसलों में और ज्यादा समय बर्बाद करता रहता है।"),
    ("Span 04 — Opportunity Cost Stolen", "जो 300 रुपये आपने खर्च कर दिए, वे तो कभी वापस नहीं आएंगे—लेकिन अपने 3 घंटे बचाकर आप कुछ नया और बेहतर कर सकते थे।"),
    ("Span 05 — Dead Project Hazard", "यही गलती लोग डूबते हुए बिजनेस, खराब करियर और गलत रिश्तों में करते हैं।"),
    ("Span 06 — Clean Slate Rule", "जब भी फंसे हों, खुद से पूछें: अगर आज तक इस काम में एक रुपया भी न लगा होता, तो क्या मैं इसे आज शुरू करता? अगर जवाब ना है, तो तुरंत छोड़ दें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral decision-making psychology awareness के लिए है और certified financial investment or legal advice का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (225, 29, 72)  # Rose / Crimson for sunk cost fallacy & cutting losses
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0158 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"The Sunk Cost Fallacy Loss Aversion Richard Thaler",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0158_sunk_cost_fallacy_thaler','display_id':'REEL-0158','topic_hi':'Sunk Cost Fallacy: खराब फिल्म में बैठकर समय बर्बाद करना मूर्खता क्यों है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
