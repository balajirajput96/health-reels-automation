...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि 30 मिनट की तेज़ पैदल चाल या दौड़ आपके दिमाग में नए न्यूरॉन्स उगाने का सबसे ताकतवर ज़रिया है?"),
    ("Span 02 — What is BDNF", "Neuroscience में BDNF को दिमाग का Miracle-Gro प्रोटीन माना जाता है।"),
    ("Span 03 — Muscle-to-Brain Signal", "जब हम कसरत करते हैं, तो मांसपेशियां Irisin और लाक्टेट रिलीज़ करती हैं, जो खून के रास्ते दिमाग में जाकर BDNF का बनना कई गुना बढ़ा देती हैं।"),
    ("Span 04 — Adult Neurogenesis", "BDNF दिमाग के याददाश्त वाले हिस्से Hippocampus में नए न्यूरॉन्स का निर्माण यानी Neurogenesis शुरू करता है।"),
    ("Span 05 — Synaptic Strengthening", "यह न्यूरॉन्स के बीच कनेक्शन मजबूत करता है, जिससे नई भाषाएं सीखना, ध्यान केंद्रित करना और फैसले लेना आसान हो जाता है।"),
    ("Span 06 — Mood & Protection", "दैनिक वर्कआउट दिमाग को डिमेंशिया और तनाव से होने वाले नुकसान से बचाकर हमेशा युवा रखता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल exercise neuroscience public awareness के लिए है और medical neurological treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (16, 185, 129)  # Emerald green for exercise/BDNF growth
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0098 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"BDNF Exercise Hippocampal Neurogenesis Evidence",fill=(148,163,184),font=fb)
