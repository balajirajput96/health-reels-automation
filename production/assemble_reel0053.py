...
WORK = ROOT / 'work' / 'reel_0053'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0053_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0053_task_switching_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपको लगता है कि आप एक साथ काम करते हुए ईमेल और मैसेज का जवाब देकर समय बचा रहे हैं?"),
    ("Span 02 — The Multitasking Myth", "Cognitive science साबित करती है कि इंसान का दिमाग एक साथ दो जटिल काम नहीं कर सकता; वह बस तेज़ी से टास्क बदलता है।"),
    ("Span 03 — Switch Cost Penalty", "इसे 'Task Switching Cost' कहते हैं—हर बार काम बदलने पर रिएक्शन टाइम धीमा हो जाता है और गलतियों की संभावना दोगुनी हो जाती है।"),
    ("Span 04 — Prefrontal Reconfiguration", "दिमाग को पहले काम के नियम भूलकर नए काम के नियम लोड करने में भारी न्यूरल ऊर्जा और समय खर्च करना पड़ता है।"),
    ("Span 05 — Attention Residue", "यूनिवर्सिटी रिसर्च दर्शाती है कि पुराने काम के बचे हुए विचार (attention residue) नए काम के फोकस को कमजोर करते हैं।"),
    ("Span 06 — Monotasking Blocks", "मल्टीटास्किंग छोड़कर 30 से 45 मिनट के लिए केवल एक काम पर पूरा ध्यान लगाने से काम की गुणवत्ता 40% तक सुधरती है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive ergonomics education के लिए है और clinical productivity counseling का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(234, 88, 12))  # Orange Switch Cost accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(234, 88, 12), font=font_header)
    draw.text((40, 90), f"REEL-0053 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Ergonomics & Task Switching Costs Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0053_task_switching_costs_and_multitasking',
        'display_id': 'REEL-0053',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0053',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Task Switching: मल्टीटास्किंग के मानसिक टैक्स और थकान का विज्ञान',
        'topic_key': 'task_switching_costs_multitasking',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_ergonomics_and_executive_control',
