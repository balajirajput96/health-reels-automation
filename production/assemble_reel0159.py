...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि अगर आप वही रोटी और दाल दोपहर के बजाय रात 10 बजे खाएं, तो खून में शुगर का स्पाइक 3 गुना ज्यादा खतरनाक होता है?"),
    ("Span 02 — Salk Institute Discovery", "साल्क इंस्टीट्यूट के वैज्ञानिक Dr. Satchin Panda के अनुसार, हमारे लिवर और आंतों में भी एक घड़ी होती है जो सूरज के साथ चलती है।"),
    ("Span 03 — Melatonin vs Insulin", "रात में जैसे ही नींद का हार्मोन मेलाटोनिन निकलता है, वह पैंक्रियाज को इंसुलिन बनाने से रोक देता है ताकि शरीर आराम कर सके।"),
    ("Span 04 — Midnight Sugar Trap", "ऐसे में जब आप देर रात खाना खाते हैं, तो शुगर को पचाने वाला इंसुलिन मौजूद नहीं होता और वह खाना सीधे चर्बी में बदल जाता है।"),
    ("Span 05 — Early Dinner Advantage", "वही खाना शाम 7 बजे खाने पर शरीर उसे तुरंत ऊर्जा में बदल देता है।"),
    ("Span 06 — Early Kitchen Rule", "सोने से कम से कम 3 घंटे पहले अपना रात का खाना खत्म कर लें और लिवर को रातभर सफाई करने दें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल circadian metabolic biology awareness के लिए है और type 1 diabetes or metabolic disorder clinical treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (245, 158, 11)  # Warm sunset amber for early time-restricted feeding & solar circadian clocks
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0159 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Circadian Food Timing Satchin Panda Insulin",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0159_circadian_food_timing','display_id':'REEL-0159','topic_hi':'Circadian Fasting: रात 10 बजे खाना खाने से शुगर 3 गुना क्यों बढ़ती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
