...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि खुद को बेदम कर देने वाला वर्कआउट करने के बजाय हल्की गति से की गई एक्सरसाइज सेल्स के लिए ज्यादा ताकतवर होती है?"),
    ("Span 02 — What is Zone 2?", "Sports Medicine में इसे Zone 2 Cardio कहते हैं—यह वह गति है जहाँ शरीर ऊर्जा के लिए मुख्य रूप से फैट को जलाता है।"),
    ("Span 03 — Mitochondrial Biogenesis", "रिसर्च बताती है कि Zone 2 एक्सरसाइज PGC-1alpha जीन को एक्टिव करके कोशिकाओं में हजारों नए माइटोकॉन्ड्रिया बनाती है।"),
    ("Span 04 — Lactate Clearance", "स्वस्थ माइटोकॉन्ड्रिया शरीर में बनने वाले लैक्टिक एसिड को तुरंत ईंधन बनाकर जला देते हैं, जिससे थकान नहीं होती।"),
    ("Span 05 — The Talk Test", "Zone 2 पहचानने का सबसे आसान तरीका—आप व्यायाम करते हुए पूरे वाक्य में बात कर सकते हैं, लेकिन गाना नहीं गा सकते।"),
    ("Span 06 — 150-Min Weekly Goal", "हफ्ते में 3 से 4 दिन 40 मिनट की तेज़ वॉक या हल्की साइकिलिंग करने से आपकी उम्र और स्टैमिना दोनों बढ़ते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल exercise physiology awareness के लिए है और customized sports training का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (16, 185, 129)  # Emerald green for cardio / cellular energy
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0114 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Zone 2 Cardio Mitochondria PGC1alpha Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0114_zone2_mitochondria','display_id':'REEL-0114','topic_hi':'Zone 2 Cardio: हल्की एक्सरसाइज से सेल्स में नई ऊर्जा कैसे बनती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
