...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जो इंसान अच्छे कपड़े पहनता है और मीठा बोलता है, हमारा दिमाग उसे बिना सोचे-समझे ईमानदार और बुद्धिमान क्यों मान लेता है?"),
    ("Span 02 — Halo Discovery", "साइकोलॉजी में इसे The Halo Effect कहते हैं, जिसे 1920 में Edward Thorndike ने खोजा था।"),
    ("Span 03 — Cognitive Shortcut", "दिमाग एक अच्छी खूबी—जैसे सुंदर चेहरा या साफ पहनावा देखकर यह मान लेता है कि बाकी सारी खूबियां भी उस इंसान में अच्छी होंगी।"),
    ("Span 04 — Job Court Bias", "रिसर्च में देखा गया कि स्मार्ट दिखने वाले लोगों को इंटरव्यू में ज्यादा सैलरी मिलती है और अदालतों में भी कम सजा होती है।"),
    ("Span 05 — The Horns Warning", "इसके उलट, अगर कोई इंसान थोड़ा सा भी बिखरा हुआ दिखे, तो लोग उसकी असली प्रतिभा को भी नजरअंदाज कर देते हैं।"),
    ("Span 06 — Practical Wisdom", "किसी के बाहरी रूप और चमक-दमक से धोखा न खाएं, हमेशा इंसान के काम और फैसलों से उसकी परख करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social cognitive bias awareness के लिए है और legal testimony or recruitment HR policy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (245, 158, 11)  # Amber / Gold for the Halo effect glow
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0152 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"The Halo Effect Cognitive Spillover Thorndike",fill=(148,163,184),font=fb)
