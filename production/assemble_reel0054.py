...
WORK = ROOT / 'work' / 'reel_0054'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0054_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0054_theory_of_mind_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि हम बिना बोले भी यह कैसे भांप लेते हैं कि सामने वाला व्यक्ति क्या सोच रहा है?"),
    ("Span 02 — The Mentalizing Superpower", "Cognitive science में इसे 'Theory of Mind' कहते हैं—यह दूसरों के दृष्टिकोण, इरादों और भावनाओं को समझने की क्षमता है।"),
    ("Span 03 — Developmental Milestone", "बचपन में लगभग 4 साल की उम्र में दिमाग यह समझना शुरू करता है कि दूसरे लोगों की जानकारी और राय हमसे अलग हो सकती है।"),
    ("Span 04 — The Mentalizing Brain Circuit", "Neuroscience में Brain का TPJ (Temporoparietal Junction) और Prefrontal Cortex मिलकर दूसरों के नजरिए का मॉडल बनाते हैं।"),
    ("Span 05 — Cognitive Perspective Vs Empathy", "सहानुभूति (empathy) दूसरों का दर्द महसूस करना है, जबकि Theory of Mind उनके सोचने के तरीके को समझना (cognitive perspective) है।"),
    ("Span 06 — Resolving Misunderstandings", "किसी भी बहस में यह पूछना कि 'सामने वाले के पास क्या अलग जानकारी या नजरिया हो सकता है?', रिश्तों में तनाव कम करता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social cognitive neuroscience awareness के लिए है और clinical psychological assessment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(20, 184, 166))  # Teal Mentalizing accent bar
    ...
    draw.text((40, 90), f"REEL-0054 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Social Cognitive Neuroscience & Mentalizing Network Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0054_theory_of_mind_and_mentalizing_network',
        'display_id': 'REEL-0054',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0054',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Theory of Mind: दूसरों के विचारों और भावनाओं को समझने का Neuroscience',
        'topic_key': 'theory_of_mind_mentalizing_network',
        'pillar': 'mental_health',
        'evidence_class': 'social_cognitive_neuroscience_and_perspective_taking',
