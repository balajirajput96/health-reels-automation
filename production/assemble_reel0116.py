...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी अनुभव किया है कि कई घंटे कोई गेम खेलने के बाद जब आप आंखें बंद करते हैं, तो वही दृश्य हवा में तैरते हुए दिखाई देते हैं?"),
    ("Span 02 — Harvard Study", "Harvard Medical School के वैज्ञानिक Robert Stickgold ने इसे Tetris Effect कहा है।"),
    ("Span 03 — Cognitive Priming", "दिमाग जिस काम को बार-बार दोहराता है, वह दुनिया को देखने के लिए वैसा ही एक खास चश्मा बना लेता है।"),
    ("Span 04 — Negative Pattern Trap", "अगर आप दिनभर गलतियां, कमियां और तनाव ढूंढते रहेंगे, तो दिमाग अपने आप हर रिश्ते और काम में सिर्फ कमियां ही देखना शुरू कर देगा।"),
    ("Span 05 — Positive Rewiring", "लेकिन अगर आप रोज जानबूझकर 3 अच्छी चीजें ढूंढने का अभ्यास करें, तो दिमाग हर मुश्किल में नए अवसर तलाशने के लिए रीवायर हो जाता है।"),
    ("Span 06 — Opportunity Habit", "रात को सोने से पहले दिन की 3 सकारात्मक बातें लिखें—आपका दिमाग रातभर उन्हीं पैटर्न को पक्का करेगा।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive neuroplasticity awareness के लिए है और clinical psychological therapy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (168, 85, 247)  # Purple for cognitive patterns / priming
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0116 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Tetris Effect Cognitive Priming Mindset Rewiring",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0116_tetris_effect_priming','display_id':'REEL-0116','topic_hi':'Tetris Effect: दिमाग दिनभर जो देखता है, वही पैटर्न क्यों दोहराता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
