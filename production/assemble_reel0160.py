...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि सिनेमा हॉल में पॉपकॉर्न का छोटा साइज 100, मीडियम 180 और बड़ा 200 रुपये का क्यों होता है? यह कोई इत्तेफाक नहीं, एक दिमागी जाल है!"),
    ("Span 02 — Decoy Discovery", "बिहेवियरल साइकोलॉजिस्ट Dan Ariely ने इसे The Decoy Effect कहा है।"),
    ("Span 03 — The Asymmetric Trap", "यहाँ 180 रुपये वाला मीडियम पॉपकॉर्न सिर्फ एक चारा है—ताकि आपको लगे कि सिर्फ 20 रुपये और देकर सबसे बड़ा टब लेना बहुत समझदारी है।"),
    ("Span 04 — The 84% Shift", "रिसर्च में देखा गया कि बिना इस चारे के लोग सबसे सस्ता 100 रुपये वाला पॉपकॉर्न लेते, लेकिन चारे के आते ही 84% लोग सबसे महंगा 200 रुपये वाला खरीद लेते हैं।"),
    ("Span 05 — Comparative Trick", "हमारा दिमाग किसी चीज की असली कीमत नहीं समझ पाता, वह सिर्फ तुलना करके फैसला लेता है।"),
    ("Span 06 — Smart Buyer Rule", "खरीदारी करते वक्त बीच वाले विकल्प को नजरअंदाज करें और सोचें कि आपको सचमुच कितनी जरूरत है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral economics pricing psychology awareness के लिए है और commercial consumer disputes or retail policy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (234, 179, 8)  # Golden popcorn yellow for the decoy effect & pricing architecture
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0160 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"The Decoy Effect Asymmetric Dominance Dan Ariely",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0160_decoy_effect_pricing','display_id':'REEL-0160','topic_hi':'The Decoy Effect: पॉपकॉर्न का बीच वाला साइज बड़ा टब क्यों खरीदवाता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
