...
SPANS = [
    ("Span 01 — Hook", "क्या आपके साथ कभी ऐसा हुआ है कि किसी रेस्टोरेंट के 10 पेज के मेन्यू को देखकर आपका दिमाग थक गया हो और आप कुछ भी तय न कर पाए हों?"),
    ("Span 02 — Jam Experiment", "Stanford की रिसर्च में जब लोगों को 24 तरह के जैम दिखाए गए तो केवल 3% ने खरीदा, लेकिन जब सिर्फ 6 जैम दिखाए गए तो 30% लोगों ने खरीदा।"),
    ("Span 03 — Paradox of Choice", "मनोवैज्ञानिक Barry Schwartz के अनुसार, इसे Paradox of Choice कहते हैं—जितने ज्यादा विकल्प होंगे, दिमाग उतना ही ज्यादा तनाव में रहेगा।"),
    ("Span 04 — Decision Fatigue", "सुबह क्या पहनें और क्या खाएं जैसे छोटे-छोटे फैसले भी दिमाग की सोचने वाली ऊर्जा यानी Prefrontal Cortex को खाली कर देते हैं।"),
    ("Span 05 — Minimalist Secret", "इसीलिए Steve Jobs और Mark Zuckerberg जैसे लीडर्स रोज एक ही तरह के कपड़े पहनते थे ताकि दिमाग बड़े फैसलों के लिए फ्रेश रहे।"),
    ("Span 06 — 3-Choice Habit", "अपने गैर-जरूरी फैसलों को ऑटोमेट करें और किसी भी चीज में हमेशा सिर्फ 3 बेस्ट ऑप्शन्स में से ही चुनाव करें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive decision science awareness के लिए है और clinical executive dysfunction का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (239, 68, 68)  # Red for choice overload / decision fatigue
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0127 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Paradox of Choice Decision Fatigue Jam Experiment",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0127_paradox_of_choice','display_id':'REEL-0127','topic_hi':'Paradox of Choice: ज्यादा विकल्प से दिमाग क्यों थक जाता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
