...
WORK = ROOT / 'work' / 'reel_0066'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0066_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0066_deep_work_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप भी दिन में लगातार 8 घंटे बिना रुके बैठकर काम करने की कोशिश करते हैं और फिर भी खुद को थका हुआ पाते हैं?"),
    ("Span 02 — Laboratory Vigilance Research", "Cognitive Science बताती है कि दिमाग का गहरा फोकस (Deep Work) कोई अंतहीन बैटरी नहीं है, बल्कि इसकी जैविक सीमाएं हैं।"),
    ("Span 03 — Attention Residue", "जब भी आप काम के बीच एक सेकंड के लिए फोन या ईमेल देखते हैं, तो दिमाग का एक हिस्सा वहीं अटका रह जाता है (Attention Residue)।"),
    ("Span 04 — 90-Minute Ultradian Cycles", "मानव मस्तिष्क स्वाभाविक रूप से 90 मिनट के चक्र (Ultradian Rhythms) में काम करता है—इसके बाद ध्यान और सटीकता घटने लगती है।"),
    ("Span 05 — The 4-Hour Daily Limit", "रिसर्च से पता चलता है कि दुनिया के टॉप प्रोफेशनल्स भी दिन में केवल 3 से 4 घंटे ही असली गहरा और कठिन मानसिक काम कर पाते हैं।"),
    ("Span 06 — Smart Scheduling Architecture", "इसलिए लंबे समय तक जबरदस्ती बैठने के बजाय 60 से 90 मिनट के बिना रुकावट वाले ब्लॉक्स में काम करें और फिर 15 मिनट का ब्रेक लें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive ergonomics awareness के लिए है और clinical workplace burnout diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(6, 182, 212))  # Cyan Deep Work accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(6, 182, 212), font=font_header)
    draw.text((40, 90), f"REEL-0066 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Ergonomics & Ultradian Focus Cycle Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0066_deep_work_and_cognitive_endurance',
        'display_id': 'REEL-0066',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0066',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Deep Work: गहरे फोकस (Concentration) के पीछे का असली Biological विज्ञान',
        'topic_key': 'deep_work_cognitive_endurance_ultradian',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_ergonomics_and_sustained_attention',
