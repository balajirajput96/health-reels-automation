...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि 30 की उम्र के बाद सिर्फ दूध पीने या कैल्शियम की गोली खाने से हड्डियां मजबूत नहीं होतीं—जब तक आप वजन नहीं उठाते?"),
    ("Span 02 — Wolff's Law Science", "मेडिकल साइंस में इसे Wolff's Law कहते हैं।"),
    ("Span 03 — Mechanical Signal", "जब आप वजन उठाते हैं या दंड-बैठक लगाते हैं, तो हड्डियों पर हल्का दबाव पड़ता है, जिससे हड्डियों के अंदर खास कोशिकाएं जाग जाती हैं।"),
    ("Span 04 — Calcium Deposition", "ये कोशिकाएं खून से कैल्शियम खींचकर हड्डियों को कंक्रीट की तरह घना और मजबूत बनाने लगती हैं।"),
    ("Span 05 — Sarcopenia Defense", "बिना वजन उठाए हड्डियां हर साल 1% कमजोर होने लगती हैं और ऑस्टियोपोरोसिस का खतरा बढ़ जाता है।"),
    ("Span 06 — Strength Habit", "हफ्ते में 3 दिन डंबल, पुश-अप्स या स्क्वैट्स करें ताकि आपकी हड्डियां 80 की उम्र में भी लोहे जैसी मजबूत रहें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल orthopedic biomechanics awareness के लिए है और osteoporosis clinical prescription or fracture physiotherapy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (20, 184, 166)  # Teal for bone mineral density & skeletal strength
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0157 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Wolffs Law Bone Mineral Density Strength Training",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0157_wolffs_law_bone_density','display_id':'REEL-0157','topic_hi':'Wolffs Law: 30 की उम्र के बाद हड्डियां मजबूत करने के लिए वजन उठाना क्यों जरूरी है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
