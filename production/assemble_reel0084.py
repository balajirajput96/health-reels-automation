...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि नई गाड़ी या बड़ी सफलता मिलने के एक-दो दिन बाद ही आप फिर से अगली चीज़ की तलाश में लग जाते हैं? इसकी वजह है आपका Dopamine System।"),
    ("Span 02 — Prediction Error", "Neuroscientist Wolfram Schultz ने खोजा कि Dopamine neurons असल इनाम मिलने पर नहीं, बल्कि इनाम की उम्मीद यानी Anticipation पर activate होते हैं।"),
    ("Span 03 — Wanting vs Liking", "Kent Berridge के अनुसार, Dopamine 'Wanting' यानी चाहत को drive करता है, जबकि खुशी की असली अनुभूति हमारे Opioid System से आती है।"),
    ("Span 04 — Anticipation Peak", "Dopamine का स्तर इनाम की अनिश्चितता और अपेक्षा के समय सबसे ज्यादा होता है, और इनाम मिलते ही अचानक गिर जाता है।"),
    ("Span 05 — Social Media Loop", "Social Media का slot machine जैसा unpredictable reward pattern इसी Dopamine Anticipation को लगातार activate रखता है और हमें scroll करने पर मजबूर करता है।"),
    ("Span 06 — Healthy Dopamine", "इसका समाधान है: छोटे-छोटे progress milestones, learning streaks, और meaningful achievements से frequent और earned Dopamine spikes बनाएं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल motivational neuroscience awareness के लिए है और clinical addiction या dopamine disorder diagnosis का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (245, 158, 11)  # Amber for dopamine/reward
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0084 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Dopamine Reward Prediction Error Scientific Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0084_dopamine_motivation_reward','display_id':'REEL-0084','topic_hi':'Dopamine & Motivation: इनाम से ज़्यादा मज़ेदार इनाम का इंतज़ार क्यों होता है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
