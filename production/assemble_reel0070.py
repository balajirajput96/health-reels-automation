...
WORK = ROOT / 'work' / 'reel_0070'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0070_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0070_self_determination_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब हम सिर्फ दूसरों के दबाव या इनाम के लिए काम करते हैं, तो कुछ ही दिनों में अंदर से पूरी तरह खाली क्यों महसूस होने लगता है?"),
    ("Span 02 — Deci And Ryan's SDT", "Motivation Science में इसे 'Self-Determination Theory' कहते हैं—इंसानी दिमाग को खुश और प्रेरित रहने के लिए 3 बुनियादी पोषक तत्वों की ज़रूरत होती है।"),
    ("Span 03 — Autonomy (स्वतंत्रता)", "पहला है 'Autonomy'—यह महसूस करना कि आप अपने जीवन के फैसले खुद ले रहे हैं, न कि किसी के दबाव में काम कर रहे हैं।"),
    ("Span 04 — Competence (सक्षमता)", "दूसरा है 'Competence'—यह अनुभव करना कि आप नई चीजें सीख रहे हैं, कौशल में बेहतर हो रहे हैं और चुनौतियों को पार कर सकते हैं।"),
    ("Span 05 — Relatedness (जुड़ाव)", "तीसरा है 'Relatedness'—यह महसूस करना कि लोग आपकी परवाह करते हैं और आप किसी अपने समुदाय का हिस्सा हैं।"),
    ("Span 06 — Autonomous Motivation", "जब ये तीनों जरूरतें पूरी होती हैं, तो इंसान के अंदर बिना किसी बाहरी लालच के एक अटूट, असली और टिकाऊ प्रेरणा पैदा होती है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल motivation science awareness के लिए है और clinical psychotherapy diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(99, 102, 241))  # Indigo Self-Determination accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(99, 102, 241), font=font_header)
    draw.text((40, 90), f"REEL-0070 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Humanistic Motivation Psychology & Self-Determination Theory Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0070_self_determination_theory_autonomy',
        'display_id': 'REEL-0070',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0070',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Self-Determination Theory: इंसान को हमेशा प्रेरित (Motivated) रखने वाले 3 पोषक तत्व',
        'topic_key': 'self_determination_theory_autonomy_competence_relatedness',
        'pillar': 'mental_health',
        'evidence_class': 'humanistic_motivation_psychology_and_self_determination',
