#!/usr/bin/env python3
"""Assemble Reel 0031 from quota-permitted topic-specific visuals.
...
CAPTIONS = ROOT / "production" / "captions" / "REEL-0031_hi-IN.srt"
RENDERED = ROOT / "production" / "rendered"
WORK = ROOT / "production" / "assembly_work" / "reel0031"
OUT = RENDERED / "REEL-0031_quota_limited_topic_fallback.mp4"
AUDIO_OUT = AUDIO / "REEL-0031_narration_hi-IN.wav"

SPAN_DURATIONS = [9.0, 8.4, 8.72, 7.0, 9.2, 10.88, 11.68]
NATIVE_CLIP = VIDEO / "reel0031_clip01_morning_meal_timing.mp4"
IMAGE_PATHS = [
    ASSETS / "reel0031_meal_timing_primary_reference_20260823.png",
    ASSETS / "reel0031_ref02_circadian_dial_20260823.png",
    ASSETS / "reel0031_ref03_controlled_study_20260823.png",
    ASSETS / "reel0031_ref04_no_perfect_time_20260823.png",
    ASSETS / "reel0031_ref05_review_uncertainty_20260823.png",
    ASSETS / "reel0031_ref06_practical_cues_20260823.png",
]
...
def main() -> int:
    for path in [NATIVE_CLIP, *IMAGE_PATHS, CAPTIONS, AUDIO / "REEL-0031_narration_hi-IN.wav"]:
        if not path.is_file():
    ...
    if not AUDIO_OUT.exists():
        shutil.copy2(AUDIO / "REEL-0031_narration_hi-IN.wav", AUDIO_OUT)
    ...
    (RENDERED / "REEL-0031_quota_limited_fallback_assembly.json").write_text(
