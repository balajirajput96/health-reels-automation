...
WORK = ROOT / 'work' / 'reel_0021'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0021_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0021_identity_routines_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि कुछ habits को stick करना इतना मुश्किल क्यों लगता है?"),
    ("Span 02 — Identity & Values", "Psychological research suggest करती है कि जब routines personal identity और values से align होती हैं, तो habit building आसान हो सकती है।"),
    ("Span 03 — Action Reflection", "जब आप हर action को अपने values का reflection मानते हैं, तो consistency maintain करना natural लगने लगता है।"),
    ("Span 04 — Desired Identity", "इसका मतलब है सिर्फ goals पर नहीं, बल्कि daily actions को अपनी desired identity के साथ connect करना।"),
    ("Span 05 — Environmental Cues", "Research बताती है कि small, value-driven cues environment में automatic positive behaviors को foster करते हैं।"),
    ("Span 06 — Gradual Process", "याद रखिए, यह एक gradual process है जिसमें हर व्यक्ति का experience और timeline अलग हो सकता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल general education के लिए है और professional psychological advice का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(59, 130, 246))  # Blue Identity accent bar
    ...
    draw.text((40, 90), f"REEL-0021 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "PMC & Behavioral Science Habit Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0021_building_routines_around_identity_and_values',
        'display_id': 'REEL-0021',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0021',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Building Routines: Identity और Core Values से Habit Formation का विज्ञान',
        'topic_key': 'building_routines_identity_values',
        'pillar': 'mental_health',
        'evidence_class': 'pmc_and_behavioral_science',
