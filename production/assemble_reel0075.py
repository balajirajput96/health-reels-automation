...
WORK = ROOT / 'work' / 'reel_0075'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0075_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0075_cognitive_flexibility_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप भी काम करते वक्त एक साथ चैटिंग, ईमेल और ब्राउजिंग करते हैं और सोचते हैं कि आप स्मार्ट मल्टीटास्किंग कर रहे हैं?"),
    ("Span 02 — The Illusion Of Multitasking", "Cognitive Neuroscience साफ बताती है कि इंसानी दिमाग एक साथ दो जटिल काम नहीं कर सकता—वह बस तेजी से दोनों के बीच स्विच करता है।"),
    ("Span 03 — Switch Costs In Milliseconds", "हर बार जब आप काम बदलते हैं, तो दिमाग में 'स्विच कॉस्ट' (Switch Cost) पैदा होता है, जिससे आपकी गति और सटीकता दोनों घट जाती हैं।"),
    ("Span 04 — Task Set Reconfiguration", "हमारे 'Prefrontal Cortex' को पुराने काम के नियम मिटाकर नए काम के नियम लोड करने पड़ते हैं (Task Set Reconfiguration)।"),
    ("Span 05 — The Mental Exhaustion Trap", "बार-बार स्विच करने से दिमाग की ग्लूकोज ऊर्जा बहुत तेजी से खर्च होती है और बिना ज्यादा काम किए भी सिर भारी होने लगता है।"),
    ("Span 06 — Batch Working Solution", "समाधान यह है कि एक समय में सिर्फ एक काम पर पूरा ध्यान दें और एक जैसे कामों को एक साथ पूरा करें (Batch Processing)।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल executive function cognitive awareness के लिए है और clinical attention deficit diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(139, 92, 246))  # Violet Executive Switch accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(139, 92, 246), font=font_header)
    draw.text((40, 90), f"REEL-0075 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Neuroscience & Task Set Reconfiguration Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0075_cognitive_flexibility_task_switching',
        'display_id': 'REEL-0075',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0075',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Task Switching: एक साथ कई काम करने पर दिमाग धीमा क्यों हो जाता है?',
        'topic_key': 'cognitive_flexibility_task_switching_switch_cost',
        'pillar': 'mental_health',
        'evidence_class': 'executive_function_and_cognitive_neuroscience',
