...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि हमारी मांसपेशियां सिर्फ वजन उठाने के लिए नहीं हैं, बल्कि वे शरीर का सबसे बड़ा हार्मोन बनाने वाला अंग हैं?"),
    ("Span 02 — Myokines Discovery", "Danish वैज्ञानिक Dr. Bente Pedersen ने खोजा कि एक्सरसाइज के दौरान मांसपेशियों के सिकुड़ने पर Myokines नाम के विशेष प्रोटीन्स खून में निकलते हैं।"),
    ("Span 03 — Irisin & Brain", "इनमें से Irisin नाम का हार्मोन सीधे खून से दिमाग में जाता है और नई ब्रेन सेल्स बनाने वाले BDNF को तेजी से बढ़ाता है।"),
    ("Span 04 — Anti-Inflammatory Shield", "मांसपेशियों से निकलने वाले ये प्रोटीन्स शरीर में पुरानी सूजन को खत्म करते हैं और डिप्रेशन से बचाते हैं।"),
    ("Span 05 — Fat-Burning Miracle", "मायोकाइन्स पेट की जिद्दी सफेद चर्बी को फैट जलाने वाले Beige Fat में बदल देते हैं।"),
    ("Span 06 — Strength Protocol", "हफ्ते में कम से कम 3 बार स्ट्रेंथ ट्रेनिंग या स्क्वाट्स करें ताकि आपका शरीर इन प्राकृतिक दवाओं को लगातार बनाता रहे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल muscle physiology awareness के लिए है और orthopedic rehabilitation का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (132, 204, 22)  # Lime green for muscle endocrinology & strength
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0128 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Myokines Muscles Endocrine Organ Irisin BDNF Evidence",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0128_myokines_muscles_endocrine','display_id':'REEL-0128','topic_hi':'Myokines: मांसपेशियां शरीर का सबसे बड़ा हार्मोन अंग हैं!','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
