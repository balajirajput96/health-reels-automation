...
WORK = ROOT / 'work' / 'reel_0033'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0033_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0033_reappraisal_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "किसी बड़े काम से पहले दिल का तेज़ धड़कना—क्या यह सिर्फ डर है, या शरीर की तैयारी?"),
    ("Span 02 — Cognitive Reappraisal", "Psychology में इसे 'cognitive reappraisal' कहते हैं—परिस्थिति और शारीरिक प्रतिक्रिया के अर्थ को दोबारा परिभाषित करना।"),
    ("Span 03 — Challenge vs Threat", "रिसर्च बताती है कि तनाव को 'खतरा' मानने के बजाय 'चुनौती' मानना cardiovascular response को बदल देता है।"),
    ("Span 04 — Cardiovascular Blood Flow", "Challenge mindset में blood vessels खुली रहती हैं और brain को oxygenated blood की बेहतर supply मिलती है।"),
    ("Span 05 — Somatic Reframing", "घबराहट महसूस होने पर खुद को याद दिलाएं—'मेरा शरीर मुझे action लेने के लिए ready कर रहा है।'"),
    ("Span 06 — Healthy Direction", "यह toxic positivity नहीं, बल्कि अपनी शारीरिक ऊर्जा को positive direction में channelize करना है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल psychological science awareness के लिए है और clinical anxiety treatment का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(249, 115, 22))  # Orange Reappraisal accent bar
    ...
    draw.text((40, 90), f"REEL-0033 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Cognitive Neuroscience & Stress Mindset Research", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0033_cognitive_reappraisal_and_stress_reframing',
        'display_id': 'REEL-0033',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0033',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Cognitive Reappraisal: Stress को Performance Energy में बदलने का विज्ञान',
        'topic_key': 'cognitive_reappraisal_and_stress_reframing',
        'pillar': 'mental_health',
        'evidence_class': 'cognitive_neuroscience_and_psychophysiology',
