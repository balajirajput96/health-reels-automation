...
WORK = ROOT / 'work' / 'reel_0051'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0051_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0051_attentional_blink_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि जब आँखें खुली होती हैं, तब भी हमारा दिमाग कुछ मिलीसेकंड के लिए नए दृश्यों को देखना बंद कर देता है?"),
    ("Span 02 — The RSVP Experiment", "Cognitive science में इसे 'Attentional Blink' कहते हैं—जब बहुत तेज़ी से तस्वीरें दिखाई जाती हैं (RSVP stream)।"),
    ("Span 03 — The 200-500ms Blindness", "पहले टारगेट (T1) को पहचानते ही, अगले 200 से 500 मिलीसेकंड तक आने वाले दूसरे टारगेट (T2) को दिमाग पूरी तरह मिस कर देता है।"),
    ("Span 04 — Working Memory Bottleneck", "ऐसा इसलिए होता है क्योंकि दिमाग पहले दृश्य को याददाश्त में सुरक्षित करने में व्यस्त हो जाता है और नया गेट बंद हो जाता है।"),
    ("Span 05 — Lag-One Sparing", "लेकिन अगर दूसरा दृश्य तुरंत (100 मिलीसेकंड के अंदर) आ जाए, तो वह गेट बंद होने से पहले अंदर पहुँच जाता है।"),
    ("Span 06 — Real-World Impact", "तेज़ ड्राइविंग या स्पोर्ट्स में यह सेकंड के छोटे हिस्से का गैप रिएक्शन टाइम को प्रभावित करता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल visual cognitive neuroscience awareness के लिए है और eye या neurological testing का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(239, 68, 68))  # Red Attentional Blink accent bar
    ...
    draw.text((40, 90), f"REEL-0051 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Visual Cognitive Attention & Temporal Dynamics Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0051_attentional_blink_and_temporal_dynamics',
        'display_id': 'REEL-0051',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0051',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Attentional Blink: आँखों के खुले रहते हुए भी दिमाग का अस्थायी अंधापन',
        'topic_key': 'attentional_blink_temporal_dynamics',
        'pillar': 'mental_health',
        'evidence_class': 'visual_attention_and_temporal_cognition',
