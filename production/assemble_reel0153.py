...
SPANS = [
    ("Span 01 — Hook", "क्या आप जानते हैं कि तरबूज इतना मीठा होने के बाद भी आपके खून में शुगर का झटका क्यों नहीं देता, जबकि सफेद ब्रेड तुरंत शुगर बढ़ा देती है?"),
    ("Span 02 — GI vs GL Mystery", "हार्वर्ड हेल्थ के अनुसार, लोग सिर्फ Glycemic Index देखते हैं, लेकिन असली खेल Glycemic Load का होता है।"),
    ("Span 03 — Watermelon Fact", "तरबूज का ग्लाइसेमिक इंडेक्स 72 है, लेकिन क्योंकि इसमें 92% पानी होता है, इसलिए इसमें कार्बोहाइड्रेट बहुत कम होता है।"),
    ("Span 04 — Low GL Reality", "एक कटोरी तरबूज का ग्लाइसेमिक लोड सिर्फ 5 है—यानी यह शुगर के मरीजों के लिए भी पूरी तरह सुरक्षित है।"),
    ("Span 05 — Real Sugar Villains", "असली खतरा मैदा, बिस्कुट और कोल्ड ड्रिंक्स हैं, जिनका ग्लाइसेमिक लोड 25 से ऊपर होता है और वे खून में इंसुलिन का विस्फोट करते हैं।"),
    ("Span 06 — Smart Diet Rule", "कुदरती फल खाने से न डरें—पानी और फाइबर से भरपूर ताजे फल खाएं और पैकेज्ड प्रोसेस्ड फूड से बचें।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल nutritional biochemistry awareness के लिए है और clinical diabetes management diet plan का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (239, 68, 68)  # Coral / Watermelon Red for glycemic load and fruit sugar biology
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0153 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"Glycemic Load vs Index Watermelon Blood Sugar",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0153_glycemic_load_vs_gi','display_id':'REEL-0153','topic_hi':'Glycemic Load: तरबूज मीठा होने के बाद भी शुगर क्यों नहीं बढ़ाता?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
