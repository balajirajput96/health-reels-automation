...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी गौर किया है कि आज हुई कोई छोटी सी गलती या बेइज्जती आपको जिंदगी की सबसे बड़ी तबाही क्यों लगने लगती है?"),
    ("Span 02 — Kahneman's Law", "नोबेल पुरस्कार विजेता Daniel Kahneman ने इसे The Focusing Illusion कहा है।"),
    ("Span 03 — The Magnifying Glass", "उनका कहना है कि जिंदगी में कोई भी चीज उतनी जरूरी नहीं होती, जितनी आप उसके बारे में सोचते वक्त मान लेते हैं।"),
    ("Span 04 — The Attention Trap", "हमारा दिमाग जिस चीज पर फोकस करता है, उसे ही पूरी दुनिया समझ बैठता है—चाहे वह एक नई गाड़ी खरीदने की खुशी हो या किसी की कही कड़वी बात।"),
    ("Span 05 — Natural Equilibrium", "लेकिन जैसे ही ध्यान हटता है, वह बात पूरी तरह गायब हो जाती है।"),
    ("Span 06 — The 10-10-10 Rule", "जब भी किसी बात की चिंता सताए, खुद से पूछें: क्या यह बात 10 दिन, 10 महीने या 10 साल बाद मायने रखेगी?"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive psychology awareness के लिए है और clinical obsessive rumination disorder treatment का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (236, 72, 153)  # Magenta / Pink for attentional magnification & focusing perspective
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0148 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"The Focusing Illusion Daniel Kahneman Perspective",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0148_focusing_illusion_kahneman','display_id':'REEL-0148','topic_hi':'The Focusing Illusion: कोई छोटी मुसीबत दिमाग में इतनी बड़ी क्यों लगती है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
