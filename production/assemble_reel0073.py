...
WORK = ROOT / 'work' / 'reel_0073'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0073_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0073_intrinsic_motivation_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि जब आपको अपने किसी पसंदीदा शौक या काम के लिए पैसे मिलने लगते हैं, तो धीरे-धीरे उसमें से सारा मज़ा क्यों खत्म हो जाता है?"),
    ("Span 02 — The Overjustification Effect", "Psychology में इसे 'Overjustification Effect' कहते हैं—जब किसी स्वाभाविक रूप से आनंददायक काम के लिए बाहरी इनाम दिया जाता है, तो आंतरिक प्रेरणा घट जाती है।"),
    ("Span 03 — Mark Lepper's Classic Experiment", "प्रसिद्ध प्रयोग में, जिन बच्चों को चित्र बनाने के लिए इनाम का वादा किया गया, बाद में उन्होंने अपने खाली समय में चित्र बनाना बंद कर दिया।"),
    ("Span 04 — Shift In Locus Of Control", "दिमाग का दृष्टिकोण बदल जाता है: 'मैं यह इसलिए करता हूँ क्योंकि मुझे खुशी मिलती है' से बदलकर 'मैं यह सिर्फ पैसे या इनाम के लिए कर रहा हूँ।'"),
    ("Span 05 — Dopamine And Dependency", "बाहरी इनाम दिमाग के डोपामिन सिस्टम को एक सौदेबाजी बना देते हैं, जिससे काम बिना इनाम के बोझ जैसा लगने लगता है।"),
    ("Span 06 — How To Reward Properly", "समाधान यह है कि काम को केवल इनाम की शर्त मत बनाएं—प्रयास और हुनर की दिल से तारीफ करें ताकि आंतरिक खुशी बनी रहे।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल cognitive motivation psychology awareness के लिए है और corporate compensation consulting का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(234, 179, 8))  # Yellow Motivation accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(234, 179, 8), font=font_header)
    draw.text((40, 90), f"REEL-0073 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Motivation Science & Overjustification Effect Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0073_intrinsic_motivation_overjustification',
        'display_id': 'REEL-0073',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0073',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Overjustification Effect: किसी शौक के पैसे मिलने पर उसमें से मज़ा क्यों गायब हो जाता है?',
        'topic_key': 'intrinsic_motivation_overjustification_effect',
        'pillar': 'mental_health',
        'evidence_class': 'motivation_science_and_cognitive_psychology',
