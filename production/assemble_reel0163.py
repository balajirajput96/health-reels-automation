...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी महसूस किया है कि जब आपके कपड़े पर कोई छोटा सा दाग लग जाता है या आप बोलते वक्त अटक जाते हैं, तो लगता है कि पूरी दुनिया सिर्फ आपको ही घूर रही है?"),
    ("Span 02 — Cornell Discovery", "साइकोलॉजी में इसे The Spotlight Effect कहते हैं।"),
    ("Span 03 — The T-Shirt Study", "कॉर्नेल यूनिवर्सिटी के वैज्ञानिकों ने छात्रों को एक अजीब सी टी-शर्ट पहनाकर कमरे में भेजा।"),
    ("Span 04 — The 50% Illusion", "टी-शर्ट पहनने वाले को लगा कि 50% लोग उसे देख रहे हैं, लेकिन असल में 80% लोगों ने उस पर ध्यान तक नहीं दिया!"),
    ("Span 05 — Egocentric Center", "हम अपनी जिंदगी के हीरो हैं, इसलिए हमारा दिमाग सोचता है कि सब लोग हम पर ही नजर रखे हुए हैं।"),
    ("Span 06 — Liberation Truth", "सच यह है कि हर इंसान अपने खुद के दाग और कमियों को छुपाने में इतना व्यस्त है कि उसे आपकी गलती देखने की फुर्सत ही नहीं है। बिंदास रहिए!"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social psychology cognitive bias awareness के लिए है और clinical social anxiety disorder therapy का विकल्प नहीं है।"),
]
CAPTION_TEXT = [s[1] for s in SPANS]
WEIGHTS = [0.15, 0.16, 0.15, 0.16, 0.14, 0.12, 0.12]
ACCENT = (251, 191, 36)  # Warm amber yellow spotlight for the spotlight effect & social anxiety relief
...
def generate_scene_graphic(index, title, subtitle, out_path):
    ...
    draw.text((40,90),f"REEL-0163 • SCENE {index:02d}",fill=(148,163,184),font=fb)
    ...
    draw.text((40,HEIGHT-180),"The Spotlight Effect Egocentric Anxiety Gilovich",fill=(148,163,184),font=fb)
...
def main():
    ...
    meta={'reel_id':'reel_0163_spotlight_effect_gilovich','display_id':'REEL-0163','topic_hi':'Spotlight Effect: गलती होने पर सबको क्यों लगता है पूरी दुनिया देख रही है?','target_account':'@balajirajput96','publication_allowed':True,'claims_boundary':'No medical diagnosis. General education only.','format':{'width':WIDTH,'height':HEIGHT,'aspect_ratio':'9:16','fps':FPS,'duration_seconds':round(duration(FINAL),3)},'sha256':{}}
