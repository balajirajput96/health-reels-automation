...
WORK = ROOT / 'work' / 'reel_0037'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0037_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0037_cue_competition_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने देखा है कि TV या phone के सामने बैठकर कोई नई अच्छी आदत शुरू करना इतना मुश्किल क्यों होता है?"),
    ("Span 02 — Associative Learning", "Associative learning science में इसे 'cue competition' कहते हैं—दिमाग में कई संकेत एक साथ ध्यान खींचने की होड़ करते हैं।"),
    ("Span 03 — Overshadowing Mechanism", "जब एक ही वातावरण में बहुत सारे triggers होते हैं, तो पुराना मजबूत trigger नए trigger के प्रभाव को दबा देता है।"),
    ("Span 04 — Habit Blocking", "Phone notifications या TV का पुराना cue नए habit cue (जैसे किताब खोलना) के असर को block कर देता है।"),
    ("Span 05 — Dedicated Clean Context", "नई आदत शुरू करने के लिए एक शांत और समर्पित स्थान (dedicated cue) चुनें ताकि ध्यान न भटके।"),
    ("Span 06 — Context Consistency", "लगातार एक ही समय और स्थान पर अभ्यास करने से नया trigger दिमाग में मजबूत associative connection बना लेता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल behavioral science awareness के लिए है और psychological consultation का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(234, 88, 12))  # Orange Cue accent bar
    ...
    draw.text((40, 90), f"REEL-0037 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Associative Learning & Cue Competition Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0037_cue_competition_and_habit_triggers',
        'display_id': 'REEL-0037',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0037',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Cue Competition: एक साथ कई Triggers और Habits का विज्ञान',
        'topic_key': 'cue_competition_and_habit_triggers',
        'pillar': 'mental_health',
        'evidence_class': 'associative_learning_and_conditioning_research',
