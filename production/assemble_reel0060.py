...
WORK = ROOT / 'work' / 'reel_0060'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0060_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0060_social_buffering_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी अनुभव किया है कि तनाव या दर्द के समय किसी अपने का हाथ पकड़ते ही दिल को तुरंत राहत क्यों मिलती है?"),
    ("Span 02 — James Coan's Hand-Holding Study", "Neuroscience में इसे 'Social Buffering' कहते हैं—fMRI स्टडीज में देखा गया कि हाथ पकड़ते ही दिमाग के खतरे वाले सर्किट शांत हो जाते हैं।"),
    ("Span 03 — Oxytocin Release", "किसी भरोसेमंद व्यक्ति के स्पर्श या सुकून भरी आवाज़ से मस्तिष्क में 'ऑक्सीटोसिन' (Oxytocin) हॉर्मोन रिलीज होता है।"),
    ("Span 04 — Amygdala Dampening", "यह ऑक्सीटोसिन दिमाग के डर केंद्र (Amygdala) में जाकर अलार्म सिग्नल को दबा देता है और कॉर्टिसोल का स्तर कम करता है।"),
    ("Span 05 — Vagal Brake Activation", "साथ ही, वेगस नर्व (Vagus Nerve) दिल की धड़कन पर ब्रेक लगाकर शरीर को रिलैक्स मोड में लाती है।"),
    ("Span 06 — Social Baseline Theory", "मानव दिमाग इस तरह विकसित हुआ है कि वह चुनौतियों का सामना अकेले करने के बजाय अपनों के साथ मिलकर ज़्यादा सुरक्षित महसूस करता है।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social neuroscience awareness के लिए है और relationship counseling या medical therapy का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(244, 63, 94))  # Rose Social Buffering accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(244, 63, 94), font=font_header)
    draw.text((40, 90), f"REEL-0060 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Social Neuroscience & Oxytocin Social Buffering Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0060_social_buffering_and_oxytocin',
        'display_id': 'REEL-0060',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0060',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Social Buffering: अपनों के साथ और स्पर्श से तनाव शांत होने का Neuroscience',
        'topic_key': 'social_buffering_oxytocin_vagal_regulation',
        'pillar': 'mental_health',
        'evidence_class': 'social_neuroscience_and_autonomic_regulation',
