...
WORK = ROOT / 'work' / 'reel_0067'
ASSETS = WORK / 'assets'
AUDIO = WORK / 'narration.wav'
MP3_RAW = WORK / 'narration_raw.mp3'
SCRIPT = ROOT / 'production' / 'reel0067_script_hi-IN.md'
BRIEF = ROOT / 'production' / 'reel0067_social_learning_brief.md'
...
SPANS = [
    ("Span 01 — Hook", "क्या आपने कभी सोचा है कि एक छोटा बच्चा बिना किसी क्लास के सिर्फ देखकर बड़ों जैसी आदतें और भाषा कैसे सीख जाता है?"),
    ("Span 02 — Albert Bandura's Theory", "Psychology में इसे 'Social Learning Theory' कहते हैं—इंसान सिर्फ अपनी गलतियों से नहीं, बल्कि दूसरों को देखकर सबसे ज़्यादा सीखता है।"),
    ("Span 03 — Vicarious Reinforcement", "इसे 'Vicarious Reinforcement' कहते हैं—जब हम दूसरों को किसी काम के लिए इनाम या सज़ा पाते देखते हैं, तो हमारा दिमाग खुद सीख जाता है।"),
    ("Span 04 — The 4-Step Modeling Engine", "यह प्रक्रिया 4 चरणों में होती है: ध्यान देना (Attention), याद रखना (Retention), दोहराना (Reproduction), और प्रेरणा (Motivation)।"),
    ("Span 05 — The Mirror Neuron System", "हमारे मस्तिष्क में 'मिरर न्यूरॉन्स' (Mirror Neurons) होते हैं जो दूसरों की क्रियाओं को देखकर खुद वैसे ही सक्रिय हो जाते हैं।"),
    ("Span 06 — The Power Of Environment", "यही कारण है कि आप जिन लोगों के साथ रहते हैं, आपकी आदतें, सोच और व्यवहार अनजाने में उनके जैसे ही बनने लगते हैं।"),
    ("Span 07 — Safety Boundary", "यह वीडियो केवल social cognitive psychology awareness के लिए है और behavioral therapy diagnosis का विकल्प नहीं है।"),
]
...
def generate_scene_graphic(index: int, title: str, subtitle: str, out_path: Path) -> None:
    ...
    draw.rectangle([(0, 140), (WIDTH, 146)], fill=(20, 184, 166))  # Teal Social Learning accent bar
    ...
    draw.text((40, 50), "HEALTH REELS AUTOMATION", fill=(20, 184, 166), font=font_header)
    draw.text((40, 90), f"REEL-0067 • SCENE {index:02d}", fill=(148, 163, 184), font=font_body)
    ...
    # Footer note
    draw.text((40, HEIGHT - 180), "Social Cognitive Psychology & Vicarious Modeling Research Evidence", fill=(148, 163, 184), font=font_body)
...
def main() -> None:
    ...
    metadata = {
        'reel_id': 'reel_0067_social_learning_theory_modeling',
        'display_id': 'REEL-0067',
        'batch': 'Batch_001',
        'canonical_drive_path': '3000_HINDI_RESEARCH_REELS/Batch_001/Reel_0067',
        'status': 'rendered_local_complete_verified',
        'topic_hi': 'Social Learning Theory: दूसरों को देखकर सीखने का शक्तिशाली Neuroscience',
        'topic_key': 'social_learning_vicarious_reinforcement',
        'pillar': 'mental_health',
        'evidence_class': 'social_cognitive_psychology_and_observational_learning',
